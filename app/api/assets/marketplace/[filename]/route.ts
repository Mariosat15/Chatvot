...
export async function GET(
  ...
  try {
    ...
    const baseDirs = [
      ...
      path.join(process.cwd(), 'apps', 'admin', 'public', 'uploads', 'marketplace'),
    ];
    ...
    if (!filePath) {
      console.error(`❌ Marketplace image not found in any location: ${sanitizedFilename} (also tried: ${webpFilename})`);
