      ...
      <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-primary-200 mt-2">
                Everything you need to know about trading competitions
              </p>
            </div>
          </div>
        </div>
        ...
        <section className="bg-dark-700/50 rounded-2xl p-6 shadow-xl border border-dark-600">
          ...
          <p className="text-dark-200 mb-4">
            Trading competitions are time-limited events where traders compete
            against each other using virtual trading points. The best performers
            win prizes in credits, which can be used for future competitions or
            withdrawn to real EUR.
          </p>
          <div className="grid sm:grid-cols-3 gap-4 mt-6">
            <div className="bg-dark-800/50 rounded-lg p-4 border border-dark-600">
              ...
              <p className="text-sm text-dark-300">
                Pay credits to enter. Entry fees form the prize pool.
              </p>
            </div>
            <div className="bg-dark-800/50 rounded-lg p-4 border border-dark-600">
              <div className="text-2xl mb-2">📊</div>
              ...
              <p className="text-sm text-dark-300">
                Trade with virtual points. Real market prices, no real money
                risk.
              </p>
            </div>
            <div className="bg-dark-800/50 rounded-lg p-4 border border-dark-600">
              ...
              <p className="text-sm text-dark-300">
                Top performers split the prize pool based on rankings.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-dark-700/50 rounded-2xl p-6 shadow-xl border border-dark-600">
          ...
          <p className="text-dark-200 mb-6">
            Each competition uses one of these methods to determine winners.
            Check the competition details before entering!
          </p>
          ...
          <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-dark-200">
                    Winner has the highest <strong>Profit & Loss</strong>. Most
                    common method.
                  </p>
                  <p className="text-xs text-green-300/60 mt-2">
                    Example: User A has +$5,000 P&L, User B has +$4,500 P&L →
                    User A wins
                  </p>
                </div>
              </div>
            ...
            <div className="bg-dark-800/50 rounded-xl p-4 border border-dark-600">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-dark-200">
                    Winner has the highest <strong>total capital</strong>{" "}
                    (starting balance + P&L).
                  </p>
                  <p className="text-xs text-purple-300/60 mt-2">
                    Example: Starting with $10,000, User A has $15,000, User B
                    has $14,500 → User A wins
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-dark-800/50 rounded-xl p-4 border border-dark-600">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-dark-200">
                    Winner has the highest <strong>win rate percentage</strong>.
                    Rewards consistency.
                  </p>
                  <p className="text-xs text-amber-300/60 mt-2">
                    Example: User A has 75% win rate (15W/5L), User B has 70%
                    (14W/6L) → User A wins
                  </p>
                </div>
              </div>
            ...
            <div className="bg-dark-800/50 rounded-xl p-4 border border-dark-600">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-dark-200">
                    Winner has the <strong>most winning trades</strong>. Rewards
                    active trading.
                  </p>
                  <p className="text-xs text-cyan-300/60 mt-2">
                    Example: User A has 25 winning trades, User B has 20 winning
                    trades → User A wins
                  </p>
                </div>
              </div>
            ...
            <div className="bg-dark-800/50 rounded-xl p-4 border border-dark-600">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-pink-400 mb-1">
                    Best Profit Factor
                  </h3>
                  <p className="text-sm text-dark-200">
                    Winner has the best <strong>profit factor</strong> (total
                    wins / total losses). Advanced metric for risk management.
                  </p>
                  <p className="text-xs text-pink-300/60 mt-2">
                    Example: User A has PF of 3.5, User B has PF of 2.8 → User A
                    wins
                  </p>
                </div>
              </div>
        ...
        <section className="bg-dark-700/50 rounded-2xl p-6 shadow-xl border border-dark-600">
          ...
          <p className="text-dark-200 mb-6">
            When two or more traders have identical performance, the competition
            uses tiebreaker rules:
          </p>

          <div className="space-y-3 mb-6">
            <div className="bg-dark-800/50 rounded-lg p-4 border border-dark-600">
              <h3 className="font-semibold text-white mb-2">
                1️⃣ First Tiebreaker
              </h3>
              <p className="text-sm text-dark-300">
                Common options: Fewer trades (more efficient), higher win rate,
                higher capital, or who joined first.
              </p>
            </div>
            <div className="bg-dark-800/50 rounded-lg p-4 border border-dark-600">
              <h3 className="font-semibold text-white mb-2">
                2️⃣ Second Tiebreaker (Optional)
              </h3>
              <p className="text-sm text-dark-300">
                If still tied, a second tiebreaker is applied using a different
                metric.
              </p>
            </div>
            <div className="bg-dark-800/50 rounded-lg p-4 border border-dark-600">
              ...
              <p className="text-sm text-dark-300">
                <strong>Split Equally:</strong> Tied participants split the
                combined prizes equally.
                <br />
                <strong>Example:</strong> 2 users tied for Rank 1 (70%) and Rank
                2 (20%) = 90% ÷ 2 = 45% each
              </p>
            </div>
          </div>
        ...
        <section className="bg-dark-700/50 rounded-2xl p-6 shadow-xl border border-dark-600">
          ...
          <p className="text-dark-200 mb-6">
            Some competitions have minimum requirements to qualify for prizes.
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-dark-800/50 rounded-lg p-4 border border-dark-600">
              ...
              <p className="text-sm text-dark-300">
                Must complete X trades to qualify for prizes. Prevents
                single-trade luck.
              </p>
              <p className="text-xs text-blue-300/60 mt-2">
                Example: If minimum is 10 trades and you only made 8,
                you&apos;re disqualified.
              </p>
            </div>
            ...
            <div className="bg-dark-800/50 rounded-lg p-4 border border-dark-600">
              ...
              <p className="text-sm text-dark-300">
                Must maintain X% win rate to qualify. Rare, but rewards
                consistency.
              </p>
              <p className="text-xs text-amber-300/60 mt-2">
                Example: If minimum is 40% and you have 35%, you&apos;re
                disqualified.
              </p>
            </div>
            ...
            <div className="bg-dark-800/50 rounded-lg p-4 border border-dark-600">
              ...
              <p className="text-sm text-dark-300">
                If you get liquidated (margin call), you&apos;re usually
                disqualified from prizes.
              </p>
              <p className="text-xs text-red-300/60 mt-2">
                Manage your risk! Keep your margin level above the stopout
                threshold.
              </p>
            </div>
            ...
            <div className="bg-dark-800/50 rounded-lg p-4 border border-dark-600">
              ...
              <p className="text-sm text-dark-300">
                Each competition may have unique rules. Always read the full
                details!
              </p>
            </div>
          </div>
        ...
        <div className="bg-dark-800/30 rounded-xl p-4 border border-dark-600">
          <p className="text-sm text-dark-400 text-center">
            ...
            Competition rules may vary. Always check the specific competition
