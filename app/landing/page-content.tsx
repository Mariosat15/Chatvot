...
export default function LandingPageContent() {
  ...
  const effectiveHeadingFont = customOverrides
    ? settings.customTheme?.headingFont || theme?.fonts.heading
    : theme?.fonts.heading;
    ...
    >
      ...
      {theme && (
        <style jsx global>{`
          ...
          .theme-text-gradient {
            ${theme.customClasses.textGradient.includes("bg-gradient")
              ? ""
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center gap-8">
              <a
                ...
                onMouseOver={(e) =>
                  (e.currentTarget.style.color = effectiveColors.primary || "")
                }
                onMouseOut={(e) =>
        ...
        <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
            ...
            >
              ...
              {settings.stats &&
                settings.stats.filter((s) => s.enabled).length > 0 && (
                  <motion.div
                    initial={{ opacity: 0, y: 30 }}
                    animate={{ opacity: 1, y: 0 }}
        ...
        settings.stats.length > 0 && (
          <section className="py-20 relative overflow-hidden">
            <div
              ...
              style={{
                background: `linear-gradient(90deg, ${effectiveColors.primary}08, transparent, ${effectiveColors.secondary}08)`,
              }}
            />
                  ...
                  .map((stat, index) => (
                    ...
                    >
                      <motion.div
                        ...
                        style={{
                          backgroundImage: theme?.effects.gradientStyle,
                          fontFamily: effectiveHeadingFont,
                        }}
                      >
                        {settings.statsAnimated ? (
        ...
        settings.howItWorksSteps.length > 0 && (
          <section className="py-24 relative overflow-hidden">
            <div
              className="absolute inset-0"
              style={{
                background: `linear-gradient(180deg, transparent, ${effectiveColors.secondary}08, transparent)`,
              }}
            />
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              <motion.div
              ...
              <div className="relative">
                ...
                <div
                  className="absolute top-16 left-0 right-0 h-1 hidden lg:block"
                  style={{
                    background: `linear-gradient(90deg, transparent, ${effectiveColors.primary}40, transparent)`,
                  }}
                />
      ...
      {false && settings?.sectionVisibility?.competitions && (
        <section
          id="competitions-legacy"
          className="py-24 relative overflow-hidden"
        >
          <div
            className="absolute inset-0"
            style={{
              background: `radial-gradient(ellipse at left, ${effectiveColors.primary}15, transparent)`,
            }}
          />
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                >
                  {settings?.competitionsTitle}
                </h2>
                <p
                  className="text-lg mb-8 leading-relaxed"
                  style={{ color: theme?.colors.textMuted }}
                >
                  {settings?.competitionsDescription}
                </p>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p
                            ...
                            style={{ color: theme?.colors.textMuted }}
                          >
                            Prize: {comp.prize} • {comp.participants} traders
                          </p>
                        </div>
                      </div>
                      <div
                          ...
                          backgroundColor:
                            comp.status === "LIVE"
                              ...
                              : comp.status === "STARTING"
                                ? `${effectiveColors.accent}20`
                                : `${effectiveColors.secondary}20`,
                          color:
                            comp.status === "LIVE"
      ...
      {false && settings?.sectionVisibility?.cta && (
        <section className="py-32 relative overflow-hidden">
          <div
            className="absolute inset-0"
            style={{
              background: `linear-gradient(135deg, ${effectiveColors.primary}15, ${effectiveColors.accent}08, ${effectiveColors.secondary}15)`,
            }}
          />
          <div
            className="absolute inset-0"
            style={{
              background: `radial-gradient(ellipse at center, ${effectiveColors.primary}15, transparent)`,
            }}
          />
