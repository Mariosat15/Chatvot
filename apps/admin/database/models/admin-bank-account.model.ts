...
AdminBankAccountSchema.statics.getDefaultAccount =
  async function (): Promise<IAdminBankAccount | null> {
    return this.findOne({ isDefault: true, isActive: true });
  };

// Static method to get all active accounts
AdminBankAccountSchema.statics.getActiveAccounts = async function (): Promise<
  IAdminBankAccount[]
> {
...
const AdminBankAccount =
  ...
  mongoose.model<IAdminBankAccount, IAdminBankAccountModel>(
    "AdminBankAccount",
