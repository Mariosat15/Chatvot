...
export interface IWalletTransaction extends Document {
  ...
  // Reason: mirrors the main app. Nine writers already pass this - challenge entry (x2),
  // the refund on decline, and six finalization payout rows across both apps - but it was
  // never declared, so strict mode discarded every one and the whole challenge money trail
  // was unattributable. Declared 1 Sep 2026; historical rows cannot be recovered.
