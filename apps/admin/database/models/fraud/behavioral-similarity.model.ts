...
BehavioralSimilaritySchema.index({
  similarityScore: -1,
  mirrorTradingDetected: 1,
});
...
BehavioralSimilaritySchema.statics.findHighSimilarity = function (
  threshold = 0.7,
) {
  return this.find({
...
const BehavioralSimilarity =
  models.BehavioralSimilarity ||
  model<IBehavioralSimilarity>(
    "BehavioralSimilarity",
    BehavioralSimilaritySchema,
  );
