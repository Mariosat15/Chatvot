...
CompanySettingsSchema.statics.getSingleton =
  async function (): Promise<ICompanySettings> {
...
CompanySettingsSchema.statics.isEUCompany =
...
const CompanySettings: ICompanySettingsModel =
  ...
  model<ICompanySettings, ICompanySettingsModel>(
    "CompanySettings",
