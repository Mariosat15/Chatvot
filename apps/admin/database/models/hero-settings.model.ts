...
const defaultFeatures: IFeatureCard[] = [
  {
    ...
    description:
      "Compete in real-time trading competitions with live leaderboards and massive prize pools.",
    color: "#ffd700",
    order: 1,
    enabled: true,
  },
  {
    ...
    description:
      "Challenge other traders to head-to-head battles and prove your trading skills.",
    color: "#ef4444",
    order: 2,
    enabled: true,
  },
  {
    ...
    description:
      "Climb the ranks and earn your place among the world's best traders.",
    color: "#8b5cf6",
    order: 3,
    enabled: true,
  },
  {
    ...
    description:
      "Unlock exclusive avatars, badges, and profile customizations.",
    color: "#06b6d4",
    order: 4,
    enabled: true,
  },
  {
    ...
    description:
      "Track your performance with detailed statistics and insights.",
    color: "#10b981",
    order: 5,
    enabled: true,
  },
...
const defaultHowItWorks: IHowItWorksStep[] = [
  {
    ...
    description: "Sign up in seconds and verify your profile",
    icon: "UserPlus",
    enabled: true,
  },
  {
    ...
    description: "Browse active competitions and enter your choice",
    icon: "Trophy",
    enabled: true,
  },
  {
  ...
  },
  {
    ...
    step: 4,
    title: "Win Prizes",
    description: "Top the leaderboard and claim your rewards",
    icon: "Award",
    enabled: true,
  },
];
...
const HeroSettingsSchema = new Schema<IHeroSettings>(
  {
    ...
    description: {
      type: String,
      default: "The ultimate competitive trading platform",
    },
    ...
    heroDescription: {
      type: String,
      default:
        "Join the world's most exciting trading competitions. Battle other traders in real-time, climb the leaderboards, and win massive prizes.",
    },
    heroBackgroundImage: { type: String, default: "" },
    heroBackgroundVideo: { type: String, default: "" },
    heroBackgroundType: {
      type: String,
      enum: ["color", "gradient", "image", "video", "particles"],
      default: "particles",
    },
    heroParticlesConfig: {
    ...
    heroAnimationType: {
      type: String,
      enum: ["fade", "slide", "zoom", "typewriter", "glitch"],
      default: "glitch",
    },
    ...
    featuresSubtitle: {
      type: String,
      default: "Everything you need to dominate",
    },
    ...
    statsSubtitle: {
      type: String,
      default: "Join the fastest growing trading community",
    },
    ...
    competitionsDescription: {
      type: String,
      default:
        "Real-time trading battles with live leaderboards and massive prize pools",
    },
    ...
    challengesDescription: {
      type: String,
      default: "Challenge any trader to a head-to-head battle",
    },
    ...
    adminShowcaseSubtitle: {
      type: String,
      default: "Total control at your fingertips",
    },
    adminShowcaseDescription: {
      type: String,
      default:
        "Manage every aspect of your trading platform with our comprehensive admin dashboard",
    },
    ...
    whiteLabelDescription: {
      type: String,
      default:
        "Launch your own branded trading competition platform in days, not months",
    },
    ...
    ctaSubtitle: {
      type: String,
      default: "Join thousands of traders already winning",
    },
    ctaDescription: {
      type: String,
      default: "Create your free account and start competing today",
    },
    ...
    ctaStyle: {
      type: String,
      enum: ["simple", "gradient", "image", "animated"],
      default: "animated",
    },
    ...
    footerCopyright: {
      type: String,
      default: "© 2024 TradingArena. All rights reserved.",
    },
    ...
    enterpriseHeroTitle: {
      type: String,
      default: "Launch Your Own Trading Platform",
    },
    enterpriseHeroSubtitle: { type: String, default: "Enterprise Solutions" },
    enterpriseHeroDescription: {
      type: String,
      default:
        "Complete white-label solution with powerful admin panel, fraud detection, payment processing, and everything you need to run a successful trading competition platform.",
    },
      ...
      default: [
        {
          ...
          description:
            "Custom logo, colors, fonts, and styling to match your brand identity perfectly.",
          enabled: true,
          order: 1,
        },
        {
          ...
          title: "Custom Domain",
          description:
            "Run the platform on your own domain with SSL certificate included.",
          enabled: true,
          order: 2,
        },
        {
          ...
          description:
            "Branded emails with your logo, colors, and custom templates.",
          enabled: true,
          order: 3,
        },
        {
          ...
          title: "API Access",
          description:
            "Full API access for custom integrations and third-party services.",
          enabled: true,
          order: 4,
        },
        {
          ...
          description:
            "Your own dedicated servers for maximum performance and reliability.",
          enabled: true,
          order: 5,
        },
        {
          ...
          description:
            "24/7 dedicated support team with direct communication channels.",
          enabled: true,
          order: 6,
        },
      ],
      ...
      default: [
        {
          ...
          description:
            "Monitor platform performance, user activity, and revenue in real-time.",
        ...
        },
        {
          ...
          title: "User Management",
          description:
            "Complete control over users, roles, permissions, and restrictions.",
        ...
        },
        {
          ...
          description:
            "Create, manage, and monitor trading competitions with customizable rules.",
        ...
        },
        {
          ...
          title: "Fraud Detection",
          description:
            "AI-powered fraud detection with behavioral analysis and alerts.",
        ...
        },
        {
          ...
          description:
            "Multiple payment providers with automatic fee calculation.",
        ...
        },
        {
          ...
          description: "Customizable email templates and in-app notifications.",
        ...
        },
        {
          ...
          title: "Audit Logging",
          description:
            "Complete audit trail of all admin actions for compliance.",
        ...
        },
        {
          ...
          description: "Track revenue, fees, VAT, and platform financials.",
      ...
      default: [
        {
          ...
          price: "$499",
          period: "/month",
          description: "Perfect for small trading communities",
          features: [
            "Up to 1,000 users",
            "Basic admin panel",
        ...
        },
        {
          ...
          price: "$1,499",
          period: "/month",
          description: "For growing trading platforms",
          features: [
            "Up to 10,000 users",
            "Full admin panel",
    ...
    enterpriseContactSubtitle: {
      type: String,
      default: "Contact our sales team for a personalized demo and quote",
    },
    enterpriseContactEmail: {
      type: String,
      default: "enterprise@chartvolt.com",
    },
    ...
    authPageTestimonialText: {
      type: String,
      default:
        "chatvolt turned my watchlist into a winning list. The alerts are spot-on, and I feel more confident making moves in the market",
    },
