...
AssignmentSettingsSchema.statics.getSettings =
  async function (): Promise<IAssignmentSettings> {
...
export function getStrategyDescription(strategy: AssignmentStrategy): string {
  const descriptions: Record<AssignmentStrategy, string> = {
    least_customers:
      "Assign to employee with the fewest active customers (balance workload)",
...
export const AssignmentSettings =
  mongoose.models.AssignmentSettings ||
  mongoose.model<IAssignmentSettings>(
    "AssignmentSettings",
