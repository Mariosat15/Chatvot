...
// Static methods
NotificationTemplateSchema.statics.getTemplate = async function (
  templateId: string,
) {
...
const NotificationTemplate =
  (mongoose.models.NotificationTemplate as INotificationTemplateModel) ||
  mongoose.model<INotificationTemplate, INotificationTemplateModel>(
...
function getDefaultTemplates(): Partial<INotificationTemplate>[] {
  return [
    // ========== PURCHASE ==========
    {
      ...
      message:
        "Your deposit of {{amount}} is being processed. This usually takes a few moments.",
      icon: "💳",
      priority: "normal",
      color: "#3B82F6",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "{{amount}} credits have been added to your wallet. Your new balance is {{balance}} credits.",
      icon: "✅",
      priority: "high",
      color: "#10B981",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "Your withdrawal of {{amount}} has been submitted and is pending review.",
      icon: "📤",
      priority: "normal",
      color: "#F59E0B",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "Your withdrawal of {{amount}} has been processed. Funds should arrive within 3-5 business days.",
      icon: "✅",
      priority: "high",
      color: "#10B981",
      isEnabled: true,
    ...
    // ========== COMPETITION ==========
    {
      ...
      title: "🎯 You're In!",
      message:
        'You\'ve successfully entered "{{competitionName}}". Entry fee: {{entryFee}} credits. Good luck!',
      icon: "🎯",
      priority: "high",
      color: "#8B5CF6",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        '"{{competitionName}}" starts in {{timeUntil}}. Get ready to trade!',
      icon: "⏰",
      priority: "high",
      color: "#F59E0B",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        '"{{competitionName}}" has started! Trading is now open. May the best trader win!',
      icon: "🚀",
      priority: "urgent",
      color: "#10B981",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        '"{{competitionName}}" ends in {{timeUntil}}. Current position: #{{currentRank}}',
      icon: "⚠️",
      priority: "high",
      color: "#F59E0B",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        '"{{competitionName}}" has ended! Your final position: #{{finalRank}} with P&L of {{pnl}}',
      icon: "🏁",
      priority: "high",
      color: "#6366F1",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        'You won "{{competitionName}}"! Your prize of {{prize}} credits has been added to your wallet!',
      icon: "🏆",
      priority: "urgent",
      color: "#FDD458",
      isEnabled: true,
    ...
    },
    {
      ...
      title: "🥇 Podium Finish!",
      message:
        'You finished #{{finalRank}} in "{{competitionName}}"! Prize: {{prize}} credits',
      icon: "🥇",
      priority: "high",
      color: "#FDD458",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        '{{prize}} credits from "{{competitionName}}" have been added to your wallet!',
      icon: "💰",
      priority: "high",
      color: "#10B981",
      isEnabled: true,
    ...
    },
    {
      ...
      title: "⛔ Disqualified",
      message:
        'You have been disqualified from "{{competitionName}}". Reason: {{reason}}',
      icon: "⛔",
      priority: "urgent",
      color: "#EF4444",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        '"{{competitionName}}" has been cancelled. Reason: {{reason}}. Your entry fee of {{entryFee}} credits has been fully refunded.',
      icon: "🚫",
      priority: "urgent",
      color: "#EF4444",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        'Your entry fee of {{entryFee}} credits for "{{competitionName}}" has been refunded to your wallet. New balance: {{balance}} credits.',
      icon: "💰",
      priority: "high",
      color: "#10B981",
      isEnabled: true,
    ...
    // ========== TRADING ==========
    {
      ...
      title: "✅ Order Filled",
      message:
        "{{orderType}} order for {{symbol}} filled at {{price}}. Size: {{size}}",
      icon: "✅",
      priority: "normal",
      color: "#10B981",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "Stop loss triggered for {{symbol}} at {{price}}. Loss limited to {{loss}}",
      icon: "🛑",
      priority: "high",
      color: "#EF4444",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "Take profit triggered for {{symbol}} at {{price}}. Profit: {{profit}}",
      icon: "🎯",
      priority: "high",
      color: "#10B981",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "Your margin level is at {{marginLevel}}%. Consider reducing positions to avoid liquidation.",
      icon: "⚠️",
      priority: "urgent",
      color: "#F59E0B",
      isEnabled: true,
    ...
    },
    {
      ...
      title: "🚨 MARGIN CALL",
      message:
        "URGENT: Margin level critically low at {{marginLevel}}%. Add funds or close positions immediately!",
      icon: "🚨",
      priority: "urgent",
      color: "#EF4444",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "Your {{symbol}} position has been liquidated due to insufficient margin.",
      icon: "💥",
      priority: "urgent",
      color: "#EF4444",
      isEnabled: true,
    ...
    },
    {
      ...
      description: "Sent when user completes a journey milestone",
      category: "achievement",
      type: "milestone_reached",
      title: "🗺️ Milestone Completed!",
      message:
        'You\'ve completed "{{milestoneName}}"! {{celebrationText}} +{{xpReward}} XP earned!',
      icon: "🗺️",
      priority: "high",
      color: "#10B981",
      isEnabled: true,
    ...
    },
    {
      ...
      title: "📈 Rank Improved!",
      message:
        "You've climbed to #{{newRank}} on the global leaderboard! (up from #{{oldRank}})",
      icon: "📈",
      priority: "normal",
      color: "#10B981",
      isEnabled: true,
    ...
    // ========== SYSTEM ==========
    {
      ...
      message:
        "The platform will undergo maintenance on {{date}} from {{startTime}} to {{endTime}}. Some features may be unavailable.",
      icon: "🔧",
      priority: "high",
      color: "#F59E0B",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "Your password has been successfully changed. If you didn't make this change, contact support immediately.",
      icon: "🔒",
      priority: "high",
      color: "#10B981",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "Your account has been suspended. Reason: {{reason}}. Contact support for more information.",
      icon: "⛔",
      priority: "urgent",
      color: "#EF4444",
      isEnabled: true,
    ...
    // ========== 1v1 CHALLENGES ==========
    {
      ...
      message:
        "{{challengerName}} has challenged you to a 1v1 battle! Entry: {{entryFee}} credits. Winner takes {{winnerPrize}} credits!",
      icon: "⚔️",
      priority: "urgent",
      color: "#F59E0B",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "{{challengedName}} has accepted your challenge! The battle begins NOW. Winner takes {{winnerPrize}} credits!",
      icon: "🎯",
      priority: "urgent",
      color: "#10B981",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "Your 1v1 challenge against {{challengerName}} has begun! You have {{duration}} minutes. May the best trader win!",
      icon: "🚀",
      priority: "urgent",
      color: "#8B5CF6",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "{{challengedName}} has declined your challenge. No credits were deducted. Try challenging someone else!",
      icon: "😔",
      priority: "normal",
      color: "#6B7280",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "Your challenge to {{challengedName}} has expired. They did not respond in time.",
      icon: "⏰",
      priority: "low",
      color: "#6B7280",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "Your challenge against {{opponentName}} ended in a tie! {{tieResolution}}",
      icon: "🤝",
      priority: "normal",
      color: "#6366F1",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "You were disqualified from the challenge against {{opponentName}}. Reason: {{reason}}",
      icon: "⚠️",
      priority: "high",
      color: "#EF4444",
      isEnabled: true,
    ...
    // ========== KYC ==========
    {
      ...
      message:
        "Your identity verification has been initiated. Please complete the process to unlock all features.",
      icon: "🔐",
      priority: "normal",
      color: "#3B82F6",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "Your identity verification was not successful. Reason: {{reason}}. You may retry the verification process.",
      icon: "❌",
      priority: "high",
      color: "#EF4444",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "Your identity verification session has expired. Please start a new verification to continue.",
      icon: "⏰",
      priority: "normal",
      color: "#F59E0B",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "To withdraw funds, you must first verify your identity. This helps keep the platform secure for everyone.",
      icon: "🔒",
      priority: "high",
      color: "#F59E0B",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "{{friendName}} accepted your friend request! You can now chat with them.",
      icon: "🎉",
      priority: "normal",
      color: "#10B981",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "{{blockedByName}} has blocked you. You can no longer send them messages or friend requests.",
      icon: "🚫",
      priority: "normal",
      color: "#EF4444",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "A new support conversation from {{customerName}} has been assigned to you.",
      icon: "📋",
      priority: "high",
      color: "#F59E0B",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "{{unblockedByName}} has unblocked you. You can now send them messages and friend requests again.",
      icon: "✅",
      priority: "low",
      color: "#10B981",
      isEnabled: true,
    ...
    },
    {
      ...
      description:
        "Sent when a support conversation is transferred to another employee",
      category: "messaging",
      type: "conversation_transferred",
      title: "🔄 Conversation Transferred",
      message:
        "Your conversation has been transferred to {{newEmployeeName}} who will continue assisting you.",
      icon: "🔄",
      priority: "normal",
      color: "#8B5CF6",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "Your support ticket has been resolved by {{employeeName}}. Thank you for contacting us!",
      icon: "✅",
      priority: "normal",
      color: "#10B981",
      isEnabled: true,
    ...
    // ========== CUSTOMER ASSIGNMENT (for customers) ==========
    {
      ...
      description:
        "Sent to customer when an account manager is assigned to them",
      category: "messaging",
      type: "account_manager_assigned",
      title: "👤 Account Manager Assigned",
      message:
        "{{employeeName}} has been assigned as your account manager. They will assist you with any questions or support needs.",
      icon: "👤",
      priority: "high",
      color: "#3B82F6",
      isEnabled: true,
    ...
    },
    {
      ...
      message:
        "Your account manager has been changed from {{previousManager}} to {{newManager}}. {{newManager}} will now be handling your account.",
      icon: "🔄",
      priority: "normal",
      color: "#F59E0B",
      isEnabled: true,
    ...
    // ========== EMPLOYEE NOTIFICATIONS (for employees) ==========
    {
      ...
      message:
        "{{customerName}} ({{customerEmail}}) has been assigned to you. You are now their account manager.",
      icon: "👥",
      priority: "high",
      color: "#10B981",
      isEnabled: true,
    ...
    },
    {
      ...
      description:
        "Sent to employee when a customer is reassigned from/to them",
      category: "messaging",
      type: "customer_reassigned",
      title: "🔄 Customer Reassigned",
      message:
        "{{customerName}} has been reassigned from {{fromEmployee}} to {{toEmployee}}.",
      icon: "🔄",
      priority: "normal",
      color: "#F59E0B",
      isEnabled: true,
    ...
    },
    {
      ...
      title: "🆕 New Customer",
      message:
        "You have a new customer: {{customerName}}. Please reach out to introduce yourself.",
      icon: "🆕",
      priority: "high",
      color: "#06B6D4",
      isEnabled: true,
    ...
    },
    {
      ...
      description:
        "Sent to employee when a customer is removed from their list",
      category: "messaging",
      type: "employee_customer_removed",
      title: "📤 Customer Removed",
      message:
        "{{customerName}} is no longer assigned to you. They have been reassigned to {{newEmployee}}.",
      icon: "📤",
      priority: "low",
      color: "#6B7280",
      isEnabled: true,
