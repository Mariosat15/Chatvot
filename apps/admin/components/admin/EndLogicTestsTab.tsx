...
const TEST_CASES: TestCase[] = [
  ...
  },
  {
    ...
    description:
      "Some liquidated, some disqualified with disqualifyOnLiquidation=true",
    disqualifyOnLiquidation: true,
  ...
  },
  {
    ...
    description:
      "Some liquidated, some disqualified with disqualifyOnLiquidation=false",
    disqualifyOnLiquidation: false,
    scenario: "Mix LIQUIDATED + DISQUALIFIED",
  ...
  // ============ FULL JOURNEY TESTS ============
  {
    ...
    expectedResult:
      "Step 1: No early end → Step 2: Finalize → Higher equity wins $160",
    status: "pending",
  },
  {
    id: "C-J2",
    ...
    expectedResult:
      "Step 1: No early end → Step 2: Finalize → Liquidated wins $160",
    status: "pending",
  },
  ...
  {
    id: "C-T4",
    category: "competition-tiebreakers",
    name: "Win Rate Tiebreaker",
    description: "Same PNL - higher win rate wins",
    disqualifyOnLiquidation: true,
    scenario: "Same PNL, P0=70% win rate, P1=50% win rate",
    expectedResult: "P0 wins via higher win rate tiebreaker",
    status: "pending",
  },
  {
    id: "C-T5",
    category: "competition-tiebreakers",
    name: "Higher Capital Tiebreaker",
    description: "Same PNL% - higher capital wins",
    disqualifyOnLiquidation: true,
    scenario: "Same PNL%, P0=$6500, P1=$6000",
    expectedResult: "P0 wins via higher capital tiebreaker",
    status: "pending",
  },
  {
    id: "C-T6",
    category: "competition-tiebreakers",
    name: "ROI Tiebreaker",
    description: "Same capital - higher ROI% wins",
    disqualifyOnLiquidation: true,
    scenario: "Same capital, P0=30% ROI, P1=20% ROI",
    expectedResult: "P0 wins via higher ROI tiebreaker",
    status: "pending",
  },
  {
    id: "C-T7",
    category: "competition-tiebreakers",
    name: "Join Time Tiebreaker",
    description: "Same everything - earlier joiner wins",
    disqualifyOnLiquidation: true,
    scenario: "Same stats, P0 joined before P1",
    expectedResult: "P0 wins via earlier join time",
    status: "pending",
  },
  {
    id: "C-T8",
    category: "competition-tiebreakers",
    name: "Split Prize (No Tiebreaker)",
    description: "Same everything - split equally",
    disqualifyOnLiquidation: true,
    scenario: "Same stats, split_prize tiebreaker",
    expectedResult: "Both split: $80 each",
    status: "pending",
  },
  ...
  {
    id: "C-T9",
    category: "competition-prize-dist",
    name: "First Gets All",
    description: "Tied players - first joiner wins all",
    disqualifyOnLiquidation: true,
    scenario: "Tied, first_gets_all distribution",
    expectedResult: "P0 (first joiner) gets $160, P1 gets $0",
    status: "pending",
  },
  {
    id: "C-T10",
    category: "competition-prize-dist",
    name: "Split Weighted",
    description: "Tied players - split by capital ratio",
    disqualifyOnLiquidation: true,
    scenario: "Tied, P0=75% capital, P1=25% capital",
    expectedResult: "P0: $120 (75%), P1: $40 (25%)",
    status: "pending",
  },
  ...
  // ============ SECOND TIEBREAKER TESTS ============
  {
    id: "C-T11",
    category: "competition-tiebreakers",
    name: "Second Tiebreaker Decides",
    description: "First TB tied - second TB decides",
    disqualifyOnLiquidation: true,
    scenario: "Same PNL+trades, P1=80% win rate > P0=60%",
    expectedResult: "P1 wins via second tiebreaker (win_rate)",
    status: "pending",
  },
...
const CATEGORIES = [
  {
    ...
    name: "Competition Early End",
    icon: Trophy,
    color: "text-yellow-400",
  },
  {
    id: "competition-normal",
    name: "Competition Normal End",
    icon: Trophy,
    color: "text-blue-400",
  },
  {
    id: "competition-prize",
    name: "Competition Prize Distribution",
    icon: DollarSign,
    color: "text-emerald-400",
  },
  {
    id: "competition-distribution",
    name: "Multi-Winner Distribution",
    icon: DollarSign,
    color: "text-pink-400",
  },
  {
    id: "competition-journey",
    name: "Competition Full Journey",
    icon: Clock,
  ...
  {
    id: "competition-tiebreakers",
    name: "⚖️ Tiebreaker Types",
    icon: Trophy,
    color: "text-indigo-400",
  },
  {
    id: "competition-prize-dist",
    name: "💰 Prize Distribution Types",
    icon: DollarSign,
    color: "text-lime-400",
  },
  {
  ...
  {
    id: "competition-referral",
    name: "🎯 Competition GM Referral Fees",
    icon: DollarSign,
    color: "text-violet-400",
  },
  {
    id: "challenge-early",
    name: "Challenge Early End",
    icon: Swords,
    color: "text-orange-400",
  },
  {
    id: "challenge-normal",
    name: "Challenge Normal End",
    icon: Swords,
    color: "text-green-400",
  },
  {
    id: "challenge-prize",
    name: "Challenge Prize Distribution",
    icon: DollarSign,
    color: "text-cyan-400",
  },
  {
  ...
  {
    id: "challenge-referral",
    name: "🎯 Challenge GM Referral Fees",
    icon: DollarSign,
    color: "text-violet-400",
  },
];
...
export default function EndLogicTestsTab() {
  ...
  const runCategoryTests = async (category: string) => {
    ...
    setTestCases((prev) =>
      prev.map((t) =>
        t.category === category
          ? { ...t, status: "pending", result: undefined }
          : t,
      ),
    );
    ...
    <div className="space-y-6">
      ...
      <Card className="bg-gray-800/50 border-gray-700">
        <CardHeader>
          ...
          <CardDescription>
            Test all competition and challenge end scenarios to verify correct
            behavior
          </CardDescription>
        </CardHeader>
        <CardContent>
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              ...
                              >
                                Flag:{" "}
                                {test.disqualifyOnLiquidation ? "ON" : "OFF"}
                              </Badge>
                            </div>
                                ...
                                {test.result.prizeDistribution && (
                                  <div className="flex items-center gap-2 mt-1 text-xs text-gray-400">
                                    ...
                                    {test.result.prizeDistribution.winnerId && (
                                      <span>
                                        Winner:{" "}
                                        {test.result.prizeDistribution.winnerId.slice(
                                          -6,
                                        )}
                                      </span>
                                    )}
                  ...
                  {testCases
                    ...
                    .map((t) => (
                      <li key={t.id} className="text-sm text-gray-300">
                        • {t.id}: {t.name} -{" "}
                        {t.result?.message || "Unknown error"}
                      </li>
                    ))}
                </ul>
              </div>
