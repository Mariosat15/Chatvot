...
import { 
  ...
  Search, Filter, History, Settings, Trophy, TrendingUp
} from 'lucide-react';
...
export default function ChallengesAdminSection() {
  ...
  const [challengeToCancel, setChallengeToCancel] = useState<Challenge | null>(null);
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-orange-500/50 rounded-2xl shadow-2xl shadow-orange-500/10 overflow-hidden">
          ...
          <div className="flex items-center justify-between">
            ...
            {stats && (
              <div className="flex items-center gap-4 text-white/80">
                ...
                <div className="text-right">
                  <div className="text-2xl font-bold text-green-300">€{stats.totalFees.toFixed(0)}</div>
        ...
        <div className="flex border-b border-gray-700">
          <button
            onClick={() => { setActiveTab('active'); setPage(1); setStatusFilter(''); }}
          ...
          <button
            onClick={() => { setActiveTab('history'); setPage(1); setStatusFilter(''); }}
            className={`flex-1 px-6 py-4 text-sm font-medium flex items-center justify-center gap-2 transition-colors ${
              activeTab === 'history'
                ? 'text-orange-400 border-b-2 border-orange-400 bg-orange-500/10'
                : 'text-gray-400 hover:text-gray-200'
          ...
          >
            ...
            {stats && (
              <span className="bg-gray-500/20 text-gray-400 px-2 py-0.5 rounded-full text-xs">
                {stats.completed + stats.declined + stats.expired + stats.cancelled}
              </span>
            )}
          </button>
          <button
          ...
          {stats && (
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-3">
              ...
              <div className="bg-gray-800/50 border border-blue-500/30 rounded-xl p-3">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xl font-bold text-blue-400">{stats.accepted}</p>
                  </div>
              ...
              <div className="bg-gray-800/50 border border-purple-500/30 rounded-xl p-3">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xl font-bold text-purple-400">{stats.completed}</p>
                  </div>
              ...
              <div className="bg-gray-800/50 border border-orange-500/30 rounded-xl p-3">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-[10px] text-gray-500 uppercase">Declined</p>
                    <p className="text-xl font-bold text-orange-400">{stats.declined}</p>
                  </div>
              ...
              <div className="bg-gray-800/50 border border-red-500/30 rounded-xl p-3">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-[10px] text-gray-500 uppercase">Cancelled</p>
              ...
              <div className="bg-gray-800/50 border border-green-500/30 rounded-xl p-3">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xl font-bold text-green-400">€{stats.totalPrizePool.toFixed(0)}</p>
                  </div>
          ...
          {loading ? (
            ...
            <div className="bg-gray-800/50 border border-gray-700 rounded-2xl p-12 text-center">
              ...
              <p className="text-gray-500">
                {activeTab === 'active' ? 'No active challenges at the moment.' : 'No challenges match your filters.'}
              </p>
            </div>
          ) : (
                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-gray-500 truncate">
                            {challenge.challengerEmail} vs {challenge.challengedEmail}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-wrap items-center gap-2 mt-3">
                        <div className={`px-2.5 py-1 rounded-full border text-xs font-semibold flex items-center gap-1 ${getStatusColor(challenge.status)}`}>
                        ...
                        {challenge.status === 'pending' && (
                          <LiveCountdownBadge targetDate={challenge.acceptDeadline} label="Expires in" />
                        )}

                        {/* Time Remaining for Active */}
                        {challenge.status === 'active' && challenge.endTime && (
                          <LiveCountdownBadge targetDate={challenge.endTime} label="Ends in" isEnding />
                        )}
                        ...
                        {challenge.status === 'completed' && challenge.isTie && (
            ...
            {challengeToCancel && (
              <div className="p-4 bg-gray-800 rounded-lg">
                <p className="text-white font-semibold">
                  {challengeToCancel.challengerName} vs {challengeToCancel.challengedName}
                </p>
                <p className="text-sm text-gray-400 mt-1">
                  Entry Fee: €{challengeToCancel.entryFee} each • Prize: €{challengeToCancel.winnerPrize}
                </p>
              </div>
            )}
