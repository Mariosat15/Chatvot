          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-green-100 text-sm">
                Configure the base currency for the platform
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setSettings((prev) => ({
                    ...
                    currency: {
                      ...prev.currency,
                      exchangeRateToEUR: parseFloat(e.target.value),
                    },
                  }))
                }
              ...
              <p className="text-xs text-gray-500 mt-1">
                1 EUR = {settings.currency.exchangeRateToEUR}{" "}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-yellow-100 text-sm">
                Configure the platform's virtual currency
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-blue-500/50 rounded-2xl shadow-2xl shadow-blue-500/10 overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Label className="text-gray-300">
                Minimum Deposit ({settings.currency.symbol})
              </Label>
              <Input
                type="number"
                min="1"
                ...
                onChange={(e) => {
                  ...
                  setSettings((prev) => ({
                    ...
                    transactions: {
                      ...prev.transactions,
                      minimumDeposit: isNaN(value) ? 1 : value,
                    },
                  }));
                }}
                className="mt-2 bg-gray-700 border-gray-600 text-gray-100"
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  setSettings((prev) => ({
                    ...
                    transactions: {
                      ...prev.transactions,
                      minimumWithdrawal: isNaN(value) ? 1 : value,
                    },
                  }));
                }}
                className="mt-2 bg-gray-700 border-gray-600 text-gray-100"
          ...
          <div className="mt-4 p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-xl">
            ...
            <p className="text-xs text-gray-400 mt-1">
              All deposit and withdrawal fees are now managed in{" "}
              <strong>Settings → Fees</strong>. This includes platform fees
              (what you charge users) and bank fees (what providers charge you).
            </p>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="p-3 bg-gray-700/50 rounded-lg">
                <p className="text-xs text-gray-400">
                  10 {settings.currency.symbol}
                </p>
                <p className="text-base font-bold text-green-400">
                  {(10 / settings.credits.valueInEUR).toFixed(0)}{" "}
                  {settings.credits.symbol}
                </p>
              </div>
              <div className="p-3 bg-gray-700/50 rounded-lg">
                <p className="text-xs text-gray-400">
                  50 {settings.currency.symbol}
                </p>
                <p className="text-base font-bold text-green-400">
                  {(50 / settings.credits.valueInEUR).toFixed(0)}{" "}
                  {settings.credits.symbol}
                </p>
              </div>
              <div className="p-3 bg-gray-700/50 rounded-lg">
                <p className="text-xs text-gray-400">
                  100 {settings.credits.symbol}
                </p>
              ...
              <div className="p-3 bg-gray-700/50 rounded-lg">
                <p className="text-xs text-gray-400">
                  1000 {settings.credits.symbol}
                </p>
                <p className="text-base font-bold text-blue-400">
                  {settings.currency.symbol}
                  {(1000 * settings.credits.valueInEUR).toFixed(2)}
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-purple-100 text-sm">
                Configure accent colors for the platform
              </p>
            </div>
          </div>
        </div>
