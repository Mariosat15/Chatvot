  ...
  features: [
    {
      ...
      description:
        "Enter daily, weekly, and monthly tournaments with real-time leaderboards. Compete for cash prizes, exclusive badges, and global bragging rights.",
      enabled: true,
    },
    {
      id: "2",
      icon: "Swords",
      title: "1v1 Head-to-Head Duels",
      description:
        "Challenge any trader to a direct showdown. Set the stake, choose the timeframe, and prove you're the better trader in intense one-on-one battles.",
      enabled: true,
    },
    {
      id: "3",
      ...
      description:
        "Trade on advanced TradingView-powered charts with 50+ technical indicators, drawing tools, and multi-timeframe analysis — all in real-time.",
      enabled: true,
    },
    {
      id: "4",
      ...
      description:
        "Track your rank against thousands of traders. Earn XP, climb seasonal tiers, and showcase your achievements on your public profile.",
      enabled: true,
    },
    {
      id: "5",
      ...
      description:
        "Trade with virtual capital in a risk-free environment. Perfect your strategy, test new approaches, and build confidence — all without risking a single dollar.",
      enabled: true,
    },
    {
      id: "6",
      ...
      description:
        "Execute trades on live market prices streamed directly from institutional-grade data providers. No delays, no re-quotes — just raw market action.",
      enabled: true,
    },
    {
      id: "7",
      ...
      description:
        "Unlock badges, earn XP for every trade, and collect rewards as you progress. From Bronze to Legendary — every milestone is recognized and celebrated.",
      enabled: true,
    },
    {
      id: "8",
      icon: "Globe",
      title: "Trade 28+ Forex Pairs",
      description:
        "Access all major, minor, and exotic currency pairs with institutional-grade spreads. Diversify your strategy across the world's most liquid markets.",
      enabled: true,
    },
    {
      id: "9",
      ...
      description:
        "Join a global community of competitive traders. Share strategies, follow top performers, and learn from the best in real-time activity feeds.",
      enabled: true,
    },
  ],
  ...
  howItWorksSteps: [
    {
      ...
      description:
        "Sign up in under 60 seconds with just your email. No credit card required, no hidden fees — instant access to the full trading arena.",
      enabled: true,
    },
    {
      id: "2",
      ...
      description:
        "Choose from daily sprint tournaments, weekly marathons, or intense 1v1 duels. Filter by entry fee, prize pool, or trading pairs to find your perfect match.",
      enabled: true,
    },
    {
      id: "3",
      ...
      description:
        "Execute trades on real-time market data using professional charts and tools. Deploy your strategy across 28+ forex pairs with zero financial risk.",
      enabled: true,
    },
    {
      id: "4",
      ...
      description:
        "Finish at the top of the leaderboard and withdraw your winnings instantly. Earn badges, XP, and seasonal rewards as you build your legacy.",
      enabled: true,
    },
  ],
  ...
  enterpriseWhiteLabelFeatures: [
    {
      ...
      description:
        "Your logo, colors, fonts, and styling everywhere — from the landing page to email notifications. Fully white-labeled, zero ChartVolt branding.",
      enabled: true,
    },
    {
      id: "2",
      ...
      description:
        "Run on your own domain (e.g., arena.yourbrand.com) with enterprise-grade SSL encryption and CDN-backed global delivery.",
      enabled: true,
    },
    {
      id: "3",
      ...
      description:
        "Automated email templates, transactional emails, and notification systems — all branded with your identity and customizable via the admin panel.",
      enabled: true,
    },
    {
      id: "4",
      ...
      description:
        "Full API access for third-party integrations, custom analytics pipelines, and webhook events for real-time platform monitoring.",
      enabled: true,
    },
    {
      id: "5",
      ...
      description:
        "Isolated servers, dedicated database instances, and guaranteed uptime SLAs. Your platform runs independently for maximum performance and security.",
      enabled: true,
    },
    {
      id: "6",
      icon: "Headphones",
      title: "24/7 Priority Support & Onboarding",
      description:
        "Dedicated account manager, priority support queue, and comprehensive onboarding — from setup to your first live competition.",
      enabled: true,
    },
  ],
  ...
  enterpriseAdminFeatures: [
    {
      ...
      description:
        "Live user metrics, revenue tracking, competition performance, and engagement analytics — all visualized with professional charts and exportable reports.",
    ...
    },
    {
      ...
      description:
        "Full user lifecycle control — KYC verification, role-based access, wallet management, activity logs, and automated restriction systems.",
    ...
    },
    {
      ...
      description:
        "Create unlimited competition types — tournaments, leagues, 1v1 duels, and custom formats. Configure entry fees, prize pools, rules, and schedules with granular control.",
    ...
    },
    {
      ...
      description:
        "AI-powered anomaly detection, IP tracking, multi-account prevention, and real-time risk scoring — protecting your platform and your users around the clock.",
  ...
  enterprisePricingTiers: [
    {
      ...
      price: "$499",
      period: "/month",
      description: "Perfect for communities and startups",
      features: [
        "Up to 1,000 active users",
        "Basic admin panel",
        "5 concurrent competitions",
    ...
    },
    {
      ...
      price: "$1,499",
      period: "/month",
      description: "For growing platforms and brokers",
      features: [
    ...
    },
    {
      ...
      price: "Custom",
      period: "",
      description: "For global operators and institutions",
      features: [
        "Unlimited users",
...
export default function LandingPageBuilder() {
  ...
  const mapFromDbSettings = (db: Record<string, unknown>): LandingSettings => {
    return {
      ...
      holidaySchedule:
        (db.holidaySchedule as HolidayScheduleItem[]) ||
        defaultSettings.holidaySchedule,
      globalThemeEffects:
        (db.globalThemeEffects as GlobalThemeEffects) ||
        defaultSettings.globalThemeEffects,
      customThemeEnabled: (db.customThemeEnabled as boolean) ?? false,
      customTheme:
        (db.customTheme as CustomTheme) || defaultSettings.customTheme,

      enterprisePageEnabled: (db.enterprisePageEnabled as boolean) ?? true,

      heroEnabled:
        (db.sectionVisibility as Record<string, boolean>)?.hero ?? true,
      ...
      heroDescription:
        (db.heroDescription as string) || defaultSettings.heroDescription,
      heroBadgeText:
        (db.heroBadgeText as string) || defaultSettings.heroBadgeText,
      heroPrimaryCTAText:
        (
          db.heroCTAButtons as Array<{
            text: string;
            href: string;
            style: string;
          }>
        )?.[0]?.text || defaultSettings.heroPrimaryCTAText,
      heroPrimaryCTALink:
        (
          db.heroCTAButtons as Array<{
            text: string;
        ...
        )?.[0]?.href || defaultSettings.heroPrimaryCTALink,
      heroSecondaryCTAText:
        ...
        )?.[1]?.text || defaultSettings.heroSecondaryCTAText,
      heroSecondaryCTALink:
        ...
        )?.[1]?.href || defaultSettings.heroSecondaryCTALink,
      heroParticlesEnabled:
        (db.heroParticlesConfig as Record<string, boolean>)?.enabled ?? true,

      statsEnabled:
        (db.sectionVisibility as Record<string, boolean>)?.stats ?? true,
      statsAnimated: (db.statsAnimated as boolean) ?? true,
      stats: (db.stats as LandingSettings["stats"]) || defaultSettings.stats,

      featuresEnabled:
        (db.sectionVisibility as Record<string, boolean>)?.features ?? true,
      featuresTitle:
        (db.featuresTitle as string) || defaultSettings.featuresTitle,
      featuresSubtitle:
        (db.featuresSubtitle as string) || defaultSettings.featuresSubtitle,
      features:
        (db.features as LandingSettings["features"]) ||
        defaultSettings.features,

      howItWorksEnabled:
        (db.sectionVisibility as Record<string, boolean>)?.howItWorks ?? true,
      howItWorksTitle:
        (db.howItWorksTitle as string) || defaultSettings.howItWorksTitle,
      howItWorksSubtitle:
        (db.howItWorksSubtitle as string) || defaultSettings.howItWorksSubtitle,
      howItWorksSteps:
        (db.howItWorksSteps as LandingSettings["howItWorksSteps"]) ||
        defaultSettings.howItWorksSteps,

      competitionsEnabled:
        (db.sectionVisibility as Record<string, boolean>)?.competitions ?? true,
      competitionsTitle:
        (db.competitionsTitle as string) || defaultSettings.competitionsTitle,
      competitionsSubtitle:
        (db.competitionsSubtitle as string) ||
        defaultSettings.competitionsSubtitle,
      competitionsDescription:
        (db.competitionsDescription as string) ||
        defaultSettings.competitionsDescription,
      competitionsCTAText:
        (db.competitionsCTAText as string) ||
        defaultSettings.competitionsCTAText,
      competitionsCTALink:
        (db.competitionsCTALink as string) ||
        defaultSettings.competitionsCTALink,

      challengesEnabled:
        (db.sectionVisibility as Record<string, boolean>)?.challenges ?? true,
      challengesTitle:
        (db.challengesTitle as string) || defaultSettings.challengesTitle,
      challengesSubtitle:
        (db.challengesSubtitle as string) || defaultSettings.challengesSubtitle,
      challengesDescription:
        (db.challengesDescription as string) ||
        defaultSettings.challengesDescription,
      challengesCTAText:
        (db.challengesCTAText as string) || defaultSettings.challengesCTAText,
      challengesCTALink:
        (db.challengesCTALink as string) || defaultSettings.challengesCTALink,

      ctaEnabled:
        (db.sectionVisibility as Record<string, boolean>)?.cta ?? true,
      ctaTitle: (db.ctaTitle as string) || defaultSettings.ctaTitle,
      ctaSubtitle: (db.ctaSubtitle as string) || defaultSettings.ctaSubtitle,
      ctaDescription:
        (db.ctaDescription as string) || defaultSettings.ctaDescription,
      ctaButtonText:
        (db.ctaButtonText as string) || defaultSettings.ctaButtonText,
      ctaButtonLink:
        (db.ctaButtonLink as string) || defaultSettings.ctaButtonLink,

      footerEnabled:
        (db.sectionVisibility as Record<string, boolean>)?.footer ?? true,
      footerCopyright:
        (db.footerCopyright as string) || defaultSettings.footerCopyright,
      footerDisclaimer:
        (db.footerDisclaimer as string) || defaultSettings.footerDisclaimer,
      footerRiskDisclaimer:
        (db.footerRiskDisclaimer as string) ||
        defaultSettings.footerRiskDisclaimer,
      footerMenuPlatform:
      ...
      enterpriseHeroTitle:
        (db.enterpriseHeroTitle as string) ||
        defaultSettings.enterpriseHeroTitle,
      enterpriseHeroSubtitle:
        (db.enterpriseHeroSubtitle as string) ||
        defaultSettings.enterpriseHeroSubtitle,
      enterpriseHeroDescription:
        (db.enterpriseHeroDescription as string) ||
        defaultSettings.enterpriseHeroDescription,
      enterpriseHeroBadge:
        (db.enterpriseHeroBadge as string) ||
        defaultSettings.enterpriseHeroBadge,
      enterpriseHeroCTAText:
        (db.enterpriseHeroCTAText as string) ||
        defaultSettings.enterpriseHeroCTAText,
      enterpriseHeroCTALink:
        (db.enterpriseHeroCTALink as string) ||
        defaultSettings.enterpriseHeroCTALink,

      enterpriseWhiteLabelEnabled:
        (db.enterpriseSectionVisibility as Record<string, boolean>)
          ?.whiteLabel ?? true,
      enterpriseWhiteLabelTitle:
        (db.enterpriseWhiteLabelTitle as string) ||
        defaultSettings.enterpriseWhiteLabelTitle,
      enterpriseWhiteLabelSubtitle:
        (db.enterpriseWhiteLabelSubtitle as string) ||
        defaultSettings.enterpriseWhiteLabelSubtitle,
      enterpriseWhiteLabelFeatures:
      ...
      enterpriseAdminEnabled:
        (db.enterpriseSectionVisibility as Record<string, boolean>)
          ?.adminShowcase ?? true,
      enterpriseAdminTitle:
        (db.enterpriseAdminTitle as string) ||
        defaultSettings.enterpriseAdminTitle,
      enterpriseAdminSubtitle:
        (db.enterpriseAdminSubtitle as string) ||
        defaultSettings.enterpriseAdminSubtitle,
      enterpriseAdminDescription:
        (db.enterpriseAdminDescription as string) ||
        defaultSettings.enterpriseAdminDescription,
      enterpriseAdminFeatures:
        (db.enterpriseAdminFeatures as LandingSettings["enterpriseAdminFeatures"]) ||
        defaultSettings.enterpriseAdminFeatures,

      enterprisePricingEnabled:
        (db.enterpriseSectionVisibility as Record<string, boolean>)?.pricing ??
        true,
      enterprisePricingTitle:
        (db.enterprisePricingTitle as string) ||
        defaultSettings.enterprisePricingTitle,
      enterprisePricingSubtitle:
        (db.enterprisePricingSubtitle as string) ||
        defaultSettings.enterprisePricingSubtitle,
      enterprisePricingTiers:
        (db.enterprisePricingTiers as LandingSettings["enterprisePricingTiers"]) ||
        defaultSettings.enterprisePricingTiers,

      enterpriseContactEnabled:
        (db.enterpriseSectionVisibility as Record<string, boolean>)?.contact ??
        true,
      enterpriseContactTitle:
        (db.enterpriseContactTitle as string) ||
        defaultSettings.enterpriseContactTitle,
      enterpriseContactSubtitle:
        (db.enterpriseContactSubtitle as string) ||
        defaultSettings.enterpriseContactSubtitle,
      enterpriseContactEmail:
        (db.enterpriseContactEmail as string) ||
        defaultSettings.enterpriseContactEmail,
      enterpriseContactPhone:
        (db.enterpriseContactPhone as string) ||
        defaultSettings.enterpriseContactPhone,
      enterpriseContactCTAText:
        (db.enterpriseContactCTAText as string) ||
        defaultSettings.enterpriseContactCTAText,
    };
  };
  ...
  const mapToDbSettings = (s: LandingSettings) => {
    return {
      ...
      heroCTAButtons: [
        {
          id: "1",
          text: s.heroPrimaryCTAText,
          href: s.heroPrimaryCTALink,
          style: "primary",
          icon: "Rocket",
          enabled: true,
        },
        {
          id: "2",
          text: s.heroSecondaryCTAText,
          href: s.heroSecondaryCTALink,
          style: "secondary",
          icon: "",
          enabled: true,
        },
      ...
      heroParticlesConfig: {
        enabled: s.heroParticlesEnabled,
        color: "#eab308",
        count: 80,
        speed: 1,
        shape: "circle",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400">
            Configure your Hero and Enterprise landing pages
          </p>
        </div>
        ...
        <CardContent className="py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Enable or disable the /enterprise page (for white-label
                  customers)
                </p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <Badge
                variant={
                  settings.enterprisePageEnabled ? "default" : "secondary"
                }
                className={settings.enterprisePageEnabled ? "bg-green-500" : ""}
              >
        ...
        <CardContent className="space-y-4">
          ...
          {getThemeById(settings.activeTheme) && (
            <div className="flex items-center gap-4 p-4 bg-gray-800/50 rounded-lg border border-cyan-500/30">
              <div
                ...
                style={{
                  background: getThemeById(settings.activeTheme)?.preview,
                }}
              />
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <Badge className="bg-cyan-500 text-black text-[10px]">
                    Active
                  </Badge>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="flex gap-1">
                    <div
                      ...
                      style={{
                        background: getThemeById(settings.activeTheme)?.colors
                          .primary,
                      }}
                      title="Primary"
                    />
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(v) => updateField("activeTheme", v)}
            >
            ...
            <AccordionItem value="themes" className="border-gray-700">
              <AccordionTrigger className="text-gray-300 hover:no-underline py-2">
                <span className="text-sm">
                  Browse All Themes ({allThemes.length})
                </span>
              </AccordionTrigger>
              <AccordionContent>
                  ...
                  {allThemes.map((theme) => (
                    ...
                    >
                      ...
                      <div className="p-1 bg-gray-800">
                        <p className="text-[9px] font-semibold text-white truncate text-center">
                          {theme.name}
                        </p>
                      </div>
                      {settings.activeTheme === theme.id && (
        ...
        <CardHeader className="pb-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <Badge
                variant={
                  settings.holidayThemesEnabled ? "default" : "secondary"
                }
        ...
        <CardContent className="space-y-6">
          ...
          <div className="p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg">
            <h5 className="text-sm font-semibold text-blue-400 mb-2">
              🎯 Automatic Theme Effects
            </h5>
            <p className="text-xs text-gray-400">
              Each theme has its own unique effects that are applied
              automatically:
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mt-2 text-xs">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="text-gray-300">
                  Halloween → Blood + Fog + Ghosts
                </span>
              </div>
              <div className="flex items-center gap-1">
                <span>🐰</span>
                <span className="text-gray-300">
                  Easter → Pastel Confetti + Eggs
                </span>
              </div>
              <div className="flex items-center gap-1">
                <span>🛒</span>
                <span className="text-gray-300">
                  Black Friday → Confetti + Tags
                </span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg">
                ...
                <Switch
                  checked={
                    settings.globalThemeEffects?.particlesEnabled ?? true
                  }
                  onCheckedChange={(v) =>
              ...
              <div className="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg">
                ...
                <Switch
                  checked={
                    settings.globalThemeEffects?.glowEffectsEnabled ?? true
                  }
                  onCheckedChange={(v) =>
                    updateField("globalThemeEffects", {
                      ...settings.globalThemeEffects,
                      glowEffectsEnabled: v,
                    })
                  }
                />
              </div>
              <div className="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg">
                ...
                <Switch
                  checked={
                    settings.globalThemeEffects?.animationsEnabled ?? true
                  }
                  onCheckedChange={(v) =>
                    updateField("globalThemeEffects", {
                      ...settings.globalThemeEffects,
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-cyan-400 text-sm font-mono">
                    {settings.globalThemeEffects?.snowIntensity ?? 30}%
                  </span>
                </div>
                <input
                  type="range"
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-red-400 text-sm font-mono">
                    {settings.globalThemeEffects?.bloodIntensity ?? 20}%
                  </span>
                </div>
                <input
                  type="range"
                  ...
                  onChange={(e) =>
                    updateField("globalThemeEffects", {
                      ...settings.globalThemeEffects,
                      bloodIntensity: parseInt(e.target.value),
                    })
                  }
                  className="w-full h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-red-500"
                />
                <p className="text-[10px] text-gray-500">
                  Used in Halloween theme
                </p>
              </div>
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-yellow-400 text-sm font-mono">
                    {settings.globalThemeEffects?.confettiIntensity ?? 30}%
                  </span>
                </div>
                <input
                  type="range"
                  ...
                  onChange={(e) =>
                    updateField("globalThemeEffects", {
                      ...settings.globalThemeEffects,
                      confettiIntensity: parseInt(e.target.value),
                    })
                  }
                  className="w-full h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-yellow-500"
                />
                <p className="text-[10px] text-gray-500">
                  Used in Easter & Black Friday themes
                </p>
              </div>
            </div>
          </div>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="Orbitron">
                        Orbitron (Gaming/Sci-Fi)
                      </SelectItem>
                      <SelectItem value="Rajdhani">
                        Rajdhani (Modern Gaming)
                      </SelectItem>
                      <SelectItem value="Press Start 2P">
                        Press Start 2P (Retro Pixel)
                      </SelectItem>
                      <SelectItem value="VT323">
                      ...
                      <SelectItem value="Mountains of Christmas">
          ...
          <p className="text-xs text-gray-500 mt-4">
            💡 <strong>Tip:</strong> Holiday themes automatically enable
            relevant effects (e.g., Christmas enables snow, Halloween enables
            blood drips).
          </p>
        </CardContent>
      </Card>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          >
            ...
            >
              <AccordionTrigger className="hover:no-underline">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-3 h-3 rounded-full ${settings.heroEnabled ? "bg-green-500" : "bg-gray-500"}`}
                  />
              ...
              <AccordionContent className="pt-4 pb-6 space-y-4">
                <div className="flex items-center justify-between pb-4 border-b border-gray-700">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(v) => updateField("heroEnabled", v)}
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("heroPrimaryCTAText", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("heroPrimaryCTALink", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("heroSecondaryCTAText", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("heroSecondaryCTALink", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <Switch
                    checked={settings.heroParticlesEnabled}
                    onCheckedChange={(v) =>
                      updateField("heroParticlesEnabled", v)
                    }
                  />
                </div>
              </AccordionContent>
            ...
            >
              <AccordionTrigger className="hover:no-underline">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-3 h-3 rounded-full ${settings.statsEnabled ? "bg-green-500" : "bg-gray-500"}`}
                  />
              ...
              <AccordionContent className="pt-4 pb-6 space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        Show counting numbers on hero page
                      </p>
                    </div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between pb-4 border-b border-gray-700">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(v) => updateField("statsAnimated", v)}
                  />
                </div>
                  ...
                  {settings.stats.map((stat) => (
                    ...
                    >
                      <Switch
                        ...
                        onCheckedChange={(v) =>
                          updateArrayItem("stats", stat.id, { enabled: v })
                        }
                      />
                      <Input
                        value={stat.value}
            ...
            >
              <AccordionTrigger className="hover:no-underline">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-3 h-3 rounded-full ${settings.featuresEnabled ? "bg-green-500" : "bg-gray-500"}`}
                  />
              ...
              <AccordionContent className="pt-4 pb-6 space-y-4">
                <div className="flex items-center justify-between pb-4 border-b border-gray-700">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(v) => updateField("featuresEnabled", v)}
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("featuresTitle", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("featuresSubtitle", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <Switch
                          ...
                          onCheckedChange={(v) =>
                            updateArrayItem("features", feature.id, {
                              enabled: v,
                            })
                          }
                        />
                        <Select
                          value={feature.icon}
                          onValueChange={(v) =>
                            updateArrayItem("features", feature.id, { icon: v })
                          }
                        >
            ...
            >
              <AccordionTrigger className="hover:no-underline">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-3 h-3 rounded-full ${settings.howItWorksEnabled ? "bg-green-500" : "bg-gray-500"}`}
                  />
              ...
              <AccordionContent className="pt-4 pb-6 space-y-4">
                <div className="flex items-center justify-between pb-4 border-b border-gray-700">
                  ...
                  <Switch
                    checked={settings.howItWorksEnabled}
                    onCheckedChange={(v) => updateField("howItWorksEnabled", v)}
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("howItWorksTitle", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                  <div>
                    <Label className="text-gray-400">Section Subtitle</Label>
                    <Input
                      value={settings.howItWorksSubtitle}
                      onChange={(e) =>
                        updateField("howItWorksSubtitle", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      variant="outline"
                      onClick={() =>
                        addItem("howItWorksSteps", {
                          id: Date.now().toString(),
                          step: settings.howItWorksSteps.length + 1,
                          title: "New Step",
                  ...
                  {settings.howItWorksSteps.map((step) => (
                    ...
                    >
                      <Switch
                        ...
                        onCheckedChange={(v) =>
                          updateArrayItem("howItWorksSteps", step.id, {
                            enabled: v,
                          })
                        }
                      />
                      <div className="w-10 h-10 rounded-full bg-yellow-500 text-gray-900 flex items-center justify-center font-bold">
                        {step.step}
                      </div>
                      ...
                      <Button
                        size="icon"
                        variant="ghost"
                        onClick={() => removeItem("howItWorksSteps", step.id)}
                        className="text-red-500 hover:text-red-400"
                      >
                        <Trash2 className="h-4 w-4" />
                      </Button>
            ...
            >
              <AccordionTrigger className="hover:no-underline">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-3 h-3 rounded-full ${settings.competitionsEnabled ? "bg-green-500" : "bg-gray-500"}`}
                  />
              ...
              <AccordionContent className="pt-4 pb-6 space-y-4">
                <div className="flex items-center justify-between pb-4 border-b border-gray-700">
                  <Label className="text-gray-300">
                    Enable Competitions Section
                  </Label>
                  <Switch
                    checked={settings.competitionsEnabled}
                    onCheckedChange={(v) =>
                      updateField("competitionsEnabled", v)
                    }
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("competitionsTitle", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("competitionsSubtitle", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      updateField("competitionsDescription", e.target.value)
                    }
                    className="bg-gray-900 border-gray-600 text-white mt-1"
                    rows={2}
                  />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("competitionsCTAText", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("competitionsCTALink", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
            ...
            >
              <AccordionTrigger className="hover:no-underline">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-3 h-3 rounded-full ${settings.challengesEnabled ? "bg-green-500" : "bg-gray-500"}`}
                  />
              ...
              <AccordionContent className="pt-4 pb-6 space-y-4">
                <div className="flex items-center justify-between pb-4 border-b border-gray-700">
                  <Label className="text-gray-300">
                    Enable Challenges Section
                  </Label>
                  <Switch
                    checked={settings.challengesEnabled}
                    onCheckedChange={(v) => updateField("challengesEnabled", v)}
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label className="text-gray-400">Section Title</Label>
                    <Input
                      value={settings.challengesTitle}
                      onChange={(e) =>
                        updateField("challengesTitle", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                  <div>
                    <Label className="text-gray-400">Badge/Subtitle</Label>
                    <Input
                      value={settings.challengesSubtitle}
                      onChange={(e) =>
                        updateField("challengesSubtitle", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                ...
                <div>
                  <Label className="text-gray-400">Description</Label>
                  <Textarea
                    value={settings.challengesDescription}
                    onChange={(e) =>
                      updateField("challengesDescription", e.target.value)
                    }
                    className="bg-gray-900 border-gray-600 text-white mt-1"
                    rows={2}
                  />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label className="text-gray-400">Button Text</Label>
                    <Input
                      value={settings.challengesCTAText}
                      onChange={(e) =>
                        updateField("challengesCTAText", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                  <div>
                    <Label className="text-gray-400">Button Link</Label>
                    <Input
                      value={settings.challengesCTALink}
                      onChange={(e) =>
                        updateField("challengesCTALink", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
            ...
            >
              <AccordionTrigger className="hover:no-underline">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-3 h-3 rounded-full ${settings.ctaEnabled ? "bg-green-500" : "bg-gray-500"}`}
                  />
              ...
              <AccordionContent className="pt-4 pb-6 space-y-4">
                <div className="flex items-center justify-between pb-4 border-b border-gray-700">
                  <Label className="text-gray-300">
                    Enable Final CTA Section
                  </Label>
                  <Switch
                    checked={settings.ctaEnabled}
                    onCheckedChange={(v) => updateField("ctaEnabled", v)}
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("ctaButtonLink", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
            ...
            >
              <AccordionTrigger className="hover:no-underline">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-3 h-3 rounded-full ${settings.footerEnabled ? "bg-green-500" : "bg-gray-500"}`}
                  />
              ...
              <AccordionContent className="pt-4 pb-6 space-y-6">
                <div className="flex items-center justify-between pb-4 border-b border-gray-700">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(v) => updateField("footerEnabled", v)}
                  />
                </div>
                ...
                <div>
                  <Label className="text-gray-400">
                    Additional Disclaimer (Optional)
                  </Label>
                  <Textarea
                    value={settings.footerDisclaimer}
                    onChange={(e) =>
                      updateField("footerDisclaimer", e.target.value)
                    }
                    className="bg-gray-900 border-gray-600 text-white mt-1"
                    rows={2}
        ...
        <TabsContent value="enterprise-page" className="space-y-4 mt-6">
          ...
          >
              ...
              <AccordionContent className="pt-4 pb-6 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("enterpriseHeroTitle", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("enterpriseHeroBadge", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      updateField("enterpriseHeroDescription", e.target.value)
                    }
                    className="bg-gray-900 border-gray-600 text-white mt-1"
                    rows={2}
                  />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("enterpriseHeroCTAText", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("enterpriseHeroCTALink", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
            ...
            <AccordionItem
              value="ent-whitelabel"
              className="bg-gray-800 border border-gray-700 rounded-lg px-4"
            >
              <AccordionTrigger className="hover:no-underline">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-3 h-3 rounded-full ${settings.enterpriseWhiteLabelEnabled ? "bg-green-500" : "bg-gray-500"}`}
                  />
              ...
              <AccordionContent className="pt-4 pb-6 space-y-4">
                <div className="flex items-center justify-between pb-4 border-b border-gray-700">
                  <Label className="text-gray-300">
                    Enable White Label Section
                  </Label>
                  <Switch
                    checked={settings.enterpriseWhiteLabelEnabled}
                    onCheckedChange={(v) =>
                      updateField("enterpriseWhiteLabelEnabled", v)
                    }
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("enterpriseWhiteLabelTitle", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      variant="outline"
                      onClick={() =>
                        addItem("enterpriseWhiteLabelFeatures", {
                          id: Date.now().toString(),
                          icon: "Star",
                          title: "New Feature",
            ...
            >
              <AccordionTrigger className="hover:no-underline">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-3 h-3 rounded-full ${settings.enterpriseAdminEnabled ? "bg-green-500" : "bg-gray-500"}`}
                  />
              ...
              <AccordionContent className="pt-4 pb-6 space-y-4">
                <div className="flex items-center justify-between pb-4 border-b border-gray-700">
                  <Label className="text-gray-300">
                    Enable Admin Showcase Section
                  </Label>
                  <Switch
                    checked={settings.enterpriseAdminEnabled}
                    onCheckedChange={(v) =>
                      updateField("enterpriseAdminEnabled", v)
                    }
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("enterpriseAdminTitle", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("enterpriseAdminSubtitle", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      updateField("enterpriseAdminDescription", e.target.value)
                    }
                    className="bg-gray-900 border-gray-600 text-white mt-1"
                    rows={2}
                  />
            ...
            >
              <AccordionTrigger className="hover:no-underline">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-3 h-3 rounded-full ${settings.enterprisePricingEnabled ? "bg-green-500" : "bg-gray-500"}`}
                  />
              ...
              <AccordionContent className="pt-4 pb-6 space-y-4">
                <div className="flex items-center justify-between pb-4 border-b border-gray-700">
                  ...
                  <Switch
                    checked={settings.enterprisePricingEnabled}
                    onCheckedChange={(v) =>
                      updateField("enterprisePricingEnabled", v)
                    }
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("enterprisePricingTitle", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("enterprisePricingSubtitle", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                ...
                <div className="space-y-3">
                  ...
                  {settings.enterprisePricingTiers.map((tier) => (
                    <div
                      key={tier.id}
                      className="p-4 bg-gray-900 rounded-lg space-y-3"
                    >
                      <div className="flex items-center gap-3">
                        <Switch
                          checked={tier.enabled}
                          onCheckedChange={(v) =>
                            updateArrayItem("enterprisePricingTiers", tier.id, {
                              enabled: v,
                            })
                          }
                        />
            ...
            >
              <AccordionTrigger className="hover:no-underline">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-3 h-3 rounded-full ${settings.enterpriseContactEnabled ? "bg-green-500" : "bg-gray-500"}`}
                  />
              ...
              <AccordionContent className="pt-4 pb-6 space-y-4">
                <div className="flex items-center justify-between pb-4 border-b border-gray-700">
                  ...
                  <Switch
                    checked={settings.enterpriseContactEnabled}
                    onCheckedChange={(v) =>
                      updateField("enterpriseContactEnabled", v)
                    }
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("enterpriseContactTitle", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("enterpriseContactSubtitle", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("enterpriseContactEmail", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("enterpriseContactPhone", e.target.value)
                      }
                      className="bg-gray-900 border-gray-600 text-white mt-1"
                    />
                  </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateField("enterpriseContactCTAText", e.target.value)
                    }
                    className="bg-gray-900 border-gray-600 text-white mt-1"
                  />
                </div>
