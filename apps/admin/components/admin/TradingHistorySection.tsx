...
export default function TradingHistorySection() {
  ...
  const fetchUserDetail = async (userId: string) => {
    ...
    try {
      const response = await fetch(
        `/api/trading-history/users/${userId}?contestType=${contestTypeFilter}&dateRange=${dateRange}`,
      );
  ...
  const getSelectedContest = () => {
    ...
    return (
      selectedUser.contests.find((c) => c.id === selectedContestId) || null
    );
  };
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  >
                    {selectedUser.user.totalPnl >= 0 ? "+" : ""}$
                    {selectedUser.user.totalPnl.toFixed(2)}
                  </p>
          ...
          <Card className="bg-gradient-to-br from-purple-500/10 to-purple-500/5 border-purple-500/20">
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-white">
                    {selectedUser.user.competitions +
                      selectedUser.user.challenges}
                  </p>
          ...
          <CardHeader className="pb-3">
            <div className="flex flex-col gap-4">
              ...
              <div className="w-full max-w-2xl mx-auto">
                <Label className="text-gray-400 text-xs mb-2 block text-center">
                  Select Contest
                </Label>
                <Select
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className="whitespace-nowrap">
                            {contest.name || "Unnamed"}
                          </span>
                          <Badge
                            variant="outline"
                            className="text-xs border-gray-600 shrink-0 ml-2"
                          >
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700/50">
                      ...
                      <p className="text-xl font-bold text-white">
                        {contest.summary.totalTrades}
                      </p>
                      <p className="text-xs text-gray-500 mt-1">
                        {contest.summary.winningTrades}W /{" "}
                        {contest.summary.losingTrades}L
                      </p>
                    </div>
                    <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700/50">
                    ...
                    <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700/50">
                      ...
                      <p
                        className={cn(
                          "text-xl font-bold",
                          contest.summary.totalPnl >= 0
                            ? "text-emerald-400"
                            : "text-red-400",
                        )}
                      >
                        {contest.summary.totalPnl >= 0 ? "+" : ""}$
                        {contest.summary.totalPnl.toFixed(2)}
                      </p>
                    </div>
                    <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700/50">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-lg border border-gray-700">
                  ...
                  <div className="text-right">
                    ...
                    >
                      {selectedTrade.realizedPnlPercentage >= 0 ? "+" : ""}
                      {selectedTrade.realizedPnlPercentage.toFixed(2)}%
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-4">
                    <div className="p-3 bg-gray-800/30 rounded-lg border border-gray-700/50">
                      ...
                      <p className="text-lg font-mono text-white">
                        ${selectedTrade.marginUsed.toFixed(2)}
                      </p>
                    </div>
                    <div className="p-3 bg-gray-800/30 rounded-lg border border-gray-700/50">
                      ...
                      <Badge
                        ...
                        className={cn(
                          "text-sm",
                          selectedTrade.closeReason === "take_profit" &&
                            "border-emerald-500/50 text-emerald-400 bg-emerald-500/10",
                          selectedTrade.closeReason === "stop_loss" &&
                            "border-red-500/50 text-red-400 bg-red-500/10",
                          selectedTrade.closeReason === "user" &&
                            "border-blue-500/50 text-blue-400 bg-blue-500/10",
                          selectedTrade.closeReason === "margin_call" &&
                            "border-orange-500/50 text-orange-400 bg-orange-500/10",
                        )}
                      >
                    ...
                    <div className="p-3 bg-gray-800/30 rounded-lg border border-gray-700/50">
                      ...
                      <p className="text-lg text-white">
                        {formatDuration(selectedTrade.holdingTimeSeconds)}
                      </p>
                    </div>
                    <div className="p-3 bg-gray-800/30 rounded-lg border border-gray-700/50">
                  ...
                  <div className="p-3 bg-gray-800/30 rounded-lg border border-gray-700/50">
                    ...
                    {selectedTrade.hadStopLoss ? (
                      <p className="text-lg font-mono text-red-400">
                        {selectedTrade.stopLossPrice?.toFixed(5)}
                      </p>
                    ) : (
                  ...
                  <div className="p-3 bg-gray-800/30 rounded-lg border border-gray-700/50">
                    ...
                    {selectedTrade.hadTakeProfit ? (
                      <p className="text-lg font-mono text-emerald-400">
                        {selectedTrade.takeProfitPrice?.toFixed(5)}
                      </p>
                    ) : (
                      <p className="text-lg text-gray-500">Not set</p>
                    )}
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="p-3 bg-gray-800/30 rounded-lg border border-gray-700/50">
                    ...
                    <p className="text-sm text-white">
                      {new Date(selectedTrade.closedAt).toLocaleString()}
                    </p>
                  </div>
                </div>
              </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1">
            View and analyze trading history for all users across competitions
            and challenges
          </p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-wrap items-end gap-4">
            ...
            <div className="w-[160px]">
              ...
              <Select
                ...
                onValueChange={(v: "all" | "competition" | "challenge") =>
                  setContestTypeFilter(v)
                }
              >
            ...
            <div className="w-[140px]">
              ...
              <Select
                value={dateRange}
                onValueChange={(v: "all" | "7d" | "30d" | "90d") =>
                  setDateRange(v)
                }
              >
                <SelectTrigger className="bg-gray-900/50 border-gray-700 text-white">
            ...
            <div className="w-[140px]">
              ...
              <Select
                value={sortBy}
                onValueChange={(v: "trades" | "pnl" | "winrate") =>
                  setSortBy(v)
                }
              >
                <SelectTrigger className="bg-gray-900/50 border-gray-700 text-white">
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-white">
                  {users
                    .reduce((sum, u) => sum + u.totalTrades, 0)
                    .toLocaleString()}
                </p>
                <p className="text-xs text-gray-400">Total Trades</p>
              </div>
