...
export default function FeeSettingsSection() {
      ...
      if (response.ok) {
        ...
        setSettings({
          platformDepositFeePercentage:
            data.settings?.platformDepositFeePercentage ?? 2,
          platformWithdrawalFeePercentage:
            data.settings?.platformWithdrawalFeePercentage ?? 2,
          bankDepositFeePercentage:
            data.settings?.bankDepositFeePercentage ?? 2.9,
          bankDepositFeeFixed: data.settings?.bankDepositFeeFixed ?? 0.3,
          bankWithdrawalFeePercentage:
            data.settings?.bankWithdrawalFeePercentage ?? 0.25,
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.error(
        error instanceof Error ? error.message : "Failed to save fee settings",
      );
      console.error(error);
    } finally {
      setSaving(false);
  ...
  const bankDepositFee =
    exampleDeposit * (settings.bankDepositFeePercentage / 100) +
  ...
  const bankWithdrawalFee =
    exampleWithdrawal * (settings.bankWithdrawalFeePercentage / 100) +
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-blue-200">
              ...
              <ul className="list-disc list-inside space-y-1 text-blue-300">
                <li>
                  <strong>Platform Fees</strong>: What you charge users (your
                  revenue)
                </li>
                <li>
                  <strong>Bank Fees</strong>: What Stripe/banks charge you (your
                  cost)
                </li>
                <li>
                  <strong>Net Earnings</strong> = Platform Fees - Bank Fees
                </li>
              </ul>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="bg-gray-900 border-gray-700">
          <CardHeader>
            ...
            <CardDescription>
              Fee charged to users when they deposit
            </CardDescription>
          </CardHeader>
        ...
        <Card className="bg-gray-900 border-gray-700">
          <CardHeader>
            ...
            <CardDescription>
              What Stripe charges you for deposits
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings((s) => ({
                      ...s,
                      bankDepositFeePercentage: parseFloat(e.target.value) || 0,
                    }))
                  }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings((s) => ({
                      ...s,
                      bankDepositFeeFixed: parseFloat(e.target.value) || 0,
                    }))
                  }
                  className="mt-1 bg-gray-800 border-gray-700 text-white"
                />
        ...
        <Card className="bg-gray-900 border-gray-700">
          <CardHeader>
            ...
            <CardDescription>
              Fee charged to users when they withdraw
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
        ...
        <Card className="bg-gray-900 border-gray-700">
          <CardHeader>
            ...
            <CardDescription>
              What bank charges for payouts to users
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings((s) => ({
                      ...s,
                      bankWithdrawalFeeFixed: parseFloat(e.target.value) || 0,
                    }))
                  }
                  className="mt-1 bg-gray-800 border-gray-700 text-white"
                />
          ...
          {(netDepositEarning < 0 || netWithdrawalEarning < 0) && (
            <div className="mt-4 p-3 bg-red-900/30 border border-red-500/50 rounded-lg">
              <p className="text-sm text-red-400 flex items-center gap-2">
                ...
                Warning: Your platform fees don't cover bank costs. You're
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-gray-300">
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-400">
                <li>
                  <strong>Transaction Limits</strong> (min deposit/withdrawal) →
                  Settings → Currency
                </li>
                <li>
