...
export default function PerformanceSimulatorSection() {
    ...
    try {
      ...
      if (data.success) {
        ...
        if (loadedConfig.tradersPerCompetition < loadedConfig.virtualUsers) {
          ...
          toast.info(
            `Auto-corrected traders per competition to ${loadedConfig.virtualUsers} to match virtual users`,
          );
        }
  ...
  const saveConfig = async () => {
    ...
    try {
      ...
      const configToSave = {
        ...config,
        tradersPerCompetition: Math.max(
          config.tradersPerCompetition,
          config.virtualUsers,
        ),
      };
  ...
  const runAIAnalysis = async (runId: string) => {
    try {
      ...
      if (data.success && data.aiAnalysis) {
        toast.success(
          `✅ AI Analysis Complete! Score: ${data.aiAnalysis.performanceScore}/100`,
        );
  ...
  const cleanupTestData = async (runId: string) => {
    if (
      !confirm(
        "This will delete all test data created during this simulation. Are you sure?",
      )
    ) {
      return;
    }
    ...
    try {
      ...
      if (data.success) {
        toast.success(
          `Cleanup complete: ${JSON.stringify(data.cleanupResult)}`,
        );
        fetchRuns();
      } else {
  ...
  const calculateSettingsFromUsers = (
    users: number,
    ...
    const tradesPerUser = Math.min(
      Math.max(Math.ceil(100 / Math.sqrt(users)), 5),
      50,
    ); // Scale inversely with users
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-1">
            Comprehensive load testing and stress testing for the trading
            platform
          </p>
        </div>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      ...
                      <Slider
                        ...
                        onValueChange={([v]) =>
                          setConfig({ ...config, userRegistrationRate: v })
                        }
                        min={1}
                        max={100}
                        step={1}
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        {config.userRegistrationRate} users/second
                      </p>
                    </div>
                    <div>
                      <Label className="text-gray-300 flex items-center gap-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setConfig({
                            ...config,
                            tradesPerUser: parseInt(e.target.value) || 10,
                          })
                        }
                        className="mt-2 bg-gray-900 border-gray-700 text-white"
                      />
                    ...
                    <div>
                      ...
                      <Slider
                        ...
                        onValueChange={([v]) =>
                          setConfig({ ...config, tpSlPercentage: v })
                        }
                        min={0}
                        max={100}
                        step={5}
                      ...
                      />
                      <p className="text-xs text-gray-500 mt-1">
                        {config.tpSlPercentage}% of trades have TP/SL
                      </p>
                    </div>
                  </CardContent>
                </Card>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setConfig({
                            ...config,
                            competitions: parseInt(e.target.value) || 0,
                          })
                        }
                        className="mt-2 bg-gray-900 border-gray-700 text-white"
                      />
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setConfig({
                            ...config,
                            tradersPerCompetition:
                              parseInt(e.target.value) || config.virtualUsers,
                          })
                        }
                        className="mt-2 bg-gray-900 border-gray-700 text-white"
                      />
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setConfig({
                            ...config,
                            challenges: parseInt(e.target.value) || 0,
                          })
                        }
                        className="mt-2 bg-gray-900 border-gray-700 text-white"
                      />
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setConfig({
                            ...config,
                            tradingDuration: parseInt(e.target.value) || 30,
                          })
                        }
                        className="mt-2 bg-gray-900 border-gray-700 text-white"
                      />
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      <Label className="text-gray-300">
                        Enable Hardware Stress
                      </Label>
                      <Switch
                        checked={config.enableHardwareStress}
                        onCheckedChange={(v) =>
                          setConfig({ ...config, enableHardwareStress: v })
                        }
                      />
                    </div>
                      ...
                      <>
                        <div>
                          ...
                          <Slider
                            ...
                            onValueChange={([v]) =>
                              setConfig({ ...config, cpuStressLevel: v })
                            }
                            min={1}
                            max={10}
                            step={1}
                          ...
                          />
                          <p className="text-xs text-gray-500 mt-1">
                            Level {config.cpuStressLevel}/10
                          </p>
                        </div>
                        <div>
                          <Label className="text-gray-300">
                          ...
                          <Slider
                            ...
                            onValueChange={([v]) =>
                              setConfig({ ...config, memoryStressLevel: v })
                            }
                            min={1}
                            max={10}
                            step={1}
                          ...
                          />
                          <p className="text-xs text-gray-500 mt-1">
                            Level {config.memoryStressLevel}/10
                          </p>
                        </div>
                      </>
                    )}
                  ...
                  <CardContent className="space-y-4">
                    <div className="p-3 bg-orange-500/10 border border-orange-500/30 rounded-lg mb-4">
                      <p className="text-xs text-orange-300">
                        ⚡ <strong>Concurrent Mode</strong> sends multiple
                        requests simultaneously, simulating real production
                        load. Use this to stress test your server and find
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          Fire requests in parallel instead of sequentially
                        </p>
                      </div>
                      <Switch
                        checked={config.concurrentMode || false}
                        onCheckedChange={(v) =>
                          setConfig({ ...config, concurrentMode: v })
                        }
                      />
                    </div>
                    {config.concurrentMode && (
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mb-2">
                          Number of parallel requests per wave
                        </p>
                        <Slider
                          value={[config.concurrentBatchSize || 50]}
                          onValueChange={([v]) =>
                            setConfig({ ...config, concurrentBatchSize: v })
                          }
                          min={10}
                          max={200}
                          step={10}
                        ...
                        <p className="text-xs text-orange-400 mt-1">
                          {config.concurrentBatchSize || 50} parallel
                          requests/wave
                          {(config.concurrentBatchSize || 50) > 100 &&
                            " ⚠️ High load!"}
                        </p>
                      </div>
                    )}
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(v) =>
                          setConfig({ ...config, useAIPatterns: v })
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(v) =>
                          setConfig({ ...config, useAIAnalysis: v })
                        }
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          Payment approvals, user management
                        </p>
                      </div>
                      <Switch
                        checked={config.simulateAdminActions}
                        onCheckedChange={(v) =>
                          setConfig({ ...config, simulateAdminActions: v })
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          Test fraud detection with multi-accounting
                        </p>
                      </div>
                      <Switch
                        checked={config.simulateFraud}
                        onCheckedChange={(v) =>
                          setConfig({ ...config, simulateFraud: v })
                        }
                      />
                    </div>
                    {config.simulateFraud && (
                      <div>
                        ...
                        <Slider
                          ...
                          onValueChange={([v]) =>
                            setConfig({ ...config, fraudPercentage: v })
                          }
                          min={1}
                          max={20}
                          step={1}
                        ...
                        />
                        <p className="text-xs text-gray-500 mt-1">
                          {config.fraudPercentage}% of users are fraudulent
                        </p>
                      </div>
                    )}
                  </CardContent>
          ...
          {currentRun ? (
              ...
              <Card className="bg-gray-800/50 border-gray-700">
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-gray-500 mt-2">
                    Step {currentRun.progress.currentStep} of{" "}
                    {currentRun.progress.totalSteps} (
                    {currentRun.progress.percentage}%)
                  </p>
                </CardContent>
              </Card>
                ...
                <Card className="bg-gray-800/30 border-gray-700">
                  <CardContent className="p-4">
                    ...
                    <p className="text-2xl font-bold text-white">
                      {currentRun.metrics.totalRequests.toLocaleString()}
                    </p>
                  </CardContent>
                </Card>
                <Card className="bg-gray-800/30 border-gray-700">
                  <CardContent className="p-4">
                    ...
                    <p className="text-2xl font-bold text-emerald-400">
                      {currentRun.metrics.totalRequests > 0
                        ? (
                            (currentRun.metrics.successfulRequests /
                              currentRun.metrics.totalRequests) *
                            100
                          ).toFixed(1)
                        : 0}
                      %
                ...
                <Card className="bg-gray-800/30 border-gray-700">
                  <CardContent className="p-4">
                    ...
                    <p className="text-2xl font-bold text-amber-400">
                      {currentRun.metrics.requestsPerSecond.toFixed(1)}
                    </p>
                  </CardContent>
                </Card>
              </div>
                        ...
                        >
                          ...
                          <div className="text-right">
                            ...
                            {tc.metrics?.avgResponseTime && (
                              <p className="text-xs text-gray-500">
                                {tc.metrics.avgResponseTime.toFixed(0)}ms avg
                              </p>
                            )}
                          </div>
                        </div>
            ...
            <Card className="bg-gray-800/50 border-gray-700">
              <CardContent className="py-12 text-center">
                ...
                <p className="text-sm text-gray-500 mt-2">
                  Configure and start a simulation to see live progress
                </p>
              </CardContent>
            </Card>
          )}
          ...
          {currentRun && currentRun.status === "completed" ? (
            <>
              ...
              <div className="flex flex-wrap gap-2 p-3 bg-gray-800/30 rounded-lg border border-gray-700">
                ...
                <Button
                  ...
                  onClick={() =>
                    document
                      .getElementById("section-hardware")
                      ?.scrollIntoView({ behavior: "smooth" })
                  }
                >
                  🖥️ Hardware
                  ...
                  <Card className="bg-gradient-to-br from-amber-500/10 to-orange-500/10 border-amber-500/30">
                    <CardContent className="p-4 text-center">
                      ...
                      <p
                        className={cn(
                          "text-3xl font-bold",
                          currentRun.metrics.avgResponseTime < 500
                            ? "text-emerald-400"
                            : currentRun.metrics.avgResponseTime < 1000
                              ? "text-amber-400"
                              : "text-red-400",
                        )}
                      >
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        P99: {currentRun.metrics.p99ResponseTime.toFixed(0)}ms
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border-purple-500/30">
                    <CardContent className="p-4 text-center">
                      ...
                      <p className="text-3xl font-bold text-purple-400">
                        {currentRun.duration
                          ? Math.round(currentRun.duration / 1000)
                          : 0}
                        s
                      </p>
                      <p className="text-sm text-gray-400">Total Duration</p>
                      <p className="text-xs text-gray-500 mt-1">
                        Error: {currentRun.metrics.errorRate.toFixed(1)}%
                      </p>
                    </CardContent>
                  </Card>
                </div>
                  ...
                  <CardContent className="p-4">
                    <div className="flex flex-wrap justify-around gap-4">
                      <div className="text-center min-w-[80px]">
                        ...
                        <p className="text-2xl font-bold text-white">
                          {currentRun.metrics.usersCreated}
                        </p>
                      ...
                      <div className="text-center min-w-[80px]">
                        ...
                        <p className="text-2xl font-bold text-white">
                          {currentRun.metrics.competitionsCreated}
                        </p>
                      ...
                      <div className="text-center min-w-[80px]">
                        ...
                        <p className="text-2xl font-bold text-white">
                          {currentRun.metrics.challengesCreated}
                        </p>
                      ...
                      <div className="text-center min-w-[80px]">
                        ...
                        <p className="text-2xl font-bold text-white">
                          {currentRun.metrics.tradesExecuted}
                        </p>
                      ...
                      <div className="text-center min-w-[80px]">
                        ...
                        <p className="text-2xl font-bold text-white">
                          {currentRun.metrics.depositsProcessed || 0}
                        </p>
              ...
              <div id="section-ai">
                ...
                {currentRun.aiAnalysis &&
                currentRun.aiAnalysis.performanceScore !== undefined ? (
                  <div className="space-y-6">
                          ...
                          <div className="relative w-28 h-28 mx-auto mb-3">
                            <svg className="w-28 h-28 transform -rotate-90">
                              ...
                              <circle
                                ...
                                r="48"
                                stroke={
                                  currentRun.aiAnalysis.performanceScore >= 80
                                    ? "#10b981"
                                    : currentRun.aiAnalysis.performanceScore >=
                                        60
                                      ? "#f59e0b"
                                      : "#ef4444"
                                }
                        ...
                        <CardContent className="p-6 text-center space-y-4">
                          <div>
                            ...
                            <Badge
                              className={cn(
                                "text-2xl px-4 py-1",
                                currentRun.aiAnalysis.overallGrade === "A" &&
                                  "bg-emerald-500/20 text-emerald-300",
                                currentRun.aiAnalysis.overallGrade === "B" &&
                                  "bg-green-500/20 text-green-300",
                                currentRun.aiAnalysis.overallGrade === "C" &&
                                  "bg-amber-500/20 text-amber-300",
                                currentRun.aiAnalysis.overallGrade === "D" &&
                                  "bg-orange-500/20 text-orange-300",
                                currentRun.aiAnalysis.overallGrade === "F" &&
                                  "bg-red-500/20 text-red-300",
                              )}
                            >
                              {currentRun.aiAnalysis.overallGrade ||
                                (currentRun.aiAnalysis.performanceScore >= 90
                                  ? "A"
                                  : currentRun.aiAnalysis.performanceScore >= 80
                                    ? "B"
                                    : currentRun.aiAnalysis.performanceScore >=
                          ...
                          <div>
                            ...
                            <Badge
                              className={cn(
                                "text-sm",
                                currentRun.aiAnalysis.productionReadiness ===
                                  "ready" &&
                                  "bg-emerald-500/20 text-emerald-300",
                                currentRun.aiAnalysis.productionReadiness ===
                                  "needs_work" &&
                        ...
                        <CardContent className="p-4 space-y-2">
                          ...
                          {currentRun.aiAnalysis.scalabilityAssessment ? (
                            ...
                            <p className="text-gray-400 text-sm">
                              Run AI analysis for scalability info
                            </p>
                          )}
                        </CardContent>
                      </Card>
                      ...
                      <CardContent className="p-4">
                        ...
                        <ScrollArea className="h-[200px]">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                            {currentRun.aiAnalysis.findings?.map(
                              (finding, i) => (
                                <div
                                  key={i}
                                  className={cn(
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      {currentRun.aiAnalysis.bottlenecks?.length > 0 && (
                        <Card className="bg-red-500/5 border-red-500/30">
                          <CardContent className="p-4">
                            <p className="text-xs text-red-400 uppercase font-medium mb-3">
                      ...
                      {currentRun.aiAnalysis.recommendations?.length > 0 && (
                        <Card className="bg-emerald-500/5 border-emerald-500/30">
                          <CardContent className="p-4">
                            <p className="text-xs text-emerald-400 uppercase font-medium mb-3">
                              💡 Recommendations
                            </p>
                            <div className="space-y-2">
                              {currentRun.aiAnalysis.recommendations
                                .slice(0, 6)
                                .map((rec, i) => (
                                  <div
                                    key={i}
                    ...
                    {(currentRun.aiAnalysis.riskAssessment ||
                      currentRun.aiAnalysis.nextSteps) && (
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {/* Risk Assessment */}
                        {currentRun.aiAnalysis.riskAssessment &&
                          currentRun.aiAnalysis.riskAssessment.productionRisks
                            ?.length > 0 && (
                            <Card className="bg-orange-500/5 border-orange-500/30">
                              <CardContent className="p-4">
                                <p className="text-xs text-orange-400 uppercase font-medium mb-3">
                                  ⚡ Risk Assessment
                                </p>
                                <div className="space-y-2">
                                  <p className="text-xs text-gray-500 uppercase">
                                  ...
                                  <ul className="space-y-1">
                                    {currentRun.aiAnalysis.riskAssessment.productionRisks.map(
                                      (risk, i) => (
                                        <li
                                          key={i}
                                  ...
                                  {currentRun.aiAnalysis.riskAssessment
                                    ...
                                    <>
                                      ...
                                      <ul className="space-y-1">
                                        {currentRun.aiAnalysis.riskAssessment.mitigations.map(
                                          (m, i) => (
                                            <li
                                              key={i}
                                              className="text-xs text-emerald-400 flex items-start gap-1"
                                            >
                                              <span>✓</span> {m}
                                            </li>
                                          ),
                        ...
                        {(currentRun.aiAnalysis.nextSteps?.length ?? 0) > 0 && (
                          <Card className="bg-blue-500/5 border-blue-500/30">
                            <CardContent className="p-4">
                              <p className="text-xs text-blue-400 uppercase font-medium mb-3">
                                📝 Next Steps
                              </p>
                              <ol className="space-y-2">
                                {currentRun.aiAnalysis.nextSteps?.map(
                                  (step, i) => (
                                    <li
                                      key={i}
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                          <BarChart
                            data={[
                              {
                                name: "Avg",
                                value: currentRun.metrics.avgResponseTime,
                              },
                              {
                                name: "P95",
                                value: currentRun.metrics.p95ResponseTime,
                              },
                              {
                                name: "P99",
                                value: currentRun.metrics.p99ResponseTime,
                              },
                              {
                                name: "Max",
                                value: currentRun.metrics.maxResponseTime,
                              },
                            ]}
                          >
                            <CartesianGrid
                          ...
                          <PieChart>
                            <Pie
                              data={[
                                {
                                  name: "Success",
                                  value: currentRun.metrics.successfulRequests,
                                },
                                {
                                  name: "Failed",
                                  value: currentRun.metrics.failedRequests,
                                },
                              ]}
                              cx="50%"
                              cy="50%"
                  ...
                  <Card className="bg-gray-800/50 border-gray-700 lg:col-span-2">
                    ...
                    <CardContent>
                      <div className="h-48">
                        <ResponsiveContainer width="100%" height="100%">
                          <AreaChart
                            data={currentRun.hardwareMetrics.map((m, i) => ({
                              time: i,
                              cpu: m.cpu.usage,
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="text-center p-4 bg-gradient-to-br from-red-500/10 to-orange-500/10 rounded-lg border border-red-500/20">
                        ...
                        <p
                          className={cn(
                            "text-2xl font-bold",
                            currentRun.peakMetrics.maxCpuUsage > 90
                              ? "text-red-400"
                              : currentRun.peakMetrics.maxCpuUsage > 70
                                ? "text-amber-400"
                                : "text-emerald-400",
                          )}
                        >
                      ...
                      <div className="text-center p-4 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-lg border border-blue-500/20">
                        ...
                        <p
                          className={cn(
                            "text-2xl font-bold",
                            currentRun.peakMetrics.maxMemoryUsage > 90
                              ? "text-red-400"
                              : currentRun.peakMetrics.maxMemoryUsage > 70
                                ? "text-amber-400"
                                : "text-emerald-400",
                          )}
                        >
                      ...
                      <div className="text-center p-4 bg-gradient-to-br from-cyan-500/10 to-teal-500/10 rounded-lg border border-cyan-500/20">
                        ...
                        <p className="text-2xl font-bold text-cyan-400">
                          {(
                            currentRun.peakMetrics.maxQueryTime || 0
                          ).toLocaleString()}
                        </p>
              ...
              <div id="section-tests">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {Array.from(
                    new Set(currentRun.testCases.map((tc) => tc.category)),
                  ).map((category) => {
                    const categoryTests = currentRun.testCases.filter(
                      (tc) => tc.category === category,
                    );
                    const passedCount = categoryTests.filter(
                      (tc) => tc.status === "passed",
                    ).length;
                            ...
                            {currentRun.testCases.map((tc, i) => (
                              ...
                              >
                                ...
                                <td className="text-center py-2 px-2 text-blue-400">
                                  {tc.metrics?.avgResponseTime?.toFixed(0) ||
                                    "-"}
                                  ms
                                </td>
                                <td className="text-center py-2 px-2 text-amber-400">
                                  {tc.metrics?.p95ResponseTime?.toFixed(0) ||
                                    "-"}
                                  ms
                                </td>
            ...
            <Card className="bg-gray-800/50 border-gray-700">
              <CardContent className="py-12 text-center">
                ...
                <p className="text-sm text-gray-500 mt-2">
                  Run a simulation to see detailed results and AI analysis
                </p>
              </CardContent>
            </Card>
          )}
          ...
          {currentRun ? (
            <Card className="bg-gray-800/50 border-gray-700">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">
                  {
                    currentRun.testCases.filter((tc) => tc.status === "passed")
                      .length
                  }{" "}
                  / {currentRun.testCases.length} tests passed
                </CardDescription>
              </CardHeader>
              <CardContent>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">
                            ...
                            requests • {run.metrics.usersCreated} users •{" "}
                            {run.metrics.tradesExecuted} trades
                          </p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
