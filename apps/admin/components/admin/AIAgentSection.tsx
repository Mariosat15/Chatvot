...
const INFORMATIONAL_ACTIONS = [
  {
    ...
    label: "How to create competition",
    prompt:
      "How do I create a new competition? Walk me through the process step by step.",
  },
  {
    icon: <Brain className="h-4 w-4" />,
    label: "How VAT works",
    prompt:
      "How does VAT work in the system? How do I change the VAT percentage?",
  },
  {
    icon: <Brain className="h-4 w-4" />,
    label: "How winners evaluated",
    prompt:
      "How does the system evaluate competition winners? What are the ranking methods and tie breakers?",
  },
  {
    icon: <Brain className="h-4 w-4" />,
    label: "How withdrawals work",
    prompt:
      "Explain how withdrawals work. What are automatic vs manual processing modes?",
  },
  {
    icon: <Brain className="h-4 w-4" />,
    label: "How fraud detection works",
    prompt:
      "Explain how the fraud detection system works. What triggers alerts and how should I handle them?",
  },
  {
    icon: <Brain className="h-4 w-4" />,
    label: "Badge & XP system",
    prompt: "How does the badge and XP system work? How can I configure it?",
  },
  {
    icon: <Brain className="h-4 w-4" />,
    label: "How deposits work",
    prompt:
      "How do deposits work? Explain the flow from payment to wallet credit.",
  },
  {
    icon: <Brain className="h-4 w-4" />,
    label: "How KYC works",
    prompt:
      "How does the KYC verification process work? What are the steps and requirements?",
  },
];
...
const COMMAND_ACTIONS = [
  // Dashboard
  {
    ...
    prompt:
      "Give me a dashboard overview with all key metrics - users, revenue, active competitions, pending items",
  },
  ...
  // Fraud & Security
  {
    ...
    prompt:
      "Show me all users who share the same payment method (potential fraud)",
  },
  {
    icon: <AlertTriangle className="h-4 w-4" />,
    label: "Fraud alerts",
    prompt: "Show me all active fraud alerts with high severity",
  },
  {
    icon: <Shield className="h-4 w-4" />,
    label: "High risk users",
    prompt: "List all high risk users with suspicion scores above 50",
  },
  ...
  // Financial
  {
    ...
    prompt:
      "Generate a detailed financial summary for this month including deposits, withdrawals, fees, VAT, and platform earnings",
  },
  {
    icon: <CreditCard className="h-4 w-4" />,
    label: "Reconciliation",
    prompt:
      "Run a reconciliation check on all transactions from the last 7 days",
  },
  {
    icon: <Coins className="h-4 w-4" />,
    label: "Fee breakdown",
    prompt:
      "Show me a detailed fee breakdown - platform fees, bank fees, and net earnings for this month",
  },
  {
    icon: <FileText className="h-4 w-4" />,
    label: "VAT report",
    prompt: "Generate a VAT report for this quarter",
  },
  ...
  // Competitions & Challenges
  {
    ...
    prompt:
      "List all active competitions with their details and participant counts",
  },
  {
    icon: <Zap className="h-4 w-4" />,
    label: "1v1 Challenges",
    prompt: "Show me all active 1v1 challenges and their current status",
  },
  ...
  // Trading
  {
    ...
    prompt: "Show all currently open trading positions across all competitions",
  },
  {
    icon: <AlertTriangle className="h-4 w-4" />,
    label: "Margin at risk",
    prompt: "Which users are at risk of margin call or liquidation?",
  },
  ...
  // Users
  {
    ...
    label: "Online users",
    prompt: "Who is currently online on the platform?",
  },
  {
    icon: <Shield className="h-4 w-4" />,
    label: "KYC pending",
    prompt: "List all users pending KYC verification",
  },
  {
    icon: <Wallet className="h-4 w-4" />,
    label: "Pending withdrawals",
    prompt: "List all pending withdrawal requests that need review",
  },
];
    ...
    return (
      <Card className="bg-gray-800/50 border-gray-700">
        <CardContent className="p-12 text-center">
          ...
          <Button
            onClick={() =>
              (window.location.href = "/dashboard?section=environment")
            }
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Intelligent assistant for back-office operations, security, and
              compliance
            </p>
          </div>
        </div>
              ...
              {messages.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center p-8">
                  ...
                  <p className="text-gray-400 max-w-md mb-8">
                    I can help you with fraud detection, user management,
                    payment reconciliation, KYC checks, and more. Try asking me
                    something or use a quick action.
                  </p>
                          ...
                          !message.isStreaming && (
                            <div className="mt-2 p-2 rounded-lg bg-amber-500/10 border border-amber-500/20">
                              <p className="text-[10px] text-amber-400/80 flex items-center gap-1.5">
                                ...
                                <span>
                                  Data is masked for AI privacy (User 1, User
                                  2). Tables show real data. Always verify in
                                  system.
                                </span>
                              </p>
                            </div>
            ...
            <div className="p-4 border-t border-gray-700 space-y-3">
              ...
              <div className="px-3 py-2 rounded-lg bg-gradient-to-r from-amber-500/5 to-red-500/5 border border-amber-500/20 space-y-1.5">
                <p className="text-[11px] text-amber-400/70 flex items-start gap-2">
                  ...
                  <span>
                    <strong>Data Privacy:</strong> Sensitive data (emails, IDs,
                    amounts) is masked before sending to AI. Individual users
                    appear as &quot;user_0001&quot;, amounts as ranges.
                  </span>
                </p>
                <p className="text-[11px] text-amber-400/70 flex items-start gap-2">
                  <AlertTriangle className="h-3.5 w-3.5 shrink-0 mt-0.5 text-red-400" />
                  <span className="text-red-400/80">
                    <strong>⚠️ Third-Party Warning:</strong> Use at your own
                    discretion. Data queries are processed by OpenAI. Despite
                    masking, exercise caution with sensitive operations.
                  </span>
                </p>
                <p className="text-[11px] text-gray-500 flex items-start gap-2 pt-1 border-t border-gray-700/50">
                  ...
                  <span>
                    AI-generated reports are complementary. Always verify with
                    actual system data. All queries are logged for compliance.
                  </span>
                </p>
              </div>
