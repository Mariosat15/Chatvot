...
export default function InvoiceTemplateSection() {
  ...
  const sampleInvoice = useMemo(() => {
    ...
    const vatAmount = shouldApplyVat
      ? (subtotal * invoiceSettings.vatPercentage) / 100
      : 0;
    ...
    invoiceSettings.vatPercentage,
    invoiceSettings.invoicePrefix,
    invoiceSettings.invoiceNumberPadding,
  ]);
              ...
              {!companyInEU && (
                <div className="p-4 bg-blue-900/20 border border-blue-800 rounded-lg">
                  <p className="text-sm text-blue-300 flex items-center gap-2">
                    ...
                    VAT is disabled because your company is not in the EU.
                    Change your company country in Company Details to enable
                    VAT.
                  </p>
                </div>
              )}
                ...
                {[
                  {
                    key: "showLogo",
                    label: "Show Logo",
                    desc: "Display company logo",
                  },
                  {
                    key: "showCompanyAddress",
                    label: "Show Address",
                    desc: "Display company address",
                  },
                  {
                    key: "showBankDetails",
                    label: "Show Bank Details",
                    desc: "Display banking information",
                  },
                  {
                    key: "showVatNumber",
                    label: "Show VAT Number",
                    desc: "Display VAT registration number",
                  },
                  {
                    key: "showRegistrationNumber",
                    label: "Show Registration Number",
                    desc: "Display company registration",
                  },
                ].map((option) => (
                  <div
                    key={option.key}
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  Available variables: {"{{companyName}}"},{" "}
        ...
        <TabsContent value="legal" className="space-y-6 mt-6">
          <Card className="bg-gray-900 border-gray-800">
            <CardHeader>
              ...
              <CardDescription>
                This disclaimer appears at the bottom of invoices and emails. It
                covers EU consumer rights, refund policies, VAT information, and
                GDPR compliance.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              {invoiceSettings.showLegalDisclaimer && (
                <>
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-gray-500">
                      Use **text** for bold. Available variables:{" "}
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div className="text-sm text-blue-300">
                        ...
                        <ul className="list-disc list-inside space-y-1 text-blue-200/80 text-xs">
                          <li>
                            <strong>Nature of Purchase</strong> - Clarify
                            digital content/credits
                          </li>
                          <li>
                            <strong>Refund Policy</strong> - EU Consumer Rights
                            Directive compliance
                          </li>
                          <li>
                            <strong>VAT Information</strong> - For EU customers
                          </li>
                          <li>
                            <strong>GDPR Compliance</strong> - Data protection
                            notice
                          </li>
                          <li>
                            <strong>Consumer Rights</strong> - EU/EEA specific
                            rights
                          </li>
                          <li>
                            <strong>Non-EU Customers</strong> - Jurisdiction
                            information
                          </li>
                          <li>
                            <strong>Dispute Resolution</strong> - ODR platform
                            link for EU
                          </li>
                        </ul>
                      </div>
              ...
              >
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: invoiceSettings.accentColor,
                      color: "#fff",
                    }}
                  >
                    <div>
                  ...
                  <div className="p-10">
                    ...
                    <table className="w-full mb-8">
                      <thead>
                        <tr className="border-b-2 border-gray-200">
                          <th className="text-left py-3 text-xs uppercase text-gray-500">
                            Description
                          </th>
                          <th className="text-right py-3 text-xs uppercase text-gray-500">
                            Qty
                          </th>
                          <th className="text-right py-3 text-xs uppercase text-gray-500">
                            Price
                    ...
                    <div className="ml-auto w-72">
                      ...
                      <div
                        ...
                        style={{
                          borderTop: `2px solid ${invoiceSettings.primaryColor}`,
                        }}
                      >
                        <span className="text-gray-900">Total</span>
                        <span style={{ color: invoiceSettings.primaryColor }}>
                          {formatCurrency(sampleInvoice.total)}
                        </span>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="mb-4">
                          ...
                          <div className="grid grid-cols-2 gap-2 text-sm">
                            ...
                            <div>
                              ...
                              {companySettings.bankIban}
                            </div>
                            <div>
                              <span className="text-gray-500">SWIFT:</span>{" "}
                              {companySettings.bankSwift}
                            </div>
                          </div>
                        </div>
                      )}
