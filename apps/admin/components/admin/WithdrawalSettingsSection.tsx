...
export default function WithdrawalSettingsSection() {
  ...
  const handleReset = async () => {
    if (
      !confirm(
        "Are you sure you want to reset all withdrawal settings to defaults?",
      )
    ) {
      return;
    }
  ...
  return (
    <div className="space-y-6">
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  >
                    <Building
                      className={`h-5 w-5 ${settings.bankWithdrawalsEnabled ? "text-cyan-400" : "text-gray-500"}`}
                    />
                  </div>
                  <div>
                    <p className="font-medium text-white">Bank Transfers</p>
                    <p className="text-xs text-gray-400">
                      Allow users to add bank accounts for withdrawals
                    </p>
                  </div>
                </div>
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateSetting("bankWithdrawalsEnabled", checked)
                  }
                />
              </div>
              {settings.bankWithdrawalsEnabled && (
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  >
                    <CreditCard
                      className={`h-5 w-5 ${settings.cardWithdrawalsEnabled ? "text-purple-400" : "text-gray-500"}`}
                    />
                  </div>
                  <div>
                    <p className="font-medium text-white">Card Payouts</p>
                    <p className="text-xs text-gray-400">
                      Allow refunds to original deposit card
                    </p>
                  </div>
                </div>
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateSetting("cardWithdrawalsEnabled", checked)
                  }
                />
              </div>
              {settings.cardWithdrawalsEnabled && (
              ...
              <div className="mt-4 bg-red-500/10 border border-red-500/30 rounded-lg p-3">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm text-red-300">
                    Warning: No withdrawal methods are enabled. Users won&apos;t
                    be able to withdraw.
                  </p>
                </div>
              </div>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">
                  Shown to users as expected time
                </p>
              </div>
              <div>
            ...
            <div>
              <Label className="text-gray-300">
                Hold Period After Deposit (hours)
              </Label>
              <Input
                type="number"
                min={0}
              ...
              />
              <p className="text-xs text-gray-500 mt-1">
                Wait time after deposit before allowing withdrawal
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Override Credit Conversion settings
                </p>
              </div>
              <Switch
                checked={settings.useCustomFees}
                onCheckedChange={(checked) =>
                  updateSetting("useCustomFees", checked)
                }
              />
            </div>
        ...
        <Card className="bg-gray-800/50 border-gray-700">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label className="text-gray-300">
                  Require Previous Deposit
                </Label>
                <p className="text-xs text-gray-500">
                  Must have deposited at least once
                </p>
              </div>
              <Switch
                checked={settings.minimumDepositRequired}
                onCheckedChange={(checked) =>
                  updateSetting("minimumDepositRequired", checked)
                }
              />
            </div>
            <div>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Can withdraw less than full balance
                </p>
              </div>
              <Switch
                checked={settings.allowPartialWithdrawal}
                onCheckedChange={(checked) =>
                  updateSetting("allowPartialWithdrawal", checked)
                }
              />
            </div>
            <div className="flex items-center justify-between">
              <div>
                <Label className="text-gray-300">
                  Allow During Active Competitions
                </Label>
                <p className="text-xs text-gray-500">
                  Can withdraw while in competitions
                </p>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label className="text-gray-300">
                  Block on Active Challenges
                </Label>
                <p className="text-xs text-gray-500">
                  Prevent withdrawal with pending challenges
                </p>
              </div>
              <Switch
                checked={settings.blockWithdrawalOnActiveChallenges}
                onCheckedChange={(checked) =>
                  updateSetting("blockWithdrawalOnActiveChallenges", checked)
                }
              />
            </div>
          </CardContent>
            ...
            <div className="pt-4 border-t border-gray-700">
              <div className="flex items-center justify-between mb-3">
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    Prevents rapid API requests (spam/DDoS protection)
                  </p>
                </div>
                <Switch
                  checked={settings.apiRateLimitEnabled ?? true}
                  onCheckedChange={(checked) =>
                    updateSetting("apiRateLimitEnabled", checked)
                  }
                />
              </div>
              ...
              {settings.apiRateLimitEnabled && (
                <div>
                  ...
                  <p className="text-xs text-gray-500 mb-2">
                    Maximum API requests allowed per minute for withdrawal
                    operations
                  </p>
                  <Input
                    type="number"
        ...
        <Card className="bg-gray-800/50 border-gray-700">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <Label className="text-gray-300">
                  Enable Sandbox Withdrawals
                </Label>
                <p className="text-xs text-gray-500">
                  Allow withdrawals in sandbox mode
                </p>
              </div>
              <Switch
                checked={settings.sandboxEnabled}
                onCheckedChange={(checked) =>
                  updateSetting("sandboxEnabled", checked)
                }
              />
            </div>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Automatically approve sandbox withdrawals
                </p>
              </div>
              <Switch
                checked={settings.sandboxAutoApprove}
                onCheckedChange={(checked) =>
                  updateSetting("sandboxAutoApprove", checked)
                }
              />
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Email admin for each request
                </p>
              </div>
              <Switch
                checked={settings.notifyAdminOnRequest}
                onCheckedChange={(checked) =>
                  updateSetting("notifyAdminOnRequest", checked)
                }
              />
            </div>
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateSetting("notifyAdminOnHighValue", checked)
                }
              />
            </div>
      ...
      <div className="text-center text-sm text-gray-500">
        Last updated: {new Date(settings.lastUpdated).toLocaleString()} by{" "}
        {settings.updatedBy}
      </div>
    </div>
  );
