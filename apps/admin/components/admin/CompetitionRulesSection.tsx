...
const rankingMethods = [
  ...
  },
  {
    value: "roi",
    label: "Highest ROI %",
    description: "Winner has the highest return on investment percentage",
  },
  {
    value: "total_capital",
    label: "Highest Capital",
    description: "Winner has the most total capital (balance + P&L)",
  },
  {
    value: "win_rate",
    label: "Highest Win Rate",
    description: "Winner has the highest win rate percentage",
  },
  {
    value: "total_wins",
    label: "Most Wins",
    description: "Winner has the most winning trades",
  },
  {
    value: "profit_factor",
    label: "Best Profit Factor",
    description: "Winner has the best profit factor (wins / losses)",
  },
];
...
const tieBreakers = [
  {
    value: "trades_count",
    label: "Fewer Trades",
    description: "More efficient trader (fewer trades)",
  },
  {
    value: "win_rate",
    label: "Higher Win Rate",
    description: "Higher percentage of winning trades",
  },
  {
    value: "total_capital",
    label: "Higher Capital",
    description: "More total capital",
  },
  {
    value: "roi",
    label: "Higher ROI",
  ...
  {
    value: "join_time",
    label: "Who Joined First",
    description: "Earlier participant wins",
  },
  {
    value: "split_prize",
    label: "Split Prize",
    description: "Tied participants split the prize",
  },
];
...
const tiePrizeOptions = [
  {
    value: "split_equally",
    label: "Split Equally",
    description: "All tied participants get equal shares",
  },
  {
    value: "split_weighted",
    label: "Split Weighted",
    description: "Split based on secondary metrics (capital)",
  },
  {
    value: "first_gets_all",
    label: "First Gets All",
    description: "Tiebreaker determines single winner",
  },
];
    ...
    <div className="space-y-6">
      ...
      <Card className="bg-dark-700/50 border-dark-600">
        <CardHeader>
          ...
          <CardDescription>
            How participants are ranked to determine winners
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            ...
            {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
            <Select
              value={rules.rankingMethod}
              onValueChange={(value: any) =>
                updateRules("rankingMethod", value)
              }
            >
          ...
          <div className="p-3 bg-blue-500/10 border border-blue-500/30 rounded-lg">
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-blue-300">
                ...
                {
                  rankingMethods.find((m) => m.value === rules.rankingMethod)
                    ?.description
                }
              </div>
            </div>
      ...
      <Card className="bg-dark-700/50 border-dark-600">
        <CardHeader>
          ...
          <CardDescription>
            How to resolve ties when participants have equal performance
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            ...
            {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
            <Select
              value={rules.tieBreaker1}
              onValueChange={(value: any) => updateRules("tieBreaker1", value)}
            >
              <SelectTrigger className="bg-dark-800 border-dark-600 mt-2">
                <SelectValue />
              </SelectTrigger>
          ...
          <div>
            ...
            <Select
              ...
              // eslint-disable-next-line @typescript-eslint/no-explicit-any
              onValueChange={(value: any) =>
                updateRules("tieBreaker2", value === "none" ? undefined : value)
              }
            >
              <SelectTrigger className="bg-dark-800 border-dark-600 mt-2">
          ...
          <div>
            ...
            <Select
              ...
              // eslint-disable-next-line @typescript-eslint/no-explicit-any
              onValueChange={(value: any) =>
                updateRules("tiePrizeDistribution", value)
              }
            >
              <SelectTrigger className="bg-dark-800 border-dark-600 mt-2">
                <SelectValue />
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <p className="text-xs text-dark-300 mt-1">
              Participants must complete at least this many trades to qualify
              for prizes (minimum 1)
            </p>
          </div>
          ...
          <div>
            ...
            />
            <p className="text-xs text-dark-300 mt-1">
              Optional: Participants must maintain at least this win rate
              percentage
            </p>
          </div>
          ...
          <div className="flex items-start gap-3 p-3 bg-dark-800/50 rounded-lg border border-dark-600">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                updateRules("disqualifyOnLiquidation", checked)
              }
              className="mt-1"
            />
            <div className="flex-1">
              <Label
                htmlFor="disqualifyLiquidation"
                className="cursor-pointer font-medium"
              >
                Disqualify Liquidated Participants
              </Label>
              <p className="text-xs text-dark-300 mt-1">
                Participants who get liquidated (margin call) are automatically
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h4 className="font-medium text-amber-300 mb-1">
              Important: Rule Transparency
            </h4>
            <p className="text-sm text-amber-200/80">
              All competition rules are displayed to participants before they
              enter. Make sure your rules are fair and clearly communicate how
