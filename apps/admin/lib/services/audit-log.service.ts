...
export const auditLogService = {
  ...
  async log(params: LogActionParams): Promise<void> {
    try {
      ...
      try {
        ...
        const section =
          actionToSection[params.action] ||
          categoryToSection[params.category] ||
          "overview";
  ...
  async logIncidentStatusChanged(
    admin: AdminInfo,
    incidentId: string,
    title: string,
  ...
  async logEmployeePasswordReset(
    admin: AdminInfo,
    employeeId: string,
    employeeName: string,
  ): Promise<void> {
