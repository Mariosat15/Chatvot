 ...
 * pi_3ABC123 → ext_****ABC
 */
export function maskProviderTxId(
  providerTxId: string | undefined | null,
): string {
  ...
  if (typeof data === "object") {
    ...
    for (const [key, value] of Object.entries(data)) {
      ...
      // Provider transaction ID
        ...
        lowerKey.includes("providertransactionid") ||
        lowerKey.includes("paymentintentid")
      ) {
 ...
 */
export function getMaskingSummary(): {
  totalMasked: number;
