import { Swords, Users, DollarSign, Calendar, ArrowLeft, Clock, Target, Award, User, Trophy, Settings } from 'lucide-react';
...
const AdminChallengeViewPage = async ({ params }: AdminChallengeViewPageProps) => {
                ...
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h1 className="text-3xl font-bold text-white">1v1 Challenge</h1>
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-yellow-400">
                    {currencySymbol}{challenge.prizePool?.toLocaleString()}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-400">
                    {currencySymbol}{challenge.entryFee?.toLocaleString()}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-orange-400">
                    {currencySymbol}{challenge.winnerPrize?.toLocaleString()}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <p className="text-xs text-gray-500">
                    {isCancelled ? 'Status' : isActive ? 'Time Remaining' : isCompleted ? 'Status' : 'Duration'}
                  </p>
                  <p className={`text-2xl font-bold ${isCancelled ? 'text-red-400' : 'text-purple-400'}`}>
                    {isCancelled ? 'Cancelled' : isCompleted ? 'Completed' : isActive ? getTimeRemaining() : formatDuration(challenge.duration)}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-linear-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-xl p-6 shadow-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                    ...
                    <p className="text-lg font-semibold text-gray-100">
                      {challenge.platformFeePercentage}% ({currencySymbol}{challenge.platformFeeAmount})
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                    ...
                    <p className="text-lg font-semibold text-gray-100">
                      {challenge.rules?.rankingMethod === 'pnl' && 'Highest P&L'}
                      {challenge.rules?.rankingMethod === 'roi' && 'Highest ROI %'}
                      {challenge.rules?.rankingMethod === 'total_capital' && 'Highest Capital'}
              ...
              <div className="bg-linear-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-xl p-6 shadow-xl">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-800/50 border border-gray-700 rounded-lg">
                    <span className="text-sm text-gray-400">Accept Deadline</span>
                    <span className="text-sm font-semibold text-gray-100">
              ...
              <div className="bg-linear-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-xl p-6 shadow-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Challenger */}
                  {(() => {
                    const isDisqualified = challengerStats?.isDisqualified || false;
                    const isWinner = challenge.winnerId === challenge.challengerId;
                    ...
                    return (
                      <div className={`rounded-xl p-5 ${
                        ...
                        <div className="flex items-center justify-between mb-3 flex-wrap gap-2">
                          <span className="text-xs text-gray-500 uppercase font-semibold">Challenger</span>
                        ...
                        <p className={`font-bold text-xl ${isDisqualified ? 'text-red-300 line-through' : 'text-white'}`}>
                          {challenge.challengerName}
                        </p>
                        <p className="text-xs text-gray-400 mb-4">{challenge.challengerEmail}</p>
                        
                        {isCompleted && challengerStats && (
                          <div className="space-y-2 pt-4 border-t border-gray-600">
                            <div className="flex justify-between text-sm">
                              <span className="text-gray-400">P&L:</span>
                              <span className={`font-bold ${challengerStats.pnl >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                                {challengerStats.pnl >= 0 ? '+' : ''}{challengerStats.pnl?.toFixed(2)}
                              </span>
                            </div>
                            <div className="flex justify-between text-sm">
                              <span className="text-gray-400">ROI:</span>
                              <span className={`${challengerStats.pnlPercentage >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                                {challengerStats.pnlPercentage >= 0 ? '+' : ''}{challengerStats.pnlPercentage?.toFixed(2)}%
                              </span>
                            </div>
                            <div className="flex justify-between text-sm">
                              <span className="text-gray-400">Trades:</span>
                              <span className="text-white">{challengerStats.totalTrades}</span>
                            </div>
                            <div className="flex justify-between text-sm">
                              <span className="text-gray-400">Win Rate:</span>
                              <span className="text-white">{challengerStats.winRate?.toFixed(1)}%</span>
                            </div>
                            {isWinner && (
                              <div className="flex justify-between text-sm pt-2 border-t border-gray-600">
                                <span className="text-gray-400">Prize Won:</span>
                                <span className="text-yellow-400 font-bold">{currencySymbol}{challenge.winnerPrize}</span>
                              </div>
                            )}
                            {isDisqualified && challengerStats.disqualificationReason && (
                              <p className="text-xs text-red-400 mt-2">
                                Reason: {challengerStats.disqualificationReason}
                              </p>
                            )}
                          </div>
                        )}
                        ...
                        {challengerGm && (
                          <div className="mt-4 pt-4 border-t border-purple-500/30 bg-purple-500/10 -mx-5 -mb-5 p-4 rounded-b-xl">
                            ...
                            <p className="text-xs text-purple-300">{challengerGm.gmEmail}</p>
                            <p className="text-xs text-purple-400 mt-1">
                              GM Earned: <span className="font-bold">{currencySymbol}{challengerGm.gmEarning.toFixed(2)}</span>
                            </p>
                          </div>
                        )}
                      </div>
                  ...
                  {/* Challenged */}
                  {(() => {
                    const isDisqualified = challengedStats?.isDisqualified || false;
                    const isWinner = challenge.winnerId === challenge.challengedId;
                    ...
                    return (
                      <div className={`rounded-xl p-5 ${
                        ...
                        <div className="flex items-center justify-between mb-3 flex-wrap gap-2">
                          <span className="text-xs text-gray-500 uppercase font-semibold">Challenged</span>
                          <div className="flex gap-2 flex-wrap">
                            {isDisqualified ? (
                              <span className="px-2 py-1 bg-red-500/20 text-red-400 text-xs font-semibold rounded">DISQUALIFIED</span>
                            ) : isCompleted && isWinner ? (
                        ...
                        <p className="text-xs text-gray-400 mb-4">{challenge.challengedEmail}</p>
                        
                        {isCompleted && challengedStats && (
                          <div className="space-y-2 pt-4 border-t border-gray-600">
                            <div className="flex justify-between text-sm">
                              <span className="text-gray-400">P&L:</span>
                              <span className={`font-bold ${challengedStats.pnl >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                                {challengedStats.pnl >= 0 ? '+' : ''}{challengedStats.pnl?.toFixed(2)}
                              </span>
                            </div>
                            <div className="flex justify-between text-sm">
                              <span className="text-gray-400">ROI:</span>
                              <span className={`${challengedStats.pnlPercentage >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                                {challengedStats.pnlPercentage >= 0 ? '+' : ''}{challengedStats.pnlPercentage?.toFixed(2)}%
                              </span>
                            </div>
                            <div className="flex justify-between text-sm">
                              <span className="text-gray-400">Trades:</span>
                              <span className="text-white">{challengedStats.totalTrades}</span>
                            </div>
                            <div className="flex justify-between text-sm">
                              <span className="text-gray-400">Win Rate:</span>
                              <span className="text-white">{challengedStats.winRate?.toFixed(1)}%</span>
                            </div>
                            {isWinner && (
                              <div className="flex justify-between text-sm pt-2 border-t border-gray-600">
                                <span className="text-gray-400">Prize Won:</span>
                            ...
                            {isDisqualified && challengedStats.disqualificationReason && (
                              <p className="text-xs text-red-400 mt-2">
                                Reason: {challengedStats.disqualificationReason}
                              </p>
                            )}
                          </div>
                        )}
                        ...
                        {challengedGm && (
                          <div className="mt-4 pt-4 border-t border-purple-500/30 bg-purple-500/10 -mx-5 -mb-5 p-4 rounded-b-xl">
                            <p className="text-xs text-purple-400 font-semibold mb-1">Game Master Referral</p>
                            <p className="text-xs text-purple-300">{challengedGm.gmEmail}</p>
                            <p className="text-xs text-purple-400 mt-1">
                              GM Earned: <span className="font-bold">{currencySymbol}{challengedGm.gmEarning.toFixed(2)}</span>
                            </p>
                          </div>
                        )}
                      </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-linear-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-xl p-6 shadow-xl">
                ...
                <div className={`p-4 rounded-lg ${
                  ...
                  isPending || isAccepted ? 'bg-yellow-500/20 border border-yellow-500/30' :
                  isCompleted ? 'bg-gray-500/20 border border-gray-500/30' :
                  'bg-red-500/20 border border-red-500/30'
                }`}>
                  <div className="flex items-center gap-2">
                    <div className={`h-3 w-3 rounded-full ${
                      isActive ? 'bg-green-500 animate-pulse' :
                      isPending || isAccepted ? 'bg-yellow-500' :
                      isCompleted ? 'bg-gray-500' :
                      'bg-red-500'
                    }`}></div>
                    <span className={`font-semibold ${
                      isActive ? 'text-green-400' :
                      isPending || isAccepted ? 'text-yellow-400' :
                ...
                <div className="bg-linear-to-br from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 rounded-xl p-6 shadow-xl text-center">
                  ...
                  <div className="bg-yellow-500/20 px-4 py-3 rounded-lg">
                    <p className="text-yellow-400 font-bold text-xl">
                      Earned {currencySymbol}{challenge.winnerPrize}
                    </p>
                  </div>
                  {challenge.winnerPnL !== undefined && (
                    <p className="text-sm text-yellow-300/70 mt-2">
                      Final P&L: {challenge.winnerPnL >= 0 ? '+' : ''}{challenge.winnerPnL?.toFixed(2)}
                    </p>
                  )}
                </div>
              )}
              ...
              <div className="bg-linear-to-br from-blue-500/10 to-gray-900 border border-blue-500/30 rounded-xl p-6 shadow-xl">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-white font-semibold">{currencySymbol}{challenge.prizePool}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Platform Fee ({challenge.platformFeePercentage}%):</span>
                    <span className="text-blue-400 font-semibold">-{currencySymbol}{challenge.platformFeeAmount}</span>
                  </div>
