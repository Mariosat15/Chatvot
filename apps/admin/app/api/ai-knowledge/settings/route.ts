...
export async function PUT(request: NextRequest) {
  try {
    ...
    if (autoIndexHelpArticles !== undefined)
      updates.autoIndexHelpArticles = autoIndexHelpArticles;
    if (autoIndexOnHelpUpdate !== undefined)
      updates.autoIndexOnHelpUpdate = autoIndexOnHelpUpdate;
    if (chunkSize !== undefined) updates.chunkSize = chunkSize;
    if (chunkOverlap !== undefined) updates.chunkOverlap = chunkOverlap;
    if (maxChunksPerQuery !== undefined)
      updates.maxChunksPerQuery = maxChunksPerQuery;
