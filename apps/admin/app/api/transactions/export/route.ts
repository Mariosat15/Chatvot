...
export async function GET(request: NextRequest) {
  try {
    ...
    const userIds = [...new Set(transactions.map(t => t.userId).filter(id => id !== 'platform'))];
