...
function getStandardMarketHolidays(): Holiday[] {
  ...
  const holidayDefinitions = [
    ...
    // US Stock Market Holidays (NYSE/NASDAQ)
    {
      ...
      getDate: (year: number) => getNthWeekdayOfMonth(year, 0, 1, 3),
      exchange: "NYSE",
    }, // 3rd Monday of Jan
    {
      name: "Presidents Day",
      getDate: (year: number) => getNthWeekdayOfMonth(year, 1, 1, 3),
      exchange: "NYSE",
    }, // 3rd Monday of Feb
    {
      name: "Good Friday",
      getDate: (year: number) => getEasterDate(year, -2),
      exchange: "NYSE",
    },
    {
      name: "Easter Monday",
      getDate: (year: number) => getEasterDate(year, 1),
      exchange: "FOREX",
    },
    {
      name: "Memorial Day",
      getDate: (year: number) => getLastWeekdayOfMonth(year, 4, 1),
      exchange: "NYSE",
    }, // Last Monday of May
    ...
    {
      name: "Labor Day",
      getDate: (year: number) => getNthWeekdayOfMonth(year, 8, 1, 1),
      exchange: "NYSE",
    }, // 1st Monday of Sep
    {
      name: "Thanksgiving Day",
      getDate: (year: number) => getNthWeekdayOfMonth(year, 10, 4, 4),
      exchange: "NYSE",
    }, // 4th Thursday of Nov
    ...
    // UK Market Holidays (LSE)
    {
      ...
      getDate: (year: number) => getNthWeekdayOfMonth(year, 4, 1, 1),
      exchange: "LSE",
    }, // 1st Monday of May
    {
    ...
    }, // Last Monday of May
    {
      ...
      getDate: (year: number) => getLastWeekdayOfMonth(year, 7, 1),
      exchange: "LSE",
    }, // Last Monday of Aug
  ];
