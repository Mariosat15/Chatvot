 ...
 * This allows the admin panel to preview uploaded images
 */
export async function GET(
  ...
  try {
    ...
    console.log(
      `🖼️ [Serve] Request for image: ${filename} -> ${sanitizedFilename}`,
    );
    ...
    console.log(
      `📦 [Serve] Serving ${fileBuffer.length} bytes from ${filePath}`,
    );
