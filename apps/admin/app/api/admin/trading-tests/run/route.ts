...
async function productionIsMarketOpen(assetClass: string = "forex"): Promise<{
  isOpen: boolean;
  reason?: string;
  isHoliday?: boolean;
  holidayName?: string;
  ...
  try {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_APP_URL || "http://localhost:3000"}/api/market-status`,
    );
...
async function productionGetRealPrice(symbol: string): Promise<{
  bid: number;
  ask: number;
  mid: number;
  spread: number;
  ...
  for (const baseUrl of baseUrls) {
    try {
      ...
      if (response.ok) {
        ...
        console.log(
          `[Price Test] Response from ${baseUrl}:`,
      ...
      console.warn(
        `[Price Test] Failed from ${baseUrl}:`,
  ...
  console.warn(
    `[Price Test] Could not fetch price for ${symbol} from any source`,
  );
  return null;
}
...
function calculateUnrealizedPnL(
  ...
  return productionCalculateUnrealizedPnL(
    side,
    entryPrice,
    currentPrice,
    quantity,
...
function calculateMarginRequired(
  ...
  // ⚡ CALLS ACTUAL PRODUCTION FUNCTION
  return productionCalculateMarginRequired(
    quantity,
    entryPrice,
    leverage,
    symbol as ForexSymbol,
...
const TRADING_TEST_SCENARIOS: TradingTestScenario[] = [
  // ============ OPEN POSITION TESTS ============
  {
    ...
    expected: {
      marginRequired: 11.0, // (0.01 × 100000 × 1.10) / 100 = 11
      positionOpened: true,
    },
  },
  {
    ...
    expected: {
      marginRequired: 110.0, // (0.1 × 100000 × 1.10) / 100 = 110
      positionOpened: true,
    },
  },
  {
    ...
    expected: {
      marginRequired: 1100.0, // (1.0 × 100000 × 1.10) / 100 = 1100
      positionOpened: true,
    },
  },
  {
    ...
    expected: {
      marginRequired: 632.5, // (0.5 × 100000 × 1.265) / 100 = 632.50
      positionOpened: true,
    },
  },
  {
    ...
    expected: {
      marginRequired: 220.0, // (0.1 × 100000 × 1.10) / 50 = 220
      positionOpened: true,
    },
  },
  ...
  // ============ PNL CALCULATION TESTS ============
  {
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.1,
      exitPrice: 1.105, // +50 pips
    },
    expected: {
      pnl: 500.0, // (1.10500 - 1.10000) × 1.0 × 100000 = 500
    },
  },
  {
    id: "T-P2",
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.1,
      exitPrice: 1.097, // -30 pips
    },
    expected: {
      pnl: -300.0, // (1.09700 - 1.10000) × 1.0 × 100000 = -300
    },
  },
  {
    id: "T-P3",
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.1,
      exitPrice: 1.096, // +40 pips (price went down = profit for short)
    },
    expected: {
      pnl: 400.0, // (1.10000 - 1.09600) × 1.0 × 100000 = 400
    },
  },
  {
    id: "T-P4",
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.1,
      exitPrice: 1.102, // -20 pips (price went up = loss for short)
    },
    expected: {
      pnl: -200.0, // (1.10000 - 1.10200) × 1.0 × 100000 = -200
    },
  },
  {
    id: "T-P5",
    ...
    expected: {
      pnl: 50.0, // (1.10500 - 1.10000) × 0.1 × 100000 = 50
    },
  },
  {
    id: "T-P6",
    ...
    expected: {
      pnl: 5.0, // (1.10500 - 1.10000) × 0.01 × 100000 = 5
    },
  },
  {
    id: "T-P7",
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 145.0,
      exitPrice: 145.5, // +50 pips for JPY (0.50 / 0.01)
    },
    expected: {
      pnl: 50000.0, // (145.50 - 145.00) × 1.0 × 100000 = 50000 JPY ≈ $344 (but we calc in raw)
    },
  },
  ...
  // ============ MARGIN TESTS ============
  {
    ...
    expected: {
      marginRequired: 1100.0, // (1.0 × 100000 × 1.10) / 100
    },
  },
  {
    id: "T-M2",
    ...
    expected: {
      marginRequired: 2200.0, // (1.0 × 100000 × 1.10) / 50
    },
  },
  {
    id: "T-M3",
    ...
    expected: {
      marginRequired: 550.0, // (1.0 × 100000 × 1.10) / 200
    },
  },
  ...
  // ============ ROUND-TRIP TESTS (OPEN → CLOSE) ============
  {
    ...
    expected: {
      marginRequired: 110.0,
      pnl: 50.0, // +$50 profit
      finalCapital: 10050.0, // 10000 + 50
      marginReleased: true,
      positionOpened: true,
      positionClosed: true,
    },
  },
  {
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.1,
      exitPrice: 1.095, // -50 pips
      startingCapital: 10000,
    },
    expected: {
      marginRequired: 110.0,
      pnl: -50.0, // -$50 loss
      finalCapital: 9950.0, // 10000 - 50
      marginReleased: true,
      positionOpened: true,
      positionClosed: true,
    },
  },
  {
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.1,
      exitPrice: 1.095, // +50 pips (price dropped = profit)
      startingCapital: 10000,
    },
    expected: {
      marginRequired: 110.0,
  ...
  },
  {
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.1,
      exitPrice: 1.105, // -50 pips (price rose = loss)
      startingCapital: 10000,
    },
    expected: {
      marginRequired: 110.0,
  ...
  },
  {
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.1,
      exitPrice: 1.101, // +10 pips
      startingCapital: 10000,
    },
    expected: {
      marginRequired: 1100.0,
      pnl: 100.0, // +$100 profit (10 pips × $10/pip)
      finalCapital: 10100.0,
      marginReleased: true,
      positionOpened: true,
      positionClosed: true,
    },
  },
  {
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.265,
      exitPrice: 1.268, // +30 pips
      startingCapital: 10000,
    },
    expected: {
      marginRequired: 126.5, // (0.1 × 100000 × 1.265) / 100
      pnl: 30.0, // +$30 profit
      finalCapital: 10030.0,
      marginReleased: true,
      positionOpened: true,
      positionClosed: true,
    },
  ...
  },
  {
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.1,
      stopLoss: 1.095, // Below entry ✓
      takeProfit: 1.105, // Above entry ✓
    },
    expected: {
      validSLTP: true,
    },
  },
  {
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.1,
      stopLoss: 1.105, // Above entry - WRONG!
      takeProfit: 1.11,
    },
    expected: {
      validSLTP: false,
  ...
  },
  {
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.1,
      stopLoss: 1.105, // Above entry ✓
      takeProfit: 1.095, // Below entry ✓
    },
    expected: {
      validSLTP: true,
    },
  ...
  // ============ PIP VALUE TESTS ============
  {
    ...
    expected: {
      pipValue: 10.0, // 0.0001 × 1.0 × 100000 = $10
    },
  },
  {
    id: "T-PV2",
    ...
    expected: {
      pipValue: 1.0, // 0.0001 × 0.1 × 100000 = $1
    },
  },
  {
    id: "T-PV3",
    ...
    expected: {
      pipValue: 0.1, // 0.0001 × 0.01 × 100000 = $0.10
    },
  },
  ...
  // ============ TP/SL HIT DETECTION TESTS ============
  {
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.1,
      stopLoss: 1.095, // SL 50 pips below
      currentPrice: 1.0945, // Price below SL - should trigger
    },
    expected: {
      slTriggered: true,
      tpTriggered: false,
  ...
  },
  {
    ...
    params: {
      ...
      entryPrice: 1.1,
      stopLoss: 1.095,
      currentPrice: 1.098, // Price above SL
    },
    expected: {
      slTriggered: false,
      tpTriggered: false,
  ...
  },
  {
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.1,
      takeProfit: 1.105, // TP 50 pips above
      currentPrice: 1.1055, // Price above TP - should trigger
    },
    expected: {
      slTriggered: false,
      tpTriggered: true,
  ...
  },
  {
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.1,
      stopLoss: 1.105, // SL 50 pips above (for short)
      currentPrice: 1.1055, // Price above SL - should trigger for short
    },
    expected: {
      slTriggered: true,
      tpTriggered: false,
  ...
  },
  {
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.1,
      takeProfit: 1.095, // TP 50 pips below (for short)
      currentPrice: 1.0945, // Price below TP - should trigger for short
    },
    expected: {
      slTriggered: false,
      tpTriggered: true,
  ...
  // ============ STOP OUT SIMULATION TESTS ============
  {
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.1,
      currentPrice: 1.005, // Price moved against by 950 pips (below 50% margin)
      startingCapital: 10000,
    },
    expected: {
      shouldLiquidate: true,
  ...
  },
  {
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.1,
      currentPrice: 1.09, // 100 pips against
      startingCapital: 10000,
    },
    expected: {
      shouldLiquidate: false,
  ...
  },
  {
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 150.0,
      currentPrice: 150.5, // 50 pips up for JPY
    },
    expected: {
      pipsMoved: 50,
    },
  },
  {
    ...
    params: {
      ...
      leverage: 100,
      entryPrice: 1.1,
      stopLoss: 1.095, // 50 pips risk
      takeProfit: 1.11, // 100 pips reward
    },
    expected: {
  ...
  try {
    ...
    if (!testId) {
      return NextResponse.json(
        { success: false, error: "testId required" },
        { status: 400 },
      );
    }
    ...
    if (!scenario) {
      return NextResponse.json(
        { success: false, error: `Unknown test: ${testId}` },
        { status: 400 },
      );
    }
    ...
    try {
      ...
      // ============ MARGIN CALCULATION TEST ============
        ...
        if (Math.abs(actualMargin - (expected.marginRequired || 0)) > 0.01) {
          passed = false;
          issues.push(
            `Margin: expected $${expected.marginRequired}, got $${actualMargin}`,
          );
        }
      ...
      // ============ OPEN POSITION TEST ============
        ...
        await db.collection("competitionparticipants").updateOne(
          { _id: participantId },
          {
            $set: {
              availableCapital:
                (params.startingCapital || 10000) - expectedMargin,
        ...
        console.log(
          `   Position created: ${position?.status === "open" ? "✅" : "❌"}`,
        );
        console.log(
          `   Margin locked: $${position?.marginUsed} (expected: $${expected.marginRequired})`,
        );
        ...
        if (
          Math.abs(
            (position?.marginUsed || 0) - (expected.marginRequired || 0),
          ) > 0.01
        ) {
          passed = false;
          issues.push(
            `Margin: expected $${expected.marginRequired}, got $${position?.marginUsed}`,
          );
        }
      ...
      // ============ ROUND-TRIP TEST ============
        ...
        const expectedFinalCapital =
          (params.startingCapital || 10000) + expectedPnl;
        ...
        const afterOpen = await db
          ...
          .findOne({ _id: participantId });
        console.log(
          `   Available capital after open: $${afterOpen?.availableCapital}`,
        );
        ...
        const finalPosition = await db
          .collection("tradingpositions")
          .findOne({ _id: positionId });
        const finalParticipant = await db
          .collection("competitionparticipants")
          .findOne({ _id: participantId });
        ...
        console.log(
          `   Actual final capital: $${finalParticipant?.currentCapital}`,
        );
        console.log(
          `   Margin released: ${finalParticipant?.usedMargin === 0 ? "✅" : "❌"}`,
        );
        ...
        if (
          Math.abs((finalPosition?.exitPrice || 0) - (params.exitPrice || 0)) >
          0.00001
        ) {
          passed = false;
          issues.push(
            `Exit price: expected ${params.exitPrice}, got ${finalPosition?.exitPrice}`,
          );
        }
        if (
          Math.abs(
            (finalParticipant?.currentCapital || 0) -
              (expected.finalCapital || 0),
          ) > 0.01
        ) {
          passed = false;
          issues.push(
            `Final capital: expected $${expected.finalCapital}, got $${finalParticipant?.currentCapital}`,
          );
        }
        ...
        if (
          Math.abs((finalParticipant?.realizedPnl || 0) - (expected.pnl || 0)) >
          0.01
        ) {
          passed = false;
          issues.push(
            `Realized PNL: expected $${expected.pnl}, got $${finalParticipant?.realizedPnl}`,
          );
        }
      ...
      // ============ VALIDATION TEST ============
        ...
        if (expected.validQuantity !== undefined) {
          const quantityValidation = productionValidateQuantity(
            params.quantity,
          );
          console.log(
            `   validateQuantity(${params.quantity}): ${quantityValidation.valid ? "✅ Valid" : "❌ Invalid"}`,
          );
          if (quantityValidation.error)
            console.log(`      Reason: ${quantityValidation.error}`);

          if (quantityValidation.valid !== expected.validQuantity) {
            passed = false;
            issues.push(
              `Quantity validation: expected ${expected.validQuantity}, got ${quantityValidation.valid}`,
            );
          }
        ...
        // Test SL/TP validation
          ...
          console.log(
            `   validateSLTP(${params.side}, entry=${params.entryPrice}, SL=${params.stopLoss}, TP=${params.takeProfit}):`,
          );
          console.log(
            `      Result: ${slTpValidation.valid ? "✅ Valid" : "❌ Invalid"}`,
          );
          if (slTpValidation.error)
            console.log(`      Reason: ${slTpValidation.error}`);

          if (slTpValidation.valid !== expected.validSLTP) {
            passed = false;
            issues.push(
              `SL/TP validation: expected ${expected.validSLTP}, got ${slTpValidation.valid}`,
            );
          }
          ...
          actualResult = {
            passed: false,
            message: "No validation expectation specified",
          };
        }
      }
      // ============ RISK MANAGER TEST ============
        ...
        if (expected.orderAllowed !== undefined) {
          ...
          console.log(
            `   validateNewOrder(capital=$${params.startingCapital}, margin=$${marginRequired}):`,
          );
          console.log(
            `      Result: ${orderValidation.valid ? "✅ Allowed" : "❌ Rejected"}`,
          );
          if (orderValidation.error)
            console.log(`      Reason: ${orderValidation.error}`);

          if (orderValidation.valid !== expected.orderAllowed) {
            passed = false;
            issues.push(
              `Order validation: expected ${expected.orderAllowed ? "allowed" : "rejected"}, got ${orderValidation.valid ? "allowed" : "rejected"}`,
            );
          }
          ...
          actualResult = {
            ...
            details: {
              orderValidation,
              marginRequired,
              expected: expected.orderAllowed,
            },
          };
        }
        // Test margin status
        else if (
          expected.marginLevel !== undefined ||
          expected.marginStatus !== undefined
        ) {
          ...
          const marginStatus = productionGetMarginStatus(
            currentCapital,
            unrealizedPnl,
            usedMargin,
          );
          ...
          console.log(
            `   getMarginStatus(capital=$${currentCapital}, pnl=$${unrealizedPnl}, margin=$${usedMargin}):`,
          );
          console.log(
            `      Margin Level: ${marginStatus.marginLevel.toFixed(2)}%`,
          );
          ...
          if (expected.marginLevel !== undefined) {
            if (Math.abs(marginStatus.marginLevel - expected.marginLevel) > 1) {
              passed = false;
              issues.push(
                `Margin level: expected ${expected.marginLevel}%, got ${marginStatus.marginLevel.toFixed(2)}%`,
              );
            }
          }
          if (expected.marginStatus !== undefined) {
            if (marginStatus.status !== expected.marginStatus) {
              passed = false;
              issues.push(
                `Margin status: expected ${expected.marginStatus}, got ${marginStatus.status}`,
              );
            }
          }
          ...
          actualResult = {
            passed,
            message: passed
              ? "✅ Margin status correct"
              : `❌ ${issues.join(", ")}`,
            actualOutcome: `Level: ${marginStatus.marginLevel.toFixed(2)}%, Status: ${marginStatus.status}`,
            details: {
              marginStatus,
              expected: {
                marginLevel: expected.marginLevel,
                marginStatus: expected.marginStatus,
              },
            },
          };
        } else {
          actualResult = {
            passed: false,
            message: "No risk expectation specified",
          };
        }
      }
      // ============ PIP VALUE TEST ============
      else if (type === "pipvalue") {
        const actualPipValue = productionCalculatePipValue(
          params.quantity,
        ...
        if (Math.abs(actualPipValue - (expected.pipValue || 0)) > 0.01) {
          passed = false;
          issues.push(
            `Pip value: expected $${expected.pipValue}, got $${actualPipValue}`,
          );
        }
      ...
      // ============ MARKET STATUS TEST ============
        ...
        try {
          ...
          console.log(
            `   Market Open: ${marketStatus.isOpen ? "✅ YES" : "❌ NO"}`,
          );
          console.log(`   Reason: ${marketStatus.reason || "N/A"}`);
          console.log(
            `   Is Holiday: ${marketStatus.isHoliday ? "Yes" : "No"}`,
          );
          if (marketStatus.holidayName)
            console.log(`   Holiday: ${marketStatus.holidayName}`);

          if (!marketStatus || typeof marketStatus.isOpen !== "boolean") {
            passed = false;
            issues.push(
              "Market status function did not return expected structure",
            );
          }
          ...
          actualResult = {
            passed,
            message: passed
              ? "✅ Market status returned correctly"
              : `❌ ${issues.join(", ")}`,
      ...
      // ============ REAL PRICE FETCH TEST ============
        ...
        try {
          const price = await productionGetRealPrice(
            params.symbol as ForexSymbol,
          );
          ...
          if (price) {
            ...
            console.log(
              `   Spread: ${price.spread.toFixed(5)} (${(price.spread / (params.symbol.includes("JPY") ? 0.01 : 0.0001)).toFixed(1)} pips)`,
            );
            console.log(
            ...
            if (expected.hasBidAsk) {
              ...
              if (price.ask <= price.bid) {
                passed = false;
                issues.push(
                  `Invalid spread: ask (${price.ask}) <= bid (${price.bid})`,
                );
              }
            }
          } else {
      ...
      // ============ FULL ORDER FLOW TEST ============
        ...
        if (params.takeProfit)
          console.log(`   Take Profit: ${params.takeProfit}`);
        ...
        console.log(
          `      Result: ${quantityValidation.valid ? "✅ Valid" : "❌ Invalid"}`,
        );
        if (quantityValidation.error)
          console.log(`      Error: ${quantityValidation.error}`);
        ...
        console.log(
          `      Result: ${orderValidation.valid ? "✅ Order Allowed" : "❌ Order Rejected"}`,
        );
        if (orderValidation.error)
          console.log(`      Error: ${orderValidation.error}`);
        ...
        if (params.stopLoss || params.takeProfit) {
          ...
          if (slTpValidation.error)
            console.log(`      Error: ${slTpValidation.error}`);
        }
        ...
        if (expected.validations) {
          if (
            expected.validations.quantityValid !== undefined &&
            validationResults.quantityValid !==
              expected.validations.quantityValid
          ) {
            passed = false;
            issues.push(
              `Quantity validation: expected ${expected.validations.quantityValid}, got ${validationResults.quantityValid}`,
            );
          }
          if (
            expected.validations.marginSufficient !== undefined &&
            validationResults.marginSufficient !==
              expected.validations.marginSufficient
          ) {
            passed = false;
            issues.push(
              `Margin validation: expected ${expected.validations.marginSufficient}, got ${validationResults.marginSufficient}`,
            );
          }
          if (
            expected.validations.slTpValid !== undefined &&
            validationResults.slTpValid !== expected.validations.slTpValid
          ) {
            passed = false;
            issues.push(
              `SL/TP validation: expected ${expected.validations.slTpValid}, got ${validationResults.slTpValid}`,
            );
          }
        }

        // Would position be created?
        const wouldCreatePosition =
          validationResults.quantityValid &&
          validationResults.marginSufficient &&
          validationResults.slTpValid;
        console.log(
          `   Would Create Position: ${wouldCreatePosition ? "✅ YES" : "❌ NO"}`,
        );

        if (
          expected.positionCreated !== undefined &&
          wouldCreatePosition !== expected.positionCreated
        ) {
          passed = false;
          issues.push(
            `Position creation: expected ${expected.positionCreated}, got ${wouldCreatePosition}`,
          );
        }
        ...
        actualResult = {
          passed,
          message: passed
            ? "✅ Full order flow validated correctly"
            : `❌ ${issues.join(", ")}`,
          actualOutcome: wouldCreatePosition
            ? "Order would succeed"
      ...
      // ============ FULL CLOSE FLOW TEST ============
        ...
        if (
          expected.expectedPnl !== undefined &&
          Math.abs(pnl - expected.expectedPnl) > 0.01
        ) {
          passed = false;
          issues.push(
            `PNL: expected $${expected.expectedPnl}, got $${pnl.toFixed(2)}`,
          );
        }
        if (
          expected.expectedFinalCapital !== undefined &&
          Math.abs(finalCapital - expected.expectedFinalCapital) > 0.01
        ) {
          passed = false;
          issues.push(
            `Final capital: expected $${expected.expectedFinalCapital}, got $${finalCapital.toFixed(2)}`,
          );
        }
        ...
        actualResult = {
          passed,
          message: passed
            ? "✅ Full close flow calculated correctly"
            : `❌ ${issues.join(", ")}`,
      ...
      // ============ TP/SL HIT DETECTION TEST ============
        ...
        if (params.stopLoss) {
          ...
          console.log(
            `      Result: ${slTriggered ? "🔴 TRIGGERED" : "✅ Not triggered"}`,
          );
        }
        ...
        if (params.takeProfit) {
          ...
          console.log(
            `      Result: ${tpTriggered ? "🟢 TRIGGERED" : "✅ Not triggered"}`,
          );
        }
        ...
        if (params.currentPrice) {
          pipsMoved = productionCalculatePipsMoved(
            params.entryPrice,
            currentPrice,
            params.symbol as ForexSymbol,
          );
        ...
        if (
          params.takeProfit &&
          expected.potentialPnl !== undefined &&
          expected.potentialPnl >= 0
        ) {
        ...
        // Validate expectations
        if (
          expected.slTriggered !== undefined &&
          slTriggered !== expected.slTriggered
        ) {
          passed = false;
          issues.push(
            `SL triggered: expected ${expected.slTriggered}, got ${slTriggered}`,
          );
        }
        if (
          expected.tpTriggered !== undefined &&
          tpTriggered !== expected.tpTriggered
        ) {
          passed = false;
          issues.push(
            `TP triggered: expected ${expected.tpTriggered}, got ${tpTriggered}`,
          );
        }
        if (
          expected.pipsMoved !== undefined &&
          pipsMoved !== undefined &&
          Math.abs(pipsMoved - expected.pipsMoved) > 1
        ) {
          passed = false;
          issues.push(
            `Pips moved: expected ${expected.pipsMoved}, got ${pipsMoved}`,
          );
        }
        if (
          expected.riskRewardRatio !== undefined &&
          riskRewardRatio !== undefined &&
          Math.abs(riskRewardRatio - expected.riskRewardRatio) > 0.1
        ) {
          passed = false;
          issues.push(
            `R:R ratio: expected ${expected.riskRewardRatio}, got ${riskRewardRatio?.toFixed(2)}`,
          );
        }
        if (
          expected.potentialPnl !== undefined &&
          potentialPnl !== undefined &&
          Math.abs(potentialPnl - expected.potentialPnl) > 1
        ) {
          passed = false;
          issues.push(
            `Potential PNL: expected $${expected.potentialPnl}, got $${potentialPnl?.toFixed(2)}`,
          );
        }
      ...
      // ============ LIQUIDATION TEST ============
        ...
        console.log(
          `      Result: ${shouldLiquidate ? "🔴 YES - LIQUIDATE" : "✅ NO"}`,
        );
        ...
        console.log(
          `      Result: ${isMarginCall ? "⚠️ YES - MARGIN CALL" : "✅ NO"}`,
        );
        ...
        if (params.usedMargin) {
          maintenanceMargin = productionCalculateMaintenanceMargin(
            params.usedMargin,
          );
          console.log(
        ...
        // Validate expectations
        if (
          expected.shouldLiquidate !== undefined &&
          shouldLiquidate !== expected.shouldLiquidate
        ) {
          passed = false;
          issues.push(
            `shouldLiquidate: expected ${expected.shouldLiquidate}, got ${shouldLiquidate}`,
          );
        }
        if (
          expected.isMarginCall !== undefined &&
          isMarginCall !== expected.isMarginCall
        ) {
          passed = false;
          issues.push(
            `isMarginCall: expected ${expected.isMarginCall}, got ${isMarginCall}`,
          );
        }
        if (
          expected.liquidationPrice !== undefined &&
          liquidationPrice !== undefined &&
          Math.abs(liquidationPrice - expected.liquidationPrice) > 0.001
        ) {
          passed = false;
          issues.push(
            `Liquidation price: expected ${expected.liquidationPrice}, got ${liquidationPrice?.toFixed(5)}`,
          );
        }
        if (
          expected.maintenanceMargin !== undefined &&
          maintenanceMargin !== undefined &&
          Math.abs(maintenanceMargin - expected.maintenanceMargin) > 1
        ) {
          passed = false;
          issues.push(
            `Maintenance margin: expected $${expected.maintenanceMargin}, got $${maintenanceMargin?.toFixed(2)}`,
          );
        }
      ...
      // ============ STOP OUT SIMULATION TEST ============
        ...
        if (
          expected.marginLevel !== undefined &&
          Math.abs(marginLevel - expected.marginLevel) > 5
        ) {
          passed = false;
          issues.push(
            `Margin level: expected ${expected.marginLevel}%, got ${marginLevel.toFixed(2)}%`,
          );
        }
