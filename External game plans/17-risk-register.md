...
### R101 - Ninety-nine admin routes with no authorization, and fifty-eight of them write - **R101a and R101b CLOSED 16 Sep 2026; R101c/d OPEN**
...
grant decision as much as a guard) and **R101d** (the directory-wide test that turns the canary
green). 97 files called no helper when R101 was raised; the `users` tree was nineteen of them.
