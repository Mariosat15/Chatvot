...
| **R101** | **Ninety-nine admin API route files have no authorization check of any kind, and fifty-eight of them write.** *(**R101a–R101ab CLOSED 16 Sep 2026.** Inventory after R101ab: **0 no-check / 0 hand-verified / 30 helper / 307 section-granted**. R101ab closed money leftovers / ops health / employee self (11 files / 18 handlers). A document treating R101 as closed is wrong; one treating the escalation, wallet credit, erasure, exports, messaging, visitors, landing-pages, market-data, settings, ops/money/customer or money leftovers as live is stale; and one quoting **41 helper** or **78 / 58 / 55 / 51 / 44** still-unguarded is quoting a figure the next closure moved - **say which**.)* Counted over all 347 route files in `apps/admin/app/api` with comments stripped: see the detail section for the full a–ab closure history | **Critical** | **LIVE on the remaining helper-but-no-grant surface (30 routes, gamemaster deferred).** Earlier writers are closed; absence of evidence of past calls is not reassurance | **R101a–R101ab CLOSED; R101 remains open on the 30 helper-but-no-grant routes and still ahead of R96 and X7.** Inventory after R101ab: **0 / 0 / 30 / 307**. **ELEVENTH instance of this class** — every previous instance fixed the routes it happened to be looking at; the directory inventory (R101d) is what makes the rest countable || R8 | Bulk find-and-replace on wording | High | Medium | X8 |
...
### R101 - Ninety-nine admin routes with no authorization, and fifty-eight of them write - **R101a–R101ab CLOSED 16 Sep 2026; helper-but-no-grant still open**
...
**R101 remains open** on the **30 helper-but-no-grant** routes (gamemaster deferred —
