...
### R101 - Ninety-nine admin routes with no authorization, and fifty-eight of them write - **R101a–R101aa CLOSED 16 Sep 2026; helper-but-no-grant still open**
...
**R101 remains open** on the **41 helper-but-no-grant** routes (gamemaster deferred —
