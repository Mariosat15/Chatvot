...
const VATPaymentSchema = new mongoose_1.Schema({
...
const VATPayment = mongoose_1.default.models.VATPayment || mongoose_1.default.model('VATPayment', VATPaymentSchema);
exports.default = VATPayment;
