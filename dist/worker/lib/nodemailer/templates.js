...
exports.INVOICE_EMAIL_TEMPLATE = exports.INACTIVE_USER_REMINDER_EMAIL_TEMPLATE = exports.VOLUME_ALERT_EMAIL_TEMPLATE = exports.STOCK_ALERT_LOWER_EMAIL_TEMPLATE = exports.STOCK_ALERT_UPPER_EMAIL_TEMPLATE = exports.NEWS_SUMMARY_EMAIL_TEMPLATE = exports.WELCOME_EMAIL_TEMPLATE = exports.PRICE_ALERT_EMAIL_TEMPLATE = void 0;
exports.PRICE_ALERT_EMAIL_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Price Alert Triggered - Chatvolt</title>
    <style type="text/css">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="email-container" style="max-width: 600px; background-color: #141414; border-radius: 8px; border: 1px solid #30333A;">
                    ...
                    <tr>
                        <td align="left" style="padding: 40px 40px 20px 40px;">
                            <img src="{{logoUrl}}" alt="Chatvolt Logo" width="150" style="max-width: 100%; height: auto;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <!-- Alert Icon & Title -->
                            <h1 style="margin: 0 0 20px 0; font-size: 28px; font-weight: 600; color: #FDD458; line-height: 1.2;">
                                🔔 Price Alert Triggered!
                            </h1>
                            
                            <!-- Alert Message -->
                            <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">
                                Your alert "<strong style="color: #FDD458;">{{alertName}}</strong>" has been triggered.
                            </p>
                            
                            <!-- Stock Details Card -->
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #1E1E1E; border: 1px solid #30333A; border-radius: 8px; margin-bottom: 24px;">
                                <tr>
                                    <td style="padding: 24px;">
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td style="padding-bottom: 16px; border-bottom: 1px solid #30333A;">
                                                    ...
                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                        <tr>
                                                            <td style="padding-bottom: 12px;">
                                                                <p style="margin: 0; font-size: 14px; color: #9ca3af;">Current Price:</p>
                                                                <p style="margin: 4px 0 0 0; font-size: 24px; color: #FDD458; font-weight: 700;">
                                                                    {{currentPrice}}
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <p style="margin: 0; font-size: 14px; color: #9ca3af;">Alert Condition:</p>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td align="center">
                                        <a href="https://stock-market-dev.vercel.app/stocks/{{symbol}}" style="display: inline-block; background: linear-gradient(135deg, #FDD458 0%, #E8BA40 100%); color: #000000; text-decoration: none; padding: 16px 32px; border-radius: 8px; font-size: 16px; font-weight: 500; line-height: 1;">
                                            View Stock Details
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <!-- Footer -->
                    <tr>
                        <td align="center" style="padding: 20px 40px 40px 40px; border-top: 1px solid #30333A;">
                            <p style="margin: 0; font-size: 12px; color: #6b7280; line-height: 1.5;">
                                This alert was triggered at {{time}}<br>
                                © 2025 Chatvolt | <a href="https://stock-market-dev.vercel.app/" style="color: #CCDADC !important; text-decoration: underline;">Visit Chatvolt</a>
                            </p>
                        </td>
                    </tr>
...
<head>
    ...
    <title>Welcome to Chatvolt</title>
    <!--[if mso]>
    <noscript>
        <xml>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="email-container" style="max-width: 600px; background-color: #141414; border-radius: 8px; border: 1px solid #30333A;">
                    ...
                    <tr>
                        <td align="center" class="dashboard-preview" style="padding: 40px 40px 0px 40px;">
                            <img src="{{dashboardPreviewUrl}}" alt="Chatvolt Dashboard Preview" width="100%" style="max-width: 520px; width: 100%; height: auto; border-radius: 12px; border: 1px solid #30333A;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <p class="mobile-text dark-text-muted" style="margin: 40px 0 0 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important; text-align: center;">
                               chatvolt HQ, 200 Market Street, San Francisco, CA 94105<br>
                                <a href="#" style="color: #CCDADC !important; text-decoration: underline;">Unsubscribe</a> | 
                                <a href="https://stock-market-dev.vercel.app/" style="color: #CCDADC !important; text-decoration: underline;">Visit chatvolt</a><br>
                                © 2025 chatvolt
                            </p>
                        </td>
                    </tr>
...
exports.NEWS_SUMMARY_EMAIL_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
                        ...
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    You're receiving this because you subscribed to chatvolt news updates.
                                </p>
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    <a href="#" style="color: #CCDADC !important; text-decoration: underline;">Unsubscribe</a> | 
                                    <a href="https://chatvolt.app" style="color: #CCDADC !important; text-decoration: underline;">Visit chatvolt</a>
                                </p>
...
exports.STOCK_ALERT_UPPER_EMAIL_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
exports.STOCK_ALERT_LOWER_EMAIL_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
exports.VOLUME_ALERT_EMAIL_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
exports.INACTIVE_USER_REMINDER_EMAIL_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <p class="mobile-text dark-text-secondary" style="margin: 0 0 30px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">
                                We noticed you haven't visited chatvolt in a while. The markets have been moving, and there might be some opportunities you don't want to miss!
                            </p>
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                ...
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    ...
                                    <a href="{{dashboardUrl}}" style="color: #CCDADC !important; text-decoration: underline;">Visit chatvolt</a>
                                </p>
                                <p style="margin: 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    © 2025 chatvolt
                                </p>
...
exports.INVOICE_EMAIL_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
        ...
        <tr>
            <td align="center" style="padding: 40px 20px;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="email-container" style="max-width: 600px; background-color: #141414; border-radius: 8px; border: 1px solid #30333A;">
                    ...
                    <tr>
                        <td align="left" style="padding: 40px 40px 20px 40px;">
                            <img src="{{logoUrl}}" alt="{{companyName}}" width="150" style="max-width: 100%; height: auto;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 20px 40px 40px 40px;">
                            ...
                            <div style="text-align: center; margin-bottom: 24px;">
                                <span style="display: inline-block; background-color: #10b981; color: #ffffff; padding: 8px 20px; border-radius: 20px; font-size: 14px; font-weight: 600; text-transform: uppercase;">
                                    ✓ PAID
                                </span>
                            </div>
