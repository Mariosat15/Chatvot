...
async function generateInvoicePDF(invoice) {
    ...
    try {
        ...
        const mediumGray = (0, pdf_lib_1.rgb)(0.4, 0.4, 0.4);
        const lightGray = (0, pdf_lib_1.rgb)(0.6, 0.6, 0.6);
        const accentColor = (0, pdf_lib_1.rgb)(primaryColor.r, primaryColor.g, primaryColor.b);
        // Margins
        const margin = 50;
        ...
        const statusColor = invoice.status === 'paid' ? (0, pdf_lib_1.rgb)(0.06, 0.73, 0.51) :
            invoice.status === 'sent' ? (0, pdf_lib_1.rgb)(0.23, 0.51, 0.96) : (0, pdf_lib_1.rgb)(0.96, 0.62, 0.04);
        // Status background
        page.drawRectangle({
            x: statusX,
            y: y - 4,
        ...
        page.drawRectangle({
            ...
            width: contentWidth,
            height: 25,
            color: (0, pdf_lib_1.rgb)(0.95, 0.95, 0.97),
        });
        // Table headers
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
page, margin, y, contentWidth, invoice, 
// eslint-disable-next-line @typescript-eslint/no-explicit-any
helvetica, 
// eslint-disable-next-line @typescript-eslint/no-explicit-any
helveticaBold, 
    ...
    try {
        ...
        for (const word of words) {
            ...
            if (helvetica.widthOfTextAtSize(testLine, 10) > 500) {
                page.drawText(line, { x: 50, y, size: 10, font: helvetica, color: (0, pdf_lib_1.rgb)(0.2, 0.2, 0.2) });
                line = word;
                y -= 14;
                if (y < 50)
                    break;
