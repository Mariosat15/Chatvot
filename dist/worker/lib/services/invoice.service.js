 ...
 */
function formatDisclaimer(disclaimer, variables) {
...
exports.InvoiceService = {
    ...
    createInvoice: async (params) => {
        ...
        const invoiceNumber = await invoice_settings_model_1.default.getNextInvoiceNumber();
        // Determine if VAT applies
        const companyInEU = (0, company_settings_model_1.isEUCountry)(companySettings.country);
        ...
        // Generate HTML
        const html = await exports.InvoiceService.generateInvoiceHTML(invoice, invoiceSettings, companySettings);
     ...
     */
    generateInvoiceHTML: async (invoice, 
    ...
    companySettings) => {
        ...
        if (!invoiceSettings) {
            invoiceSettings = await invoice_settings_model_1.default.getSingleton();
        }
        if (!companySettings) {
            companySettings = await company_settings_model_1.default.getSingleton();
        }
...
<body>
  <div class="invoice-container">
      ...
      <div class="addresses">
        ...
        <div class="address-block" style="text-align: right;">
          ...
          <div class="address-line">
            ...
            ${invoice.customerAddress.country ? '<br>' + (company_settings_model_1.COUNTRY_NAMES[invoice.customerAddress.country] || invoice.customerAddress.country) : ''}
          </div>
          ` : ''}
        </div>
      </div>
    ...
    getInvoiceById: async (invoiceId) => {
        await (0, mongoose_1.connectToDatabase)();
        return invoice_model_1.default.findById(invoiceId);
    },
    /**
     * Get invoices for a user
     */
    getUserInvoices: async (userId, limit = 50) => {
        await (0, mongoose_1.connectToDatabase)();
        return invoice_model_1.default.find({ userId })
            .sort({ createdAt: -1 })
            .limit(limit)
            .lean();
    },
    ...
    getInvoiceByTransactionId: async (transactionId) => {
        await (0, mongoose_1.connectToDatabase)();
        return invoice_model_1.default.findOne({ transactionId });
    },
};
