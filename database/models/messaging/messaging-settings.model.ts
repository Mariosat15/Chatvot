...
const MessagingSettingsSchema = new Schema<IMessagingSettings>(
  {
    ...
    aiGreetingMessage: {
      type: String,
      default:
        "Hello! I'm your AI assistant. How can I help you today? If you need to speak with a human agent, just let me know.",
    },
    ...
    outsideHoursMessage: {
      type: String,
      default:
        "We're currently outside of our working hours. We'll respond to your message as soon as possible during our next business day.",
    },
...
MessagingSettingsSchema.statics.getSettings =
  async function (): Promise<IMessagingSettings> {
...
MessagingSettingsSchema.methods.shouldEscalateAI = function (
  ...
  if (
    ...
    confidence < this.aiConfidenceThresholdForEscalation
  ) {
...
MessagingSettingsSchema.methods.moderateContent = function (content: string): {
  content: string;
  wasModified: boolean;
  flags: string[];
} {
...
export const MessagingSettings =
  mongoose.models.MessagingSettings ||
