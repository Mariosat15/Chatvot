...
UserPresenceSchema.index(
  { typingStartedAt: 1 },
  {
    ...
    partialFilterExpression: { typingStartedAt: { $exists: true } },
  },
);
...
UserPresenceSchema.statics.getOnlineParticipants = function (
...
UserPresenceSchema.statics.getTypingInConversation = function (
  conversationId: string,
) {
...
export const UserPresence =
  mongoose.models.MessagingPresence ||
  mongoose.model<IUserPresence, UserPresenceModel>(
    "MessagingPresence",
    UserPresenceSchema,
  );
