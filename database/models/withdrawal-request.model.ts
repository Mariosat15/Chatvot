...
export interface IWithdrawalRequest extends Document {
  ...
  bankDetails?: {
    ...
    swiftBic?: string;
    country?: string;
    nuveiUpoId?: string; // Nuvei UPO ID for automatic bank payouts
  };
...
WithdrawalRequestSchema.statics.getDailyTotal = async function (
  userId: string,
): Promise<number> {
...
WithdrawalRequestSchema.statics.getMonthlyTotal = async function (
  userId: string,
): Promise<number> {
...
const WithdrawalRequest =
  ...
  mongoose.model<IWithdrawalRequest, IWithdrawalRequestModel>(
    "WithdrawalRequest",
