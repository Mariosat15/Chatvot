...
export declare const updatePositionTPSL: (
  positionId: string,
...
>;
export declare const closePosition: (
  positionId: string,
  requestedPrice?: {
    bid: number;
    ask: number;
...
export declare const updateAllPositionsPnL: (
...
>;
export declare const checkStopLossTakeProfit: (
  competitionId: string,
) => Promise<void>;
export declare function closePositionAutomatic(
  positionId: string,
  exitPrice: number,
