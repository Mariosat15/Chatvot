 ...
 * Game Icons Registry
 * 
 * Centralized mapping of game icons for consistent usage across the app.
...
export const ICON_CATEGORIES = {
  navigation: ['dashboard', 'competitions', 'challenges', 'leaderboard', 'wallet', 'profile', 'marketplace', 'settings', 'help'],
  trading: ['buy', 'sell', 'profit', 'loss', 'trade', 'investment', 'portfolio'],
  rankings: ['rank1', 'rank2', 'rank3', 'rank4', 'rank5', 'rank6', 'rank7', 'trophy', 'goldMedal', 'champion', 'victory'],
  currency: ['coin', 'coins', 'gems', 'treasure', 'chest', 'chest1', 'money', 'moneyDeposit', 'capital'],
  status: ['warning', 'riskWarning', 'target', 'timer', 'skull'],
  weapons: ['sword', 'sword1', 'axe1', 'hammer1', 'bow3D', 'bomb1'],
  equipment: ['shield1', 'helmet1', 'armor1', 'key', 'crown'],
  potions: ['healthPotion', 'energyPotion', 'fireSpell', 'blueFireSpell'],
  characters: ['rookie', 'lord', 'archer', 'wolf1', 'animal1'],
  gaming: ['joystick1', 'headset', 'keyboard', 'wasd'],
  badges: ['starAward', 'starBadge', 'shieldAward', 'certificateAward', 'award', 'giftAward'],
} as const;
