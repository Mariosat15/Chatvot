 ...
 * Game Icons Registry
 * 
 * Centralized mapping of ALL game icons for consistent usage across the app.
 * All icons are located in /public/game-icons/
 * 
 * IMPORTANT: This file is the SINGLE SOURCE OF TRUTH for icon names.
 * Both the main app and admin app must stay in sync.
 * When adding new icons to public/game-icons/, register them here.
 */
...
export const GAME_ICONS = {
  ...
  // Trophy collection (0Trophy015 series)
  ...
  // ========================================
  // Sword Weapon collection (sw0005)
  // ========================================
...
export function getGameIconPath(name: GameIconName): string {
  // Reason: name is typed as keyof GAME_ICONS — not a free-form object index.
...
// Icon categories for easy browsing (updated with all collections)
export const ICON_CATEGORIES = {
  'Trophies & Awards': [
    'trophy', 'trophyStar', 'trophyGame', 'trophyFootball', 'trophyMusic', 'trophyMovie',
    'trophy1', 'trophy2', 'trophy3',
    'trophyCol1', 'trophyCol2', 'trophyCol3', 'trophyCol4', 'trophyCol5',
    'trophyCol6', 'trophyCol7', 'trophyCol8', 'trophyCol9', 'trophyCol10',
    'trophyCol11', 'trophyCol12', 'trophyCol13', 'trophyCol14', 'trophyCol15',
    'goldMedal', 'champion', 'victory',
    'starAward', 'starAward12', 'starBadge', 'shieldAward', 'certificateAward',
    'graduationAward', 'scrollAward', 'award', 'giftAward', 'giftAward13', 'studyAward',
  ],
  'Stars & Rankings': [
    'star1', 'star2', 'star3',
    'rank1', 'rank2', 'rank3', 'rank4', 'rank5', 'rank6', 'rank7', 'medal7',
    'crown',
  ],
  'Currency & Treasure': [
    'coin', 'coins', 'gems', 'gemsAlt', 'treasure', 'chest', 'chest1', 'chest2', 'chest3', 'chest4', 'chest14',
    'pouch1', 'pouch2', 'money', 'moneyDeposit', 'moneyBalance', 'capital', 'pirateCoin',
  ],
  'Finance': [
    'dollarFinance1', 'dollarFinance2', 'dollarFinance3', 'dollarFinance4', 'dollarFinance5',
    'dollarFinance6', 'dollarFinance7', 'dollarFinance8', 'dollarFinance9', 'dollarFinance10',
    'euroFinance1', 'euroFinance2', 'euroFinance3', 'euroFinance4', 'euroFinance5',
    'euroFinance6', 'euroFinance7', 'euroFinance8', 'euroFinance9', 'euroFinance10',
    'finance1', 'finance2', 'finance3', 'finance4', 'finance5',
    'finance6', 'finance7', 'finance8', 'finance9', 'finance10',
    'finance900_1', 'finance900_2', 'finance900_3', 'finance900_4', 'finance900_5',
    'finance900_6', 'finance900_7', 'finance900_8', 'finance900_9', 'finance900_10',
    'finance22_1', 'finance22_2', 'finance22_3', 'finance22_4', 'finance22_5',
    'finance22_6', 'finance22_7', 'finance22_8', 'finance22_9', 'finance22_10',
    'financialCalculation', 'financialPlanning', 'equity', 'equities', 'dividend',
    'valuation', 'inflation', 'hedge', 'gain', 'fluctuation', 'overPrice', 'redemption',
    'riskRating', 'repository', 'investmentModel', 'fixIncome',
    'longTermInvestment', 'returnOfInvest', 'investStock', 'investEducation',
    'goldInvest', 'attractingMoney', 'dollarPlant', 'retirementSaving',
    'buy', 'sell', 'profit', 'profitAlt', 'loss', 'trade', 'investment', 'portfolio',
  ],
  'Weapons': [
    'sword', 'sword1', 'sword2', 'sword3', 'sword4', 'sword5', 'sword6',
    'swordKnight3D', 'swordNumbered', 'pirateSword', 'piratesSword',
    'axe1', 'axe2', 'axe3', 'axe4', 'axe3D', 'axeNumbered',
    'hammer1', 'hammer2', 'hammer3', 'hammer3D',
    'bow3D', 'bomb1', 'bomb2', 'bomb3', 'bomb4', 'bombLarge', 'bombNumbered',
    'piratePistol', 'pirateCannon', 'cannon',
    'sw1', 'sw2', 'sw3', 'sw4', 'sw5', 'sw6', 'sw7', 'sw8', 'sw9', 'sw10',
    'sw11', 'sw12', 'sw13', 'sw14', 'sw15',
  ],
  'Defense & Equipment': [
    'shield1', 'shield2', 'shield3', 'shield4', 'magicShield3D',
    'helmet1', 'helmet2', 'helmet3', 'helmet4', 'pirateHat', 'piratesHat',
    'armor1', 'armor2',
    'key', 'banner', 'flag', 'pirateFlag', 'piratesFlag',
    'map1', 'map2', 'mapLarge', 'pirateMap', 'maps', 'guideBook', 'compass',
    'eyePatch', 'pirateHook', 'piratesHook', 'piratePegLeg', 'barrel', 'islandRock',
  ],
  'Potions & Spells': [
    'healthPotion', 'energyPotion', 'lightningPotion', 'ragePotion', 'poisonPotion',
    'spellBrown', 'spellGreen', 'fireSpell', 'blueFireSpell', 'iceSpell',
    'energySpell', 'lightningSpell', 'healthSpell', 'poisonSpell',
  ],
  'Characters': [
    'rookie', 'lord', 'archer', 'war',
    'wolf1', 'wolf2', 'wolf3', 'wolf4', 'wolf5', 'wolf6', 'wolf7', 'wolf8', 'wolf9', 'wolf10',
    'wolf11', 'wolf12', 'wolf13', 'wolf14', 'wolf15', 'wolf16', 'wolf17', 'wolf18', 'wolf19', 'wolf20',
    'animal1', 'animal2', 'animal3', 'animal4', 'animal5',
    'animal6', 'animal7', 'animal8', 'animal9', 'animal10',
    'parrot',
  ],
  'Status & Alerts': [
    'warning', 'warning2', 'warning3', 'warning4', 'warning5',
    'warning6', 'warning7', 'warning8', 'warning9', 'warning10',
    'riskWarning', 'riskManagement', 'riskIdentification', 'riskMeasurement',
    'riskAnalysis', 'riskControl', 'riskMonitoring',
    'marketRisk', 'operationalRisk', 'externalRisk', 'systemFailures',
    'internalControl', 'marketMonitoring', 'riskScale',
    'qualitativeAnalysis', 'quantitativeAnalysis', 'impactAssessment', 'riskAssessment',
    'target', 'timer', 'timerAlt', 'skull',
  ],
  'Gaming Hardware': [
    'joystick1', 'joystick2', 'joystick3', 'headset', 'keyboard', 'wasd', 'mic',
  ],
  'Rewards & Misc': [
    'reward1', 'reward2', 'reward3', 'reward4', 'reward5',
    'meat', 'heart', 'dream', 'medKit1', 'medKit2', 'crisisRecovery',
  ],
  'Pirate Theme': [
    'pirateShip', 'piratesShip', 'anchor', 'anchor1', 'anchor2', 'anchor3', 'anchor4',
    'pirateFlag', 'piratesFlag', 'pirateHat', 'piratesHat',
    'pirateSword', 'piratesSword', 'piratePistol', 'pirateCannon',
    'pirateHook', 'piratesHook', 'piratePegLeg', 'pirateMap', 'pirateCoin',
    'compass', 'eyePatch', 'barrel', 'islandRock', 'parrot', 'cannon',
  ],
  'Game Collections': [
    'gameFirst1', 'gameFirst2', 'gameFirst3', 'gameFirst4', 'gameFirst5',
    'gameFirst6', 'gameFirst7', 'gameFirst8', 'gameFirst9', 'gameFirst10',
    'gameSecond1', 'gameSecond2', 'gameSecond3', 'gameSecond4', 'gameSecond5',
    'gameSecond6', 'gameSecond7', 'gameSecond8', 'gameSecond9', 'gameSecond10',
    'gameThird1', 'gameThird2', 'gameThird3', 'gameThird4', 'gameThird5',
    'gameThird6', 'gameThird7', 'gameThird8', 'gameThird9', 'gameThird10',
    'gameFourth1', 'gameFourth2', 'gameFourth3', 'gameFourth4', 'gameFourth5',
    'gameFourth6', 'gameFourth7', 'gameFourth8', 'gameFourth9', 'gameFourth10',
    'gameFifth1', 'gameFifth2', 'gameFifth3', 'gameFifth4', 'gameFifth5',
    'gameFifth6', 'gameFifth7', 'gameFifth8', 'gameFifth9', 'gameFifth10',
    'gameBlack1', 'gameBlack2', 'gameBlack3', 'gameBlack4', 'gameBlack5',
    'gameBlack6', 'gameBlack7', 'gameBlack8', 'gameBlack9', 'gameBlack10',
  ],
  'Renders & Art': [
    'render1', 'render2', 'render3', 'render4', 'render5',
    'render6', 'render7', 'render8', 'render9', 'render10',
    'render11', 'render12', 'render13', 'render14', 'render15',
    'render16', 'render17', 'render18', 'render19', 'render20',
    'icon0001', 'icon0002', 'icon0003', 'icon0004', 'icon0005',
    'icon0006', 'icon0007', 'icon0008', 'icon0009', 'icon0010',
    'icon0011', 'icon0012', 'icon0013', 'icon0014', 'icon0015',
    'icon0016', 'icon0017', 'icon0018', 'icon0019', 'icon0020',
  ],
  'Technology': [
    'tech1', 'tech2', 'tech3', 'tech4', 'tech5', 'tech6', 'tech7', 'tech8', 'tech9', 'tech10',
    'tech100_1', 'tech100_2', 'tech100_3', 'tech100_4', 'tech100_5',
    'tech100_6', 'tech100_7', 'tech100_8', 'tech100_9', 'tech100_10',
    'tech1110_1', 'tech1110_2', 'tech1110_3', 'tech1110_4', 'tech1110_5',
    'tech1110_6', 'tech1110_7', 'tech1110_8', 'tech1110_9', 'tech1110_10',
    'tech44_1', 'tech44_2', 'tech44_3', 'tech44_4', 'tech44_5',
    'tech44_6', 'tech44_7', 'tech44_8', 'tech44_9', 'tech44_10',
  ],
  'Seasonal: Christmas': [
    'christmas1', 'christmas2', 'christmas3', 'christmas4', 'christmas5',
    'christmas6', 'christmas7', 'christmas8', 'christmas9', 'christmas10',
    'christmas11', 'christmas12', 'christmas13', 'christmas14', 'christmas15',
    'christmas16', 'christmas17', 'christmas18', 'christmas19', 'christmas20',
  ],
  'Seasonal: Halloween': [
    'halloween1', 'halloween2', 'halloween3', 'halloween4', 'halloween5',
    'halloween6', 'halloween7', 'halloween8', 'halloween9', 'halloween10',
  ],
  'Seasonal: Black Friday': [
    'blackFriday1', 'blackFriday2', 'blackFriday3', 'blackFriday4', 'blackFriday5',
    'blackFriday6', 'blackFriday7', 'blackFriday8', 'blackFriday9', 'blackFriday10',
  ],
  'Seasonal: Cyber': [
    'cyber1', 'cyber2', 'cyber3', 'cyber4', 'cyber5',
    'cyber6', 'cyber7', 'cyber8', 'cyber9', 'cyber10',
  ],
  'School & Education': [
  ...
  'Badge Prototypes': [
    'roundProto', 'roundProto1', 'roundProto2', 'roundProto3', 'roundProto4',
    'shieldProto', 'shieldProto1', 'shieldProto2', 'shieldProto3', 'shieldProto4',
  ],
} as const;
