...
declare class NotificationService {
  ...
  sendAdminAnnouncement(
    ...
    adminEmail: string,
    userIds?: string[],
  ): Promise<number | INotification | INotification[]>;
  ...
  getUserNotifications(
    ...
    (import("mongoose").FlattenMaps<INotification> &
      Required<{
  ...
  getTemplates(category?: NotificationCategory): Promise<
    (import("mongoose").FlattenMaps<
      import("@/database/models/notification-template.model").INotificationTemplate
    > &
      Required<{
        _id: import("mongoose").Types.ObjectId;
      }> & {
