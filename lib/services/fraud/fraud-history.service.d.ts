...
export declare class FraudHistoryService {
  ...
  static logWarning(
    ...
    import("@/database/models/fraud/fraud-history.model").IFraudHistory | null
  >;
  /**
   * Log when investigation starts
   */
  static logInvestigationStarted(
    user: UserInfo,
    reason: string,
    details: string,
    admin?: AdminInfo,
   ...
   */
  static logInvestigationResolved(
    user: UserInfo,
    reason: string,
    details: string,
    admin?: AdminInfo,
