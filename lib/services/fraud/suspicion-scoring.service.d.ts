...
export declare class SuspicionScoringService {
   ...
   */
  static updateScoresForMultipleUsers(
    userIds: string[],
   ...
   */
  static getHighRiskUsers(): Promise<
    Omit<
      ISuspicionScore,
      | "calculateRiskLevel"
      | "addPercentage"
