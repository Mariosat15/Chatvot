 ...
 */
export declare function updateCachedSpread(
  symbol: ForexSymbol,
  bid: number,
  ask: number,
): void;
 ...
 */
export declare function fetchRealForexPrices(
  symbols: ForexSymbol[],
 ...
 */
export declare function getRealPrice(
  symbol: ForexSymbol,
 ...
 */
export declare function getPriceFromCacheOnly(
  symbol: ForexSymbol,
): Promise<PriceQuote | null>;
/**
 ...
 */
export declare function getPriceFromCacheOnlySync(
  symbol: ForexSymbol,
): PriceQuote | null;
/**
 ...
 * Checks: Redis → WebSocket → In-memory
 */
export declare function getAllPricesFromCache(
  symbols: ForexSymbol[],
): Promise<Map<ForexSymbol, PriceQuote>>;
/**
 ...
 * For use in hot paths where async is not acceptable
 */
export declare function getAllPricesFromCacheSync(
  symbols: ForexSymbol[],
