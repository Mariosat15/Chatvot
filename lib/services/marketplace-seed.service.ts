...
const RADIANT_FIBONACCI_MATRIX = {
...
No indicator guarantees profits. This indicator is a decision-support tool. Always use proper risk management and never risk more than you can afford to lose.`,
  ...
  codeTemplate: JSON.stringify({
    ...
    displayType: "overlay",
    description: "Dynamic auto-Fibonacci retracement (23.6%–78.6%) and extensions (127.2%, 161.8%) with rolling swing detection and BOUNCE/BREAK signals",
  }),
  defaultSettings: {
    lookback: 55,
    atrPeriod: 14,
  ...
  supportedAssets: [],
  tags: ["fibonacci", "retracement", "extension", "golden-ratio", "swing", "support", "resistance", "auto-fib", "61.8", "161.8", "premium", "overlay"],
  riskLevel: "medium",
};
