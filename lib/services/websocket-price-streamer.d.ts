 ...
 */
export declare function getCachedPrice(
  symbol: ForexSymbol,
): StreamingPriceQuote | null;
/**
 * Get all cached prices (normalized)
 */
export declare function getAllCachedPrices(): Map<
  ForexSymbol,
  StreamingPriceQuote
>;
/**
 ...
 */
export declare function getCachedPrices(
  symbols: ForexSymbol[],
 ...
 */
export declare function updateCacheFromRest(
  symbol: ForexSymbol,
