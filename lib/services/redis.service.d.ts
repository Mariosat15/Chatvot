 ...
 */
export declare function setPrice(
  symbol: string,
  price: CachedPrice,
): Promise<boolean>;
/**
 ...
 */
export declare function setPrices(
 ...
 * Add trade to queue
 */
export declare function queueTrade(
 ...
 */
export declare function completeQueuedTrade(
  trade: QueuedTrade,
): Promise<boolean>;
/**
 * Re-queue failed trade (with retry count)
 */
export declare function requeueFailedTrade(
  trade: QueuedTrade,
): Promise<boolean>;
/**
 * Get queue stats
