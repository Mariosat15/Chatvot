...
export function validateAuthSecret(): ValidationResult {
  ...
  if (!secret) {
    ...
    if (!isProduction) {
      ...
      if (generated) {
        ...
        result.warnings.push(
          "BETTER_AUTH_SECRET was auto-generated for development.",
        );
      }
    }
    ...
    if (!secret) {
      result.valid = false;
      result.errors.push(
        "BETTER_AUTH_SECRET is not set. Authentication will not work.",
      );
      return result;
    }
  }
  ...
  if (isInsecure) {
    if (isProduction) {
      ...
      console.log(
        "⚠️  Detected placeholder secret, auto-generating a secure one...",
      );
      const generated = autoGenerateSecret();
      if (generated) {
        secret = generated;
        result.warnings.push(
          "Placeholder secret replaced with auto-generated secure secret.",
        );
      } else {
        result.warnings.push(
...
export function validateEnvironment(): void {
  ...
  if (!authResult.valid && isProduction) {
    ...
    console.error(
      "   The app cannot start with insecure configuration in production.",
    );
