 ...
 */
export declare function notifyNewMessage(
  conversationId: string,
  message: any,
): void;
export declare function notifyRead(
  conversationId: string,
  participantId: string,
  participantName: string,
): void;
export declare function notifyTransfer(
  conversationId: string,
  toEmployeeId: string,
  toEmployeeName: string,
): void;
export declare function notifyFriendRequest(
  toUserId: string,
  eventType: string,
  request: any,
): void;
export declare function getOnlineParticipants(
