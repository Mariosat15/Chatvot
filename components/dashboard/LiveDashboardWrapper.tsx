...
export default function LiveDashboardWrapper({
  ...
  return (
    <>
      ...
      <div className="w-full flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-400 mt-2">
            Track your performance and compete in real-time
          </p>
        </div>
      ...
      {dashboardData.globalCharts?.dailyPnL &&
        dashboardData.globalCharts.dailyPnL.length > 0 && (
        ...
        <section className="w-full mt-8">
          <div className="bg-gray-800 border border-gray-700 rounded-xl p-12 text-center">
            ...
            <p className="text-gray-400 mb-6">
              Join a competition to start trading and compete with others in
              real-time!
            </p>
            <Link
              href="/competitions"
