      ...
      <div className="p-4 space-y-2">
        {participantData.map((item) => (
          <button
            key={item.mode}
            onClick={() =>
              setViewMode(viewMode === item.mode ? "overview" : item.mode)
            }
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span
                          className={`text-xs font-bold ${participant.pnl >= 0 ? "text-green-500" : "text-red-500"}`}
                        >
                          {participant.pnlPercentage >= 0 ? "+" : ""}
                          {participant.pnlPercentage.toFixed(1)}%
                        </span>
                      </div>
                    </div>
                    <div className="grid grid-cols-2 gap-2 text-xs">
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold text-gray-300">
                          {formatCurrency(participant.currentCapital)}
                        </span>
                      </div>
                      <div className="flex justify-between">
        ...
        <div className="px-4 pb-4 pt-2 border-t border-gray-700/50">
          ...
          <div className="w-full h-3 bg-gray-900 rounded-full overflow-hidden border border-gray-700">
            <div
              ...
              style={{
                width: `${(stats.counts.active / stats.counts.total) * 100}%`,
              }}
            >
