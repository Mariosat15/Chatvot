...
export default function PaymentProvidersSection() {
  ...
  const handleToggleActive = async (provider: PaymentProvider) => {
    try {
      const response = await fetch(`/api/admin/payment-providers/${provider._id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleSaveConfig = async () => {
    ...
    try {
      const response = await fetch(`/api/admin/payment-providers/${selectedProvider._id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  const handleRegenerateEnv = async () => {
    ...
    try {
      const response = await fetch('/api/admin/payment-providers/regenerate-env', {
        method: 'POST',
      });
