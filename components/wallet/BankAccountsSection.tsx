  ...
  const handleEditAccount = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        `/api/wallet/bank-accounts/${editingAccount.id}`,
        {
          method: "PATCH",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription className="text-gray-400">
                Add your bank account to receive withdrawals. Withdrawals are
                ...
                <DialogContent className="bg-gray-900 border-gray-700 text-white max-w-lg">
                  <DialogHeader>
                    ...
                    <DialogDescription className="text-gray-400">
                      Enter your IBAN to receive withdrawals via SEPA bank
                      transfer. Your bank details are stored securely and
                      verified when you make a withdrawal.
                    </DialogDescription>
                  </DialogHeader>
          ...
          {accounts.length === 0 ? (
            <div className="text-center py-8 border border-dashed border-gray-600 rounded-lg">
              ...
              <p className="text-gray-500 text-sm mb-4">
                <span className="text-blue-400">Note:</span> If you don&apos;t
                add a bank account, withdrawals will be refunded to your
                original payment method (the card or account you used to
                purchase credits).
              </p>
              <Button
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-start gap-3">
                      <div
                        className={`p-2 rounded-lg ${account.isDefault ? "bg-blue-500/20" : "bg-gray-600"}`}
                      >
                        <Building2
                          className={`h-5 w-5 ${account.isDefault ? "text-blue-400" : "text-gray-400"}`}
                        />
                      </div>
                      <div>
                        <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-4 mt-2 text-sm">
                          ...
                          {account.totalPayouts > 0 && (
                            <span className="text-gray-400">
                              {account.totalPayouts} payout
                              {account.totalPayouts !== 1 ? "s" : ""}
                            </span>
                          )}
                        </div>
                      </div>
            ...
            <div className="flex gap-2">
              ...
              <div className="text-sm text-blue-300">
                ...
                <p className="text-blue-200/80 mt-1">
                  When you request a withdrawal, you can choose to receive funds
                  via bank transfer (SEPA) or refund to your original payment
                  method. If you haven&apos;t added a bank account, withdrawals
                  will automatically go back to the card or account you used to
                  purchase credits. Withdrawals typically arrive in 3-5 business
                  days.
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleEditAccount} className="space-y-4 mt-4">
              ...
              <div className="space-y-2">
                ...
                {editingAccount.ibanLast4 && !editFormData.iban && (
                  <p className="text-xs text-amber-400 flex items-center gap-1">
                    ...
                    Current IBAN ends in: ****{editingAccount.ibanLast4}. Leave
              ...
              <DialogFooter className="mt-6">
                ...
                <Button
                  type="submit"
                  disabled={
                    submitting || !editFormData.accountHolderName.trim()
                  }
                  className="bg-blue-600 hover:bg-blue-700"
                >
                  {submitting ? (
