  ...
  const toggleCategory = async (category: string, enabled: boolean) => {
    try {
      ...
      if (response.ok) {
        ...
        toast.success(
          `${CATEGORY_INFO[category]?.label || category} notifications ${enabled ? "enabled" : "disabled"}`,
        );
      }
    } catch (_error) {
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Always enabled for instant updates
                    </p>
                  </div>
                </div>
              ...
              {Object.entries(CATEGORY_INFO).map(([category, info]) => {
                const isEnabled =
                  preferences.categoryPreferences[
                    category as keyof CategoryPreferences
                  ];
                      ...
                      <div className="border-t border-gray-800 p-4 space-y-2 bg-gray-900/20">
                        ...
                        {templates.map((template) => {
                          const isTemplateEnabled =
                            !preferences.disabledNotifications.includes(
                              template.templateId,
                            );
                          ...
                          return (
                            ...
                            >
                              ...
                              <Switch
                                ...
                                onCheckedChange={(enabled) =>
                                  toggleTemplate(template.templateId, enabled)
                                }
                              />
                            </div>
                          );
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(enabled) =>
                    updatePreferences({ quietHoursEnabled: enabled })
                  }
                />
              </div>
            </CardHeader>
