...
export default function NotificationCenter() {
  const [activeSubTab, setActiveSubTab] = useState<"history" | "settings">(
    "history",
  );
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="flex items-start justify-between gap-4">
                                  <div className="flex-1">
                                    <p
                                      className={`font-medium ${notification.isRead ? "text-gray-300" : "text-white"}`}
                                    >
                                      {notification.title}
                                    </p>
                                ...
                                <div className="flex items-center gap-3 mt-3">
                                  <Badge
                                    className={`text-xs ${CATEGORY_INFO[notification.category]?.color || "bg-gray-500/20 text-gray-400"}`}
                                  >
                                    {CATEGORY_INFO[notification.category]?.icon}{" "}
                                    {CATEGORY_INFO[notification.category]
