...
export default function MatchmakingCards({
  currentUserId: _currentUserId,
}: MatchmakingCardsProps) {
    ...
    try {
      ...
      if (data.success && data.match) {
        ...
        const matchIndex = matches.findIndex(
          (m) => m.trader.userId === data.match.trader.userId,
        );
        if (matchIndex !== -1) {
  ...
  const canChallengeCurrentTrader =
    currentMatch?.trader?.isOnline &&
    currentMatch?.trader?.acceptingChallenges !== false;
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <p className="text-gray-500 text-center max-w-md mb-8">
          There are no other traders available to match with right now. Check
          back later!
        </p>
        <Button
  ...
  if (currentIndex >= matches.length) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <p className="text-gray-500 text-center max-w-md mb-8">
          You&apos;ve browsed through all available traders. Refresh to see new
          traders or use auto-match!
        </p>
          ...
          {currentMatch && (
            <motion.div
              ...
              animate={{
                ...
                y: 0,
                x:
                  direction === "left" ? -400 : direction === "right" ? 400 : 0,
                rotate:
                  direction === "left"
                    ? -20
                    : direction === "right"
        ...
        >
          ...
          >
            <Swords
              className={cn(
                "h-8 w-8",
                canChallengeCurrentTrader ? "text-white" : "text-gray-500",
              )}
            />
          </div>
          <span
    ...
    <div className="w-full h-full relative overflow-hidden rounded-3xl">
      ...
      <div
        className={cn(
          ...
          isSwipingRight &&
            "bg-gradient-to-r from-green-500 to-emerald-500 opacity-60 blur-sm",
          isSwipingLeft &&
            "bg-gradient-to-r from-red-500 to-pink-500 opacity-60 blur-sm",
          !isSwipingRight &&
            !isSwipingLeft &&
      ...
      <div className="relative w-full h-full bg-gradient-to-b from-gray-900 via-gray-900 to-gray-950 rounded-3xl border border-gray-800 overflow-hidden flex flex-col">
        ...
        <div className="relative h-full flex flex-col overflow-hidden">
          ...
          <div className="flex-shrink-0 px-4 pt-2 pb-4 text-center">
            {/* Profile Image */}
            <div
              className="relative w-18 h-18 mx-auto mb-2"
