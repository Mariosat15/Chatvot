...
const TradeHistory = ({ trades }: TradeHistoryProps) => {
  ...
  const filteredTrades = trades.filter((trade) => {
    ...
    if (filterReason !== "all" && trade.closeReason !== filterReason)
      return false;
    return true;
  });
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-dark-600 leading-relaxed">
              When you trade Forex, you <strong>buy at ASK price</strong>{" "}
              (higher) and <strong>sell at BID price</strong> (lower). The
              difference is called the <strong>spread</strong> - this is how
              brokers make money. Your P&L already includes this cost. For
              example: if the price shows 1.10000/1.10003 (BID/ASK), you pay 3
              pips spread when opening AND closing.
            </p>
          </div>
        </div>
      </div>
                    ...
                    <TableCell className="text-right">
                      ...
                      {trade.totalCosts && trade.totalCosts > 0 && (
                        <div
                          ...
                          title="Spread cost already included in P&L"
                        >
