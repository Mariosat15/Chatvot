        ...
        >
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p
                  className="text-2xl md:text-3xl font-black text-white uppercase tracking-wider drop-shadow-lg"
                ...
                <p className="text-sm md:text-base text-white font-bold mt-1">
                  {marketStatus.isOpen
                    ? "🚀 Place your trades now!"
                    : "⏰ Come back when market opens"}
                </p>
              </div>
            </div>
          ...
          <div className="relative overflow-hidden rounded-xl border-4 border-amber-400 bg-gradient-to-r from-amber-600 to-orange-600 p-4 shadow-2xl shadow-amber-500/50">
            ...
            <div className="relative flex items-start gap-3">
              ...
              <div className="flex-1">
                <p
                  className="text-xl md:text-2xl font-black text-white uppercase tracking-wider drop-shadow-lg mb-3"
                  style={{ fontFamily: "Impact, Arial Black, sans-serif" }}
                >
