  ...
  return (
    <div className="flex flex-col items-center gap-1">
      ...
      >
        {activeTInfo ? (
          <activeTInfo.icon
            ...
            style={{
              transform:
                activeTool === "vertical-line" ? "rotate(90deg)" : undefined,
            }}
          />
        ) : (
            ...
            {DRAWING_TOOLS.map(({ tool, icon: Icon, label }) => (
              ...
              >
                <Icon
                  ...
                  style={{
                    transform:
                      tool === "vertical-line" ? "rotate(90deg)" : undefined,
                  }}
                />
      ...
      <Dialog open={isSettingsOpen} onOpenChange={setIsSettingsOpen}>
        <DialogContent
          className="bg-[#131722] border-[#2b2b43] text-white max-w-xs"
          style={{ zIndex: 99999 }}
          container={portalContainer}
        >
          <DialogHeader>
          ...
          <div className="space-y-6 mt-4">
            ...
            <div>
              <Label className="text-sm text-white mb-3 block">
                Line Width: {displayLineWidth}px
              </Label>
              <Slider
