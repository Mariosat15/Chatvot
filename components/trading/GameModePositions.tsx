...
import { X, TrendingUp, TrendingDown, Target, Shield, Loader2 } from 'lucide-react';
...
export default function GameModePositions({ positions, competitionId }: GameModePositionsProps) {
    ...
    <div className="space-y-2">
      {positions.map((position) => {
        ...
        const pnl = currentPrice 
          ? position.side === 'long'
            ? (currentPrice.bid - position.entryPrice) * position.quantity * 100000
            : (position.entryPrice - currentPrice.ask) * position.quantity * 100000
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-2 text-xs">
              <div>
                ...
                <div className="text-white font-medium">{position.quantity} lots</div>
              </div>
              <div>
                <span className="text-gray-500">Entry</span>
                <div className="text-white font-medium">{position.entryPrice.toFixed(5)}</div>
              </div>
              <div>
