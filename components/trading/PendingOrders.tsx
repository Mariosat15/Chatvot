    ...
    return (
      <div className="text-center py-8">
        ...
        <p className="text-xs text-dark-600 mt-1">
          Limit orders will appear here until executed
        </p>
      </div>
    );
  }
    ...
    <div className="overflow-x-auto">
      <Table>
        <TableHeader>
          <TableRow className="border-dark-400 hover:bg-dark-300">
            ...
            <TableHead className="text-dark-600 text-right">
              Limit Price
            </TableHead>
            <TableHead className="text-dark-600 text-right">
              Margin Required
        ...
        <TableBody>
          {orders.map((order) => (
            <TableRow
              key={order._id}
              className="border-dark-400 hover:bg-dark-300"
            >
      ...
      <div className="mt-4 bg-blue-500/10 border border-blue-500/30 rounded-lg p-3">
        <p className="text-xs text-blue-400">
          💡 <span className="font-semibold">Pending limit orders</span> do NOT
          lock your margin. Margin will only be locked when the order executes
          and creates an open position. You can cancel these orders anytime
          without affecting your available capital.
        </p>
      </div>
    </div>
  );
