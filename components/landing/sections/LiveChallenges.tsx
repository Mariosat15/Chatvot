...
export default function LiveChallenges({
  ...
  title = "1v1 Trading Challenges",
  subtitle = "Settle It Head-to-Head",
  description = "Think you're better than another trader? Prove it. Challenge anyone to a direct 1v1 challenge — choose the stake, set the rules, and let the market decide the winner. No luck, just pure skill.",
