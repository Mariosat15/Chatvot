...
import { Calendar, X, ArrowRight, Clock, Users, CheckCircle } from 'lucide-react';
...
export default function DemoScheduler({
  ...
  if (inline) {
    return (
      ...
      >
        <div className="p-4 flex items-center gap-2" style={{ borderBottom: `1px solid ${theme?.colors?.border}` }}>
          <Calendar className="h-5 w-5" style={{ color: effectiveColors.primary }} />
          <span className="font-bold" style={{ color: effectiveColors.text }}>Schedule Your Demo</span>
        </div>
        <iframe
          src={calendlyUrl}
          width="100%"
          ...
          >
            ...
            >
              ...
              <div className="grid md:grid-cols-3">
                ...
                >
                  <h4 className="font-bold mb-4" style={{ color: effectiveColors.text }}>
                    What to expect:
                  </h4>
                  
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 flex-shrink-0 mt-0.5" style={{ color: theme?.colors?.success || '#22c55e' }} />
                    <div>
                      <div className="font-medium" style={{ color: effectiveColors.text }}>
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      <Clock className="h-4 w-4" style={{ color: effectiveColors.primary }} />
                      <span className="text-sm font-medium" style={{ color: effectiveColors.text }}>
                        30-minute call
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Users className="h-4 w-4" style={{ color: effectiveColors.primary }} />
                      <span className="text-sm font-medium" style={{ color: effectiveColors.text }}>
