  ...
  return (
    ...
    >
      <span
        ...
        style={{ fontSize: 12 + Math.random() * 12 }}
      >
        ❄
      </span>
    </motion.div>
...
function RGBWave() {
  return (
    <motion.div
      ...
      style={{
        background:
          "linear-gradient(90deg, rgba(255,0,0,0.1), rgba(0,255,0,0.1), rgba(0,0,255,0.1), rgba(255,0,0,0.1))",
        ...
        return (
          <>
            ...
            <motion.div
              ...
              style={{
                background:
                  "radial-gradient(ellipse at 50% 0%, rgba(187,37,40,0.2) 0%, transparent 50%), radial-gradient(ellipse at 30% 20%, rgba(22,91,51,0.2) 0%, transparent 40%)",
              }}
        ...
        return (
          <>
            ...
            <motion.div
              ...
              style={{
                background:
                  "radial-gradient(ellipse at 50% 100%, rgba(139,0,255,0.15) 0%, transparent 50%)",
              }}
            ...
            <motion.div
              ...
              style={{
                ...
                right: "15%",
                background:
                  "radial-gradient(circle, rgba(255,200,100,0.8) 0%, rgba(255,150,50,0.3) 50%, transparent 70%)",
              }}
        ...
        return (
          <>
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "repeating-linear-gradient(45deg, transparent, transparent 20px, #ff0000 20px, #ff0000 22px)",
              }}
            />
            ...
            {Array.from({ length: 30 }).map((_, i) => (
              <ConfettiParticle
                ...
                x={Math.random() * 100}
                color={
                  i % 3 === 0 ? "#ff0000" : i % 3 === 1 ? "#ffd700" : "#ffffff"
                }
              />
            ))}
          ...
          <>
            ...
            {Array.from({ length: 25 }).map((_, i) => (
              <ConfettiParticle
                ...
                x={Math.random() * 100}
                color={
                  ["#ff69b4", "#87ceeb", "#98fb98", "#ffd700", "#dda0dd"][i % 5]
                }
              />
            ))}
        ...
        return (
          <>
            ...
            <motion.div
              ...
              style={{
                background:
                  "radial-gradient(circle at 20% 80%, rgba(0,245,255,0.15) 0%, transparent 40%), radial-gradient(circle at 80% 20%, rgba(255,0,255,0.15) 0%, transparent 40%)",
              }}
              animate={{ opacity: [0.5, 1, 0.5] }}
            ...
            {Array.from({ length: 30 }).map((_, i) => (
              <SparkleParticle
                ...
                delay={i * 0.2}
                color={
                  i % 3 === 0 ? "#00f5ff" : i % 3 === 1 ? "#ff00ff" : "#ffff00"
                }
              />
            ))}
        ...
        return (
          <>
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "linear-gradient(#fcee0910 1px, transparent 1px), linear-gradient(90deg, #fcee0910 1px, transparent 1px)",
        ...
        return (
          <>
            ...
            <motion.div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(102,126,234,0.1) 0%, rgba(118,75,162,0.1) 25%, rgba(240,147,251,0.1) 50%, rgba(245,87,108,0.1) 75%, rgba(79,172,254,0.1) 100%)",
        ...
        return (
          <>
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "linear-gradient(0deg, transparent 49%, rgba(255,255,255,0.5) 50%, transparent 51%)",
          ...
          <>
            ...
            {Array.from({ length: 30 }).map((_, i) => (
              <SparkleParticle
                ...
                delay={i * 0.2}
                color={
                  i % 3 === 0 ? "#ffd700" : i % 3 === 1 ? "#c0c0c0" : "#cd7f32"
                }
              />
            ))}
