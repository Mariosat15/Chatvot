      ...
      <DialogPortal data-slot="dialog-portal" container={container}>
        ...
        <DialogPrimitive.Content
          ...
          className={cn(
            ...
            !fullScreenMobile &&
              "top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] rounded-lg max-h-[90vh] data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
            // When fullScreenMobile, use different positioning on mobile
            fullScreenMobile &&
              "sm:top-[50%] sm:left-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-lg sm:max-h-[90vh] sm:data-[state=closed]:zoom-out-95 sm:data-[state=open]:zoom-in-95",
