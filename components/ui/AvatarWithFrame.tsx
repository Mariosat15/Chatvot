...
export default function AvatarWithFrame({
  ...
  return (
    <div
      className={cn("relative flex-shrink-0", sizeConfig.container, className)}
    >
      {/* Avatar Layer (bottom) */}
      <div
        className={cn(
            ...
            <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-cyan-500/20 to-blue-500/20">
              {name ? (
                <span
                  ...
                  style={{
                    fontSize: `calc(${sizeConfig.container.split(" ")[0].replace("w-", "")} * 0.4rem)`,
                  }}
                >
                  {initials}
                </span>
 ...
 */
export function useAvatarWithFrame(_userId?: string) {
